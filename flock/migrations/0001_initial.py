# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-04-08 22:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_template', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='flock.ClassTemplate')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='flock.Person')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.DecimalField(decimal_places=2, max_digits=4)),
                ('asked_instructor', models.DateField(blank=True, default=None, null=True)),
                ('asked_assistants', models.DateField(blank=True, default=None, null=True)),
                ('asked_students', models.DateField(blank=True, default=None, null=True)),
                ('invoiced_students', models.DateField(blank=True, default=None, null=True)),
                ('asked_for_resources', models.DateField(blank=True, default=None, null=True)),
                ('class_template', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='flock.ClassTemplate')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_in_class_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='flock.PersonInClassTemplate')),
                ('resource_in_class_tempate', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='flock.ResourceInClassTemplate')),
            ],
        ),
        migrations.AddField(
            model_name='resourceinscheduledclass',
            name='scheduled_class',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='flock.ScheduledClass'),
        ),
        migrations.AddField(
