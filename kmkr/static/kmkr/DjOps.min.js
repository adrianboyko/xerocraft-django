	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				function () {
					var _p1 = {ctor: '_Tuple2', _0: model.selectedShow, _1: model.selectedShowDate};
					if (((_p1.ctor === '_Tuple2') && (_p1._0.ctor === 'Just')) && (_p1._1.ctor === 'Just')) {
						return {
							ctor: '::',
							_0: _elm_lang$html$Html$text('⟵'),
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text('Tracks for'),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$br,
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html$text(_p1._0._0.data.title),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$br,
												...
												_1: {
													...
													_0: _elm_lang$html$Html$text(
														A2(
															...
															'%a, %b %ddd',
															_user$project$CalendarDate$fromDate(_p1._1._0))),
													_1: {ctor: '[]'}
												}
											}
										}
						...
						return {
							ctor: '::',
							_0: _elm_lang$html$Html$text('Finish the START tab.'),
							_1: {ctor: '[]'}
						};
					}
				}()),
...
var _user$project$DjOps$layout_header_col_trackInfo = function (model) {
	...
	return A2(
		...
		function () {
			var _p2 = model.nowPlaying;
			if (_p2.ctor === 'Just') {
				var _p3 = _p2._0.track;
				if (_p3.ctor === 'Just') {
					var _p4 = _p3._0;
					return (_elm_lang$core$Native_Utils.cmp(_p4.remainingSeconds, 0) > 0) ? {
						ctor: '::',
						_0: A2(
							_user$project$DjOps$timeRemaining,
							_elm_lang$core$Basics$toString(
								_elm_lang$core$Basics$floor(_p4.remainingSeconds / 60)),
							_elm_lang$core$Basics$toString(
								A2(
									_elm_lang$core$Basics$rem,
									_elm_lang$core$Basics$floor(_p4.remainingSeconds),
									60))),
						_1: {
							ctor: '::',
							_0: A4(_user$project$DjOps$stackedPair, titleLabel, _p4.title, artistLabel, _p4.artist),
							_1: {ctor: '[]'}
						}
					} : blankInfo;
				} else {
...
var _user$project$DjOps$layout_header_col_showInfo = function (model) {
	...
	return A2(
		...
		function () {
			var _p5 = model.nowPlaying;
			if (_p5.ctor === 'Just') {
				var _p6 = _p5._0.show;
				if (_p6.ctor === 'Just') {
					var _p7 = _p6._0;
					return (_elm_lang$core$Native_Utils.cmp(_p7.remainingSeconds, 0) > 0) ? {
						ctor: '::',
						_0: A2(
							_user$project$DjOps$timeRemaining,
							_elm_lang$core$Basics$toString(
								_elm_lang$core$Basics$floor(_p7.remainingSeconds / 60)),
							_elm_lang$core$Basics$toString(
								A2(
									_elm_lang$core$Basics$rem,
									_elm_lang$core$Basics$floor(_p7.remainingSeconds),
									60))),
						_1: {
							ctor: '::',
							_0: A4(
								...
								_p7.title,
								hostLabel,
								A2(_elm_lang$core$String$join, ' & ', _p7.hosts)),
							_1: {ctor: '[]'}
						}
					} : blankInfo;
				} else {
...
var _user$project$DjOps$tick_NowPlayingClocks = function (_p9) {
	var _p10 = _p9;
	var _p14 = _p10._0;
	var _p13 = _p10._1;
	var _p11 = _p14.nowPlaying;
	if (_p11.ctor === 'Just') {
		var _p12 = _p11._0;
		...
		var updatedTrack = A2(_elm_lang$core$Maybe$map, decRemaining, _p12.track);
		var updatedShow = A2(_elm_lang$core$Maybe$map, decRemaining, _p12.show);
...
var _user$project$DjOps$tick_Idle = function (_p15) {
	var _p16 = _p15;
	var _p17 = _p16._0;
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			_p17,
			{keyboardIdleTime: _p17.keyboardIdleTime + 1}),
		_1: _p16._1
	};
};
		...
		while (true) {
			...
			if (_p20.ctor === '[]') {
				...
				var tte = A9(
					...
					_elm_lang$core$Maybe$Just(_p21.id),
					_p21.data.artist,
					_p21.data.title,
					_p21.data.duration,
					_p21.data.trackBroadcast,
					_p21.data.artist,
					_p21.data.title,
					_p21.data.duration,
					_p21.data.trackBroadcast);
				var seq = _p21.data.sequence;
													...
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return function (r) {
																		return {errMsgs: a, keyboardIdleTime: b, mdl: c, xisFlags: d, xis: e, currTime: f, selectedTab: g, shows: h, selectedShow: i, selectedShowDate: j, episode: k, broadcast: l, datePicker: m, member: n, nowPlaying: o, tracksTabEntries: p, userid: q, password: r};
																	};
																};
															};
														};
					...
					return A2(
						_elm_lang$html$Html$option,
						{
							...
							_1: {
								...
								_0: _user$project$DjOps$tagattr(
									function () {
										var _p22 = model.selectedShow;
										if (_p22.ctor === 'Just') {
											return _elm_lang$core$Native_Utils.eq(show.id, _p22._0.id) ? 'selected' : 'dummy';
										} else {
											return 'dummy';
										}
									}()),
...
var _user$project$DjOps$tracks_tableRow = F2(
	function (model, r) {
												...
												_1: {
													...
													_0: A2(
														...
														_elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$DurationColumn) && ((_elm_lang$core$Native_Utils.cmp(
															...
															0) > 0) && function (_p25) {
															return !A2(_elm_lang$core$Regex$contains, mmss, _p25);
														}(tte.duration)),
		...
		var _p26 = A2(_elm_lang$core$Array$get, r, model.tracksTabEntries);
		if (_p26.ctor === 'Just') {
			var _p27 = _p26._0;
			return A2(
				_debois$elm_mdl$Material_Table$tr,
				{
					...
					_0: A2(
						_debois$elm_mdl$Material_Options$css,
						'color',
						_user$project$DjOps$tracksTabEntryIsDirty(_p27) ? 'red' : 'black'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
									...
									_0: A2(
										...
										_user$project$DjOps$firstTdStyle,
										{
											...
											_0: A5(
												...
												model.mdl,
												{
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _debois$elm_mdl$Material_Options$onClick(
																A2(_user$project$DjOps$PlayTrack_Clicked, r, _p27)),
															_1: {
																ctor: '::',
																_0: A2(
																	_debois$elm_mdl$Material_Options$when,
												...
												{
													ctor: '::',
													_0: A3(_user$project$DjOps$tracksTabEntryIcon, model, r, _p27),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
...
var _user$project$DjOps$upsertEpisodeTrack = F3(
	function (model, row, tte) {
		var _p28 = model.episode;
		if (_p28.ctor === 'Just') {
			var etData = A6(
				_user$project$XisRestApi$EpisodeTrackData,
				model.xis.episodeUrl(_p28._0.id),
				row,
				tte.artist,
				tte.title,
				tte.duration,
				tte.trackBroadcast);
			var _p29 = tte.episodeTrackId;
			if (_p29.ctor === 'Just') {
				return A2(
					model.xis.replaceEpisodeTrack,
					A2(_user$project$DjangoRestFramework$Resource, _p29._0, etData),
	...
	function (minIdle, _p31) {
		...
		var reducer = F2(
			function (_p34, _p33) {
				...
				var _p38 = _p36._0;
				var _p37 = _p36._1;
				if (_user$project$DjOps$tracksTabEntryIsDirty(_p40)) {
					var extraCmd = A2(
						...
						}) ? A3(_user$project$DjOps$deleteEpisodeTrack, _p38, _p39, _p40) : A3(_user$project$DjOps$upsertEpisodeTrack, _p38, _p39, _p40);
					return A2(
						_ccapndave$elm_update_extra$Update_Extra$addCmd,
						extraCmd,
						{ctor: '_Tuple2', _0: _p38, _1: _p37});
				} else {
					return {ctor: '_Tuple2', _0: _p38, _1: _p37};
				}
			});
		return (_elm_lang$core$Native_Utils.cmp(_p41.keyboardIdleTime, minIdle) > -1) ? A3(
			_elm_lang$core$List$foldl,
			reducer,
			{ctor: '_Tuple2', _0: _p41, _1: _p32._1},
			_elm_lang$core$Array$toIndexedList(_p41.tracksTabEntries)) : {ctor: '_Tuple2', _0: _p41, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$DjOps$tick_SaveTracksTab = function (_p42) {
	var _p43 = _p42;
	return A2(
...
var _user$project$DjOps$fetchTracksTabData = function (_p44) {
	var _p45 = _p44;
	var _p49 = _p45._0;
	var _p46 = {ctor: '_Tuple2', _0: _p49.selectedShow, _1: _p49.selectedShowDate};
	if (((_p46.ctor === '_Tuple2') && (_p46._0.ctor === 'Just')) && (_p46._1.ctor === 'Just')) {
		var _p48 = _p46._1._0;
		var _p47 = _p46._0._0;
		var tagger = A2(_user$project$DjOps$EpisodeList_Result, _p47, _p48);
		var dateFilter = _user$project$XisRestApi$EpisodeDateEquals(
			_user$project$CalendarDate$fromDate(_p48));
		var showFilter = _user$project$XisRestApi$EpisodeShowEquals(_p47.id);
		var fetchCmd = A2(
			_p49.xis.listEpisodes,
			{
				ctor: '::',
				_0: showFilter,
				_1: {
			...
			tagger);
		return {ctor: '_Tuple2', _0: _p49, _1: fetchCmd};
	} else {
		return {ctor: '_Tuple2', _0: _p49, _1: _p45._1};
	}
};
...
var _user$project$DjOps$tick_NowPlayingCheck = function (_p50) {
	var _p51 = _p50;
	var _p53 = _p51._0;
	var _p52 = _user$project$DjOps$nowPlayingTimeRemaining(_p53);
	var showSecsLeft = _p52.showSecsLeft;
	var trackSecsLeft = _p52.trackSecsLeft;
	...
	return A2(
		...
		A2(
			_ccapndave$elm_update_extra$Update_Extra$addCmd,
			trackCmd,
			{ctor: '_Tuple2', _0: _p53, _1: _p51._1}));
};
var _user$project$DjOps$BroadcastExists_Result = function (a) {
	return {ctor: 'BroadcastExists_Result', _0: a};
};
var _user$project$DjOps$fetchBroadcastData = function (_p54) {
	var _p55 = _p54;
	var _p58 = _p55._0;
	var _p57 = _p55._1;
	var _p56 = _p58.episode;
	if (_p56.ctor === 'Just') {
		...
		var epiFilter = _user$project$XisRestApi$BroadcastsWithEpisodeIdEqualTo(_p56._0.id);
		var fetchCmd = A2(
			_p58.xis.listBroadcasts,
			{
				ctor: '::',
				_0: epiFilter,
				_1: {
					...
					_1: {
						...
						_0: function () {
							if (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.episode) || _elm_community$maybe_extra$Maybe_Extra$isNothing(model.member)) {
								...
								var _p59 = model.selectedShowDate;
								if (_p59.ctor === 'Just') {
									return (!_elm_lang$core$Native_Utils.eq(
										_user$project$CalendarDate$fromDate(_p59._0),
	...
	function (action, model) {
		...
		switch (_p61.ctor) {
			...
			case 'BeginBroadcast_Clicked':
				var _p62 = model.episode;
				if (_p62.ctor === 'Just') {
					var bcData = {
						episode: model.xis.episodeUrl(_p62._0.id),
			...
			case 'Login_Clicked':
				var _p73 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p73.ctor === '_Tuple2') && (_p73._0.ctor === 'Just')) && (_p73._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A3(model.xis.authenticate, _p73._0._0, _p73._1._0, _user$project$DjOps$Authenticate_Result)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p61._0, model);
			case 'PasswordInput':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							password: _elm_lang$core$Maybe$Just(_p61._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'PlayTrack_Clicked':
				var _p78 = _p61._1;
				var _p77 = _p78.episodeTrackId;
				if (_p77.ctor === 'Just') {
					var callback = A2(_user$project$DjOps$TrackBroadastCreate_Result, _p61._0, _p78);
					var trackBroadcastData = {
						...
						nonLibraryTrack: _elm_lang$core$Maybe$Just(
							model.xis.episodeTrackUrl(_p77._0)),
					...
					var dummy = A2(_elm_lang$core$Debug$log, 'EpisodeTrackId is Nothing: ', _p78);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'SelectTab':
				return A2(
			...
			case 'SetDatePicker':
				var _p79 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p61._0, model.datePicker);
				var newDatePicker = _p79._0;
				var datePickerCmd = _p79._1;
				var dateEvent = _p79._2;
				var _p80 = dateEvent;
				if (_p80.ctor === 'NoChange') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return _user$project$DjOps$fetchTracksTabData(
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{selectedShowDate: _p80._0, datePicker: newDatePicker}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$DjOps$SetDatePicker, datePickerCmd)
						});
				}
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p61._0._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'ShowWasChosen':
				var _p82 = _p61._0;
				var _p81 = _elm_lang$core$Result$toMaybe(
					_elm_lang$core$String$toInt(_p82));
				if (_p81.ctor === 'Just') {
					var show = A2(
						_elm_community$list_extra$List_Extra$find,
						function (s) {
							return _elm_lang$core$Native_Utils.eq(s.id, _p81._0);
						},
						model.shows);
					return _user$project$DjOps$fetchTracksTabData(
						{
					...
					var dummy = A2(_elm_lang$core$Debug$log, 'Couldn\'t convert to Int', _p82);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Tick':
			...
			case 'TrackFieldUpdate':
				...
				var tte1 = A2(
					...
					A2(_elm_lang$core$Array$get, _p84, model.tracksTabEntries));
				var tte2 = function () {
					var _p83 = _p61._1;
					switch (_p83.ctor) {
						case 'ArtistColumn':
						...
						default:
							return _elm_lang$core$Native_Utils.update(
								tte1,
								{
									duration: _user$project$DjOps$mmss_mask(_p85)
								});
					}
				}();
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						tracksTabEntries: A3(_elm_lang$core$Array$set, _p84, tte2, model.tracksTabEntries)
					});
			...
			case 'UseridInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							userid: _elm_lang$core$Maybe$Just(_p61._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Authenticate_Result':
				if (_p61._0.ctor === 'Ok') {
					if (_p61._0._0.isAuthentic) {
						...
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								member: _p61._0._0.authenticatedMember,
								xis: A2(
			...
			case 'EpisodeTrackDelete_Result':
				if (_p61._1.ctor === 'Ok') {
					var newTtes = A3(_elm_lang$core$Array$set, _p61._0, _user$project$DjOps$blankTracksTabEntry, model.tracksTabEntries);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p61._1._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'EpisodeTrackUpsert_Result':
				if (_p61._0.ctor === 'Ok') {
					var _p72 = _p61._0._0;
					var _p71 = A2(_elm_lang$core$Array$get, _p72.data.sequence, model.tracksTabEntries);
					if (_p71.ctor === 'Just') {
						var newTte = _elm_lang$core$Native_Utils.update(
							_p71._0,
							{
								episodeTrackId: _elm_lang$core$Maybe$Just(_p72.id),
								savedArtist: _p72.data.artist,
								savedTitle: _p72.data.title,
								savedDuration: _p72.data.duration,
								savedTrackBroadcast: _p72.data.trackBroadcast
							});
						var newTtes = A3(_elm_lang$core$Array$set, _p72.data.sequence, newTte, model.tracksTabEntries);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
						...
						var dummy = A2(_elm_lang$core$Debug$log, 'Couldn\'t find row for', _p72);
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				} else {
					return {
			...
			case 'NowPlaying_Result':
				if (_p61._0.ctor === 'Ok') {
					...
					if (_p74.ctor === 'Just') {
						...
						var modifiedNP = A2(
							_user$project$XisRestApi$NowPlaying,
							((!_elm_lang$core$Native_Utils.eq(mShow, show)) || (!_elm_lang$core$Native_Utils.eq(mHost, host))) ? _p76.show : _p75.show,
							((!_elm_lang$core$Native_Utils.eq(mTitle, title)) || (!_elm_lang$core$Native_Utils.eq(mArtist, artist))) ? _p76.track : _p75.track);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									nowPlaying: _elm_lang$core$Maybe$Just(_p76)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
					...
					var dummy = A2(
						_elm_lang$core$Debug$log,
						'NowPlaying_Result',
						_elm_lang$core$Basics$toString(_p61._0._0));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
				...
				if (_p61._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								broadcast: _elm_lang$core$Maybe$Just(_p61._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
						...
						if (_p63._1.ctor === '[]') {
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										broadcast: _elm_lang$core$Maybe$Just(_p63._0)
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						} else {
									...
									model,
									{
										errMsgs: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$core$Basics$toString(_p64),
													_1: {ctor: '[]'}
												}
											}
										}
			...
			case 'EpisodeCreate_Result':
				if (_p61._2.ctor === 'Ok') {
					...
					var msg = A3(
						...
						_p61._1,
						_elm_lang$core$Result$Ok(
							_user$project$DjangoRestFramework$singletonPageOf(_p65)));
					return A3(
						...
						msg,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									episode: _elm_lang$core$Maybe$Just(_p65)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						});
				} else {
					var dummy = A2(
						...
						_elm_lang$core$Basics$toString(_p61._2._0));
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'EpisodeList_Result':
				if (_p61._2.ctor === 'Ok') {
					var _p70 = _p61._1;
					var _p69 = _p61._0;
					var _p68 = _p61._2._0.results;
					var _p67 = _p61._2._0.count;
					if (_elm_lang$core$Native_Utils.eq(_p67, 1)) {
						var episode = _elm_lang$core$List$head(_p68);
						var tracksForTab = A2(
							_elm_lang$core$Maybe$withDefault,
							{ctor: '[]'},
							A2(
						...
						if (_elm_lang$core$Native_Utils.eq(_p67, 0)) {
							var tagger = A2(_user$project$DjOps$EpisodeCreate_Result, _p69, _p70);
							var selShowUrl = model.xis.showUrl(_p69.id);
							var epData = A4(
								_user$project$XisRestApi$EpisodeData,
								selShowUrl,
								_user$project$CalendarDate$fromDate(_p70),
								'',
								{ctor: '[]'});
							var createCmd = A2(model.xis.createEpisode, epData, tagger);
							return {ctor: '_Tuple2', _0: model, _1: createCmd};
						} else {
							var dummy = A2(_elm_lang$core$Debug$log, '>1 Episode', _p68);
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						}
					}
				} else {
			...
			default:
				if (_p61._2.ctor === 'Ok') {
					var trackBroadcastUrl = model.xis.trackBroadcastUrl(_p61._2._0.id);
					var newTte = _elm_lang$core$Native_Utils.update(
						_p61._1,
						{
							trackBroadcast: _elm_lang$core$Maybe$Just(trackBroadcastUrl)
						});
					var newTtes = A3(_elm_lang$core$Array$set, _p61._0, newTte, model.tracksTabEntries);
					return A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
						_user$project$DjOps$update,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p61._2._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
...
var _user$project$DjOps$AcknowledgeDialog = {ctor: 'AcknowledgeDialog'};
var _user$project$DjOps$err_dialog_config = function (model) {
	return (_elm_lang$core$Native_Utils.cmp(
		...
		{
			closeMessage: _elm_lang$core$Maybe$Just(_user$project$DjOps$AcknowledgeDialog),
