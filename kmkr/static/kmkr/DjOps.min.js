...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var _p12 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
				start: {line: 1191, column: 25},
				end: {line: 1191, column: 36}
												...
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return {authenticateUrl: a, claimListUrl: b, discoveryMethodListUrl: c, emailMembershipInfoUrl: d, logMessageUrl: e, memberListUrl: f, membershipListUrl: g, playListUrl: h, productListUrl: i, showListUrl: j, taskListUrl: k, timeBlocksUrl: l, timeBlockTypesUrl: m, vendLogListUrl: n, visitEventListUrl: o, workListUrl: p, workNoteListUrl: q};
																};
															};
														};
													};
	...
	return {
		...
		_0: A2(
			...
			},
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text('DJ Ops Console'),
					_1: {ctor: '[]'}
				}
			}),
		_1: {ctor: '[]'}
											...
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return {errMsgs: a, mdl: b, xis: c, currTime: d, selectedTab: e, shows: f, chosenShowsId: g, showDate: h, datePicker: i, member: j, state: k, typed: l, rfidsToCheck: m, loggedAsPresent: n, userid: o, password: p};
															};
														};
													};
												};
...
var _user$project$DjOps$tick = F2(
	function (time, model) {
		var _p1 = model.state;
		if (_p1.ctor === 'CheckingAnRfid') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						state: _user$project$DjOps$CheckingAnRfid(_p1._0 + 1)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
...
var _user$project$DjOps$checkAnRfid = function (model) {
	...
	switch (_p4.ctor) {
		...
		case 'FoundRfidToBe':
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		default:
			var _p5 = model.rfidsToCheck;
			if (_p5.ctor === '::') {
				var memberFilters = {
					ctor: '::',
					_0: _user$project$XisRestApi$RfidNumberEquals(_p5._0),
					_1: {ctor: '[]'}
				};
...
var _user$project$DjOps$init = function (flags) {
	...
	var datePickerCmd = _p7._1;
	var auth = function () {
		var _p8 = flags.csrfToken;
		if (_p8.ctor === 'Just') {
			return _user$project$DjangoRestFramework$LoggedIn(_p8._0);
		} else {
...
var _user$project$DjOps$update = F2(
	function (action, model) {
		...
		switch (_p9.ctor) {
			...
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p9._0, model);
			case 'SelectTab':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'Tick':
				...
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{currTime: _p10});
				var seconds = (_elm_lang$core$Basics$round(_p10) / 1000) | 0;
			...
			case 'UseridInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							userid: _elm_lang$core$Maybe$Just(_p9._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'PasswordInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							password: _elm_lang$core$Maybe$Just(_p9._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			...
			case 'SetDatePicker':
				var _p11 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p9._0, model.datePicker);
				var newDatePicker = _p11._0;
				var datePickerCmd = _p11._1;
				var dateEvent = _p11._2;
				var date = function () {
					var _p12 = dateEvent;
					if (_p12.ctor === 'NoChange') {
			...
			case 'KeyDownAuthenticate':
				var _p13 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p13.ctor === '_Tuple2') && (_p13._0.ctor === 'Just')) && (_p13._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _elm_lang$core$Native_Utils.eq(_p9._0, 13) ? A3(model.xis.authenticate, _p13._0._0, _p13._1._0, _user$project$DjOps$Authenticate_Result) : _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Authenticate_Result':
				if (_p9._0.ctor === 'Ok') {
					var errMsgs = _p9._0._0.isAuthentic ? {ctor: '[]'} : {
						ctor: '::',
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{member: _p9._0._0.authenticatedMember, errMsgs: errMsgs}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
			...
			case 'KeyDownRfid':
				...
				if (_elm_lang$core$List$isEmpty(finds)) {
					...
					var hexToInt = function (_p15) {
						return _rtfeldman$hex$Hex$fromString(
							_elm_lang$core$String$toLower(_p15));
					};
				...
				if (_p9._0.ctor === 'Ok') {
						...
						if (_p16._1.ctor === '[]') {
							...
							var newModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									...
									rfidsToCheck: {ctor: '[]'},
									typed: '',
									loggedAsPresent: A2(_elm_lang$core$Set$insert, _p17.id, model.loggedAsPresent)
								});
							var cmd2 = A2(_elm_lang$core$Set$member, _p17.id, model.loggedAsPresent) ? _elm_lang$core$Platform_Cmd$none : A2(
								model.xis.createVisitEvent,
								{
									who: model.xis.memberUrl(_p17.id),
									when: model.currTime,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$DjOps$HitAnHttpErr(_p9._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
																																				...
																																				function (workListUrl) {
																																					return A2(
																																						...
																																						function (workNoteListUrl) {
																																							return _elm_lang$core$Json_Decode$succeed(
																																								{authenticateUrl: authenticateUrl, claimListUrl: claimListUrl, discoveryMethodListUrl: discoveryMethodListUrl, emailMembershipInfoUrl: emailMembershipInfoUrl, logMessageUrl: logMessageUrl, memberListUrl: memberListUrl, membershipListUrl: membershipListUrl, playListUrl: playListUrl, productListUrl: productListUrl, showListUrl: showListUrl, taskListUrl: taskListUrl, timeBlockTypesUrl: timeBlockTypesUrl, timeBlocksUrl: timeBlocksUrl, vendLogListUrl: vendLogListUrl, visitEventListUrl: visitEventListUrl, workListUrl: workListUrl, workNoteListUrl: workNoteListUrl});
																																						},
