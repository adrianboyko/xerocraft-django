												...
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return {errMsgs: a, mdl: b, xis: c, currTime: d, selectedTab: e, shows: f, chosenShowsId: g, showDate: h, datePicker: i, member: j, nowPlaying: k, state: l, typed: m, rfidsToCheck: n, loggedAsPresent: o, userid: p, password: q};
																};
															};
														};
													};
...
var _user$project$DjOps$tableRow = F2(
	function (model, r) {
		var aTd = F4(
			function (s, r, c, opts) {
				return A2(
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							_user$project$DjOps$tableRow(model),
