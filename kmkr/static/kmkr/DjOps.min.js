		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$option,
				{
					...
					_1: {
						ctor: '::',
						_0: _user$project$DjOps$tagattr('selected'),
						_1: {
							ctor: '::',
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {mdl: a, xis: b, currTime: c, selectedTab: d, shows: e, showDate: f, datePicker: g, member: h, state: i, typed: j, rfidsToCheck: k, loggedAsPresent: l};
											};
										};
									};
								};
...
var _user$project$DjOps$tick = F2(
	function (time, model) {
		var _p2 = model.state;
		if (_p2.ctor === 'CheckingAnRfid') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						state: _user$project$DjOps$CheckingAnRfid(_p2._0 + 1)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
...
var _user$project$DjOps$tab_start = function (model) {
	...
	var numTd = _elm_lang$html$Html$td(
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_user$project$DjOps_ops['=>'], 'color', '#3f51b5'),
							_1: {ctor: '[]'}
						}
					}
				}),
									...
									_0: instTd(
										{
											...
											_0: para(
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Use your RFID to log in.'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
...
var _user$project$DjOps$init = function (flags) {
	...
	var datePickerCmd = _p6._1;
	var auth = function () {
		var _p7 = flags.csrfToken;
		if (_p7.ctor === 'Just') {
			return _user$project$DjangoRestFramework$LoggedIn(_p7._0);
		} else {
...
var _user$project$DjOps$update = F2(
	function (action, model) {
		...
		switch (_p8.ctor) {
			...
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p8._0, model);
			case 'SelectTab':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'Tick':
				...
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{currTime: _p9});
				var seconds = (_elm_lang$core$Basics$round(_p9) / 1000) | 0;
			...
			case 'SetDatePicker':
				var _p10 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p8._0, model.datePicker);
				var newDatePicker = _p10._0;
				var datePickerCmd = _p10._1;
				var dateEvent = _p10._2;
				var date = function () {
					var _p11 = dateEvent;
					if (_p11.ctor === 'NoChange') {
						...
						default:
							return A2(
								...
								_elm_lang$core$String$fromChar(
									_elm_lang$core$Char$fromCode(_p12)));
					}
				}();
				...
				if (_p8._0.ctor === 'Ok') {
						...
						if (_p14._1.ctor === '[]') {
							...
							var newModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									...
									rfidsToCheck: {ctor: '[]'},
									typed: '',
									loggedAsPresent: A2(_elm_lang$core$Set$insert, _p15.id, model.loggedAsPresent)
								});
							var cmd2 = A2(_elm_lang$core$Set$member, _p15.id, model.loggedAsPresent) ? _elm_lang$core$Platform_Cmd$none : A2(
								model.xis.createVisitEvent,
								{
									who: model.xis.memberUrl(_p15.id),
									when: model.currTime,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$DjOps$HitAnHttpErr(_p8._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
