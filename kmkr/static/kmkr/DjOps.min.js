...
var _user$project$XisRestApi$deleteEpisodeTrackByUrl = F4(
	function (flags, auth, url, tagger) {
		var request = A2(_user$project$DjangoRestFramework$deleteRequest, auth, url);
		return A2(_elm_lang$http$Http$send, tagger, request);
	});
var _user$project$XisRestApi$deleteEpisodeTrackById = F4(
	function (flags, auth, id, tagger) {
		var url = A2(_user$project$DjangoRestFramework$urlFromId, flags.episodeTrackListUrl, id);
		return A4(_user$project$XisRestApi$deleteEpisodeTrackByUrl, flags, auth, url, tagger);
	});
...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var _p18 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
				start: {line: 1056, column: 25},
				end: {line: 1056, column: 36}
...
var _user$project$XisRestApi$deletePlayByUrl = F4(
	function (flags, auth, url, tagger) {
		var request = A2(_user$project$DjangoRestFramework$deleteRequest, auth, url);
		return A2(_elm_lang$http$Http$send, tagger, request);
	});
var _user$project$XisRestApi$deletePlayById = F4(
	function (flags, auth, id, tagger) {
		var url = A2(_user$project$DjangoRestFramework$urlFromId, flags.playListUrl, id);
		return A4(_user$project$XisRestApi$deletePlayByUrl, flags, auth, url, tagger);
	});
...
var _user$project$XisRestApi$createSession = F2(
	function (flags, auth) {
		return {
			...
			deleteEpisodeTrackById: A2(_user$project$XisRestApi$deleteEpisodeTrackById, flags, auth),
			deleteEpisodeTrackByUrl: A2(_user$project$XisRestApi$deleteEpisodeTrackByUrl, flags, auth),
			deletePlayById: A2(_user$project$XisRestApi$deletePlayById, flags, auth),
			deletePlayByUrl: A2(_user$project$XisRestApi$deletePlayByUrl, flags, auth),
