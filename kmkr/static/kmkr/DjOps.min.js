...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var _p12 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
				start: {line: 1197, column: 25},
				end: {line: 1197, column: 36}
...
var _user$project$XisRestApi$encodePlayData = function (_p16) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$playDataNVPs(_p16));
};
...
var _user$project$XisRestApi$playListFilterToString = function (filter) {
	var _p17 = filter;
	switch (_p17.ctor) {
		...
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'play_date=',
				_user$project$CalendarDate$toString(_p17._0));
	}
};
...
var _user$project$XisRestApi$encodeWorkData = function (_p18) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$workDataNVPs(_p18));
};
...
var _user$project$XisRestApi$workListFilterToString = function (filter) {
	var _p19 = filter;
	if (_p19.ctor === 'WorkedClaimEquals') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'claim=',
...
var _user$project$XisRestApi$encodeClaimData = function (_p21) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$claimDataNVPs(_p21));
};
	...
	switch (_p23.ctor) {
		case 'ClaimStatusEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'status=',
				_user$project$XisRestApi$claimStatusValue(_p23._0));
...
var _user$project$XisRestApi$memberHasStatusOnTask = F4(
	function (flags, memberNum, questionedStatus, task) {
		...
		var _p26 = actualStatus;
		if (_p26.ctor === 'Nothing') {
			return false;
		} else {
			return _elm_lang$core$Native_Utils.eq(_p26._0, questionedStatus);
		}
	});
var _user$project$XisRestApi$taskListFilterToString = function (filter) {
	...
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'scheduled_date=',
		_user$project$CalendarDate$toString(_p27._0));
};
														...
														return function (o) {
															return function (p) {
																return function (q) {
																	return function (r) {
																		return function (s) {
																			return {authenticateUrl: a, claimListUrl: b, discoveryMethodListUrl: c, emailMembershipInfoUrl: d, logMessageUrl: e, memberListUrl: f, membershipListUrl: g, nowPlayingUrl: h, playListUrl: i, productListUrl: j, showListUrl: k, taskListUrl: l, timeBlocksUrl: m, timeBlockTypesUrl: n, trackListUrl: o, vendLogListUrl: p, visitEventListUrl: q, workListUrl: r, workNoteListUrl: s};
																		};
																	};
																};
															};
																																																	...
																																																	return function (_24) {
																																																		return function (_25) {
																																																			return function (_26) {
																																																				return function (_27) {
																																																					return function (_28) {
																																																						return {getMembershipById: a, getPlayByUrl: b, getTaskById: c, getTaskFromUrl: d, getWorkFromUrl: e, createClaim: f, createPlay: g, createVendLog: h, createVisitEvent: i, createWork: j, createWorkNote: k, deletePlayById: l, deletePlayByUrl: m, deleteWorkById: n, deleteWorkByUrl: o, listClaims: p, listDiscoveryMethods: q, listMembers: r, listMemberships: s, listPlays: t, listShows: u, listTasks: v, listTimeBlocks: w, listTimeBlockTypes: x, listVisitEvents: y, listWorks: z, moreVisitEvents: _1, replaceClaim: _2, replaceWork: _3, replacePlay: _4, claimUrl: _5, memberUrl: _6, productUrl: _7, showUrl: _8, taskUrl: _9, vendLogUrl: _10, visitEventUrl: _11, workUrl: _12, workNoteUrl: _13, authenticate: _14, blockHasType: _15, coverTime: _16, defaultBlockType: _17, emailMembershipInfo: _18, logMessage: _19, getBlocksTypes: _20, memberCanClaimTask: _21, memberHasStatusOnTask: _22, membersClaimOnTask: _23, membersStatusOnTask: _24, membersWithStatusOnTask: _25, mostRecentMembership: _26, nowPlaying: _27, pitInBlock: _28};
																																																					};
																																																				};
																																																			};
																																																		};
...
var _user$project$XisRestApi$decodeWorkNoteData = A3(
	...
	A2(
		...
		function (_p28) {
			return _elm_community$json_extra$Json_Decode_Extra$fromResult(
				_user$project$PointInTime$fromString(_p28));
		},
		_elm_lang$core$Json_Decode$string),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
...
var _user$project$XisRestApi$listPlays = F4(
	function (flags, auth, filters, resultToMsg) {
		var request = A3(
			_user$project$DjangoRestFramework$getRequest,
			auth,
			A3(_user$project$XisRestApi$filteredListUrl, flags.playListUrl, filters, _user$project$XisRestApi$playListFilterToString),
...
var _user$project$XisRestApi$taskPriorityDecoder = A2(
	...
	function (str) {
		...
		switch (_p29) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown priority: ', _p29));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$staffingStatusDecoder = A2(
	...
	function (str) {
		...
		switch (_p30) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown staffing status: ', _p30));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeClaimStatus = A2(
	...
	function (str) {
		...
		switch (_p31) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown claim status: ', _p31));
		}
	},
	_elm_lang$core$Json_Decode$string);
																																								...
																																								function (workListUrl) {
																																									return A2(
																																										...
																																										function (workNoteListUrl) {
																																											return _elm_lang$core$Json_Decode$succeed(
																																												{authenticateUrl: authenticateUrl, claimListUrl: claimListUrl, discoveryMethodListUrl: discoveryMethodListUrl, emailMembershipInfoUrl: emailMembershipInfoUrl, logMessageUrl: logMessageUrl, memberListUrl: memberListUrl, membershipListUrl: membershipListUrl, nowPlayingUrl: nowPlayingUrl, playListUrl: playListUrl, productListUrl: productListUrl, showListUrl: showListUrl, taskListUrl: taskListUrl, timeBlockTypesUrl: timeBlockTypesUrl, timeBlocksUrl: timeBlocksUrl, trackListUrl: trackListUrl, vendLogListUrl: vendLogListUrl, visitEventListUrl: visitEventListUrl, workListUrl: workListUrl, workNoteListUrl: workNoteListUrl});
																																										},
