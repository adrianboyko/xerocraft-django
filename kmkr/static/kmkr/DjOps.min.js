...
var _user$project$XisRestApi$episodeTrackDataNVPs = function (etd) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
...
var _user$project$XisRestApi$encodeEpisodeTrackData = function (_p1) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$episodeTrackDataNVPs(_p1));
};
...
var _user$project$XisRestApi$encodeEpisodeData = function (_p2) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$episodeDataNVPs(_p2));
};
var _user$project$XisRestApi$episodeFilterToString = function (filter) {
	var _p3 = filter;
	if (_p3.ctor === 'EpisodeDateEquals') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'first_broadcast=',
			_user$project$CalendarDate$toString(_p3._0));
	} else {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'show=',
...
var _user$project$XisRestApi$broadcastFilterToString = function (filter) {
	var _p5 = filter;
	if (_p5.ctor === 'BroadcastsWithEpisodeIdEqualTo') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'episode=',
		...
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'type=',
			_user$project$XisRestApi$broadcastTypeToString(_p5._0));
	}
};
...
var _user$project$XisRestApi$encodeBroadcastData = function (_p6) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$broadcastDataNVPs(_p6));
};
var _user$project$XisRestApi$replaceAll = F2(
	function (_p7, whole) {
		...
		return A4(
			_elm_lang$core$Regex$replace,
			_elm_lang$core$Regex$All,
			_elm_lang$core$Regex$regex(_p8.oldSub),
			function (_p9) {
				return _p8.newSub;
			},
			whole);
	...
	switch (_p13.ctor) {
		case 'VEF_WhenGreaterOrEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'when__gte=',
				_user$project$PointInTime$isoString(_p13._0));
		case 'VEF_EventTypeEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'event_type=',
				_user$project$XisRestApi$eventTypeString(_p13._0));
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'method=',
				_user$project$XisRestApi$eventMethodString(_p13._0));
	}
};
...
var _user$project$XisRestApi$encodeVisitEventDataOut = function (_p14) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$visitEventDataNVPs(_p14));
};
...
var _user$project$XisRestApi$encodeVendLogData = function (_p15) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$vendLogDataNVPs(_p15));
};
...
var _user$project$XisRestApi$coverTime = F2(
	function (memberships, now) {
		var _p16 = _user$project$XisRestApi$mostRecentMembership(memberships);
		if (_p16.ctor === 'Nothing') {
			return false;
		} else {
			var _p17 = _p16._0;
			var membershipRange = A2(_user$project$RangeOfTime$fromCalendarDates, _p17.data.startDate, _p17.data.endDate);
...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var bd = block.data;
		var _p19 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
...
var _user$project$XisRestApi$memberFilterToString = function (filter) {
	...
	switch (_p22.ctor) {
		...
		case 'EmailEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__email__iexact=', _p22._0);
		case 'UsernameEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__iexact=', _p22._0);
		case 'UsernameContains':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__icontains=', _p22._0);
		case 'UsernameStartsWith':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__istartswith=', _p22._0);
		case 'LastNameStartsWith':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__last_name__istartswith=', _p22._0);
		case 'LastNameEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__last_name__iexact=', _p22._0);
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
...
var _user$project$XisRestApi$encodePlayData = function (_p23) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$playDataNVPs(_p23));
};
	...
	switch (_p24.ctor) {
		...
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'play_date=',
				_user$project$CalendarDate$toString(_p24._0));
	}
};
...
var _user$project$XisRestApi$encodeWorkNoteData = function (_p25) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$workNoteDataNVPs(_p25));
};
...
var _user$project$XisRestApi$encodeWorkData = function (_p26) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$workDataNVPs(_p26));
};
var _user$project$XisRestApi$workFilterToString = function (filter) {
	var _p27 = filter;
	if (_p27.ctor === 'WorkedClaimEquals') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'claim=',
...
var _user$project$XisRestApi$encodeClaimData = function (_p29) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$claimDataNVPs(_p29));
};
	...
	switch (_p31.ctor) {
		case 'ClaimStatusEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'status=',
				_user$project$XisRestApi$claimStatusValue(_p31._0));
...
var _user$project$XisRestApi$memberHasStatusOnTask = F4(
	function (flags, memberNum, questionedStatus, task) {
		...
		var _p34 = actualStatus;
		if (_p34.ctor === 'Nothing') {
			return false;
		} else {
			return _elm_lang$core$Native_Utils.eq(_p34._0, questionedStatus);
		}
	});
var _user$project$XisRestApi$taskFilterToString = function (filter) {
	...
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'scheduled_date=',
		_user$project$CalendarDate$toString(_p35._0));
};
...
var _user$project$XisRestApi$decodeWorkNoteData = A3(
	...
	A2(
		...
		function (_p36) {
			return _elm_community$json_extra$Json_Decode_Extra$fromResult(
				_user$project$PointInTime$fromString(_p36));
		},
		_elm_lang$core$Json_Decode$string),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
...
var _user$project$XisRestApi$EpisodeTrackData = F5(
	function (a, b, c, d, e) {
		return {episode: a, sequence: b, artist: c, title: d, duration: e};
	});
var _user$project$XisRestApi$decodeEpisodeTrackData = A6(
	_elm_lang$core$Json_Decode$map5,
...
var _user$project$XisRestApi$taskPriorityDecoder = A2(
	...
	function (str) {
		...
		switch (_p37) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown priority: ', _p37));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$staffingStatusDecoder = A2(
	...
	function (str) {
		...
		switch (_p38) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown staffing status: ', _p38));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeClaimStatus = A2(
	...
	function (str) {
		...
		switch (_p39) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown claim status: ', _p39));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeVisitEventType = A2(
	...
	function (str) {
		...
		switch (_p42) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown visit event type: ', _p42));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$broadcastTypeDecoder = A2(
	...
	function (str) {
		...
		switch (_p43) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown broadcast type: ', _p43));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$DjOps$tick_NowPlaying = function (_p9) {
	var _p10 = _p9;
	var _p16 = _p10._0;
	var _p15 = _p10._1;
	var _p11 = _p16.nowPlaying;
	if (_p11.ctor === 'Just') {
		var _p14 = _p11._0;
		var _p12 = _p14.track;
		if (_p12.ctor === 'Just') {
			var _p13 = _p12._0;
			var updatedTrack = _elm_lang$core$Native_Utils.update(
				_p13,
				{remainingSeconds: _p13.remainingSeconds - 1});
			var updatedNowPlaying = _elm_lang$core$Native_Utils.update(
				_p14,
				{
					track: _elm_lang$core$Maybe$Just(updatedTrack)
				});
			...
			return {ctor: '_Tuple2', _0: updatedModel, _1: _p15};
		} else {
...
var _user$project$DjOps$tick_Idle = function (_p17) {
	var _p18 = _p17;
	var _p19 = _p18._0;
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			_p19,
			{keyboardIdleTime: _p19.keyboardIdleTime + 1}),
		_1: _p18._1
	};
};
...
var _user$project$DjOps$TracksTabEntry = F8(
	function (a, b, c, d, e, f, g, h) {
		return {episodeTrackId: a, artist: b, title: c, duration: d, savedArtist: e, savedTitle: f, savedDuration: g, trackBroadcast: h};
	});
var _user$project$DjOps$newTracksTabEntry = F7(
	function (id, artist, title, duration, sArtist, sTitle, sDuration) {
		return A8(_user$project$DjOps$TracksTabEntry, id, artist, title, duration, sArtist, sTitle, sDuration, _elm_lang$core$Maybe$Nothing);
	});
var _user$project$DjOps$blankTracksTabEntry = A7(_user$project$DjOps$newTracksTabEntry, _elm_lang$core$Maybe$Nothing, '', '', '', '', '', '');
var _user$project$DjOps$populateTracksTabData_Helper = F2(
	function (model, plesRemaining) {
		populateTracksTabData_Helper:
		while (true) {
			var _p22 = plesRemaining;
			if (_p22.ctor === '[]') {
				return model;
			} else {
				var _p23 = _p22._0;
				var tte = A7(
					_user$project$DjOps$newTracksTabEntry,
					_elm_lang$core$Maybe$Just(_p23.id),
					_p23.data.artist,
					_p23.data.title,
					_p23.data.duration,
					_p23.data.artist,
...
var _user$project$DjOps$populateTracksTabData = F2(
	function (ples, model) {
		...
		return A2(_user$project$DjOps$populateTracksTabData_Helper, newModel, ples);
	});
					...
					return A2(
						_elm_lang$html$Html$option,
						{
							...
							_1: {
								...
								_0: _user$project$DjOps$tagattr(
									function () {
										var _p24 = model.selectedShow;
										if (_p24.ctor === 'Just') {
											return _elm_lang$core$Native_Utils.eq(show.id, _p24._0.id) ? 'selected' : 'dummy';
										} else {
											return 'dummy';
										}
									}()),
...
var _user$project$DjOps$init = function (flags) {
	var _p25 = _elm_community$elm_datepicker$DatePicker$init;
	var datePicker = _p25._0;
	var datePickerCmd = _p25._1;
	var model = {
		errMsgs: {ctor: '[]'},
		keyboardIdleTime: 0,
	...
	var nowPlayingCmd = model.xis.nowPlaying(_user$project$DjOps$NowPlaying_Result);
...
var _user$project$DjOps$tracks_tableRow = F2(
	function (model, r) {
												...
												_1: {
													...
													_0: A2(
														...
														_elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$DurationColumn) && ((_elm_lang$core$Native_Utils.cmp(
															...
															0) > 0) && function (_p27) {
															return !A2(_elm_lang$core$Regex$contains, mmss, _p27);
														}(tte.duration)),
		...
		var _p28 = A2(_elm_lang$core$Array$get, r, model.tracksTabEntries);
		if (_p28.ctor === 'Just') {
			var _p29 = _p28._0;
			return A2(
				_debois$elm_mdl$Material_Table$tr,
				{
					...
					_0: A2(
						_debois$elm_mdl$Material_Options$css,
						'color',
						_user$project$DjOps$tracksTabEntryIsDirty(_p29) ? 'red' : 'black'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
											...
											_0: A5(
												...
												model.mdl,
												{
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _debois$elm_mdl$Material_Options$onClick(
																A2(_user$project$DjOps$PlayTrack_Clicked, r, _p29)),
															_1: {ctor: '[]'}
														}
													}
												},
												{
													...
													_0: _debois$elm_mdl$Material_Icon$i(
														_elm_community$maybe_extra$Maybe_Extra$isJust(_p29.trackBroadcast) ? 'done' : 'play_arrow'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
...
var _user$project$DjOps$upsertEpisodeTrack = F3(
	function (model, row, tte) {
		var _p30 = model.episode;
		if (_p30.ctor === 'Just') {
			var etData = A5(
				_user$project$XisRestApi$EpisodeTrackData,
				model.xis.episodeUrl(_p30._0.id),
				row,
				tte.artist,
				tte.title,
				tte.duration);
			var _p31 = tte.episodeTrackId;
			if (_p31.ctor === 'Just') {
				return A2(
					model.xis.replaceEpisodeTrack,
					A2(_user$project$DjangoRestFramework$Resource, _p31._0, etData),
	...
	function (minIdle, _p33) {
		...
		var reducer = F2(
			function (_p36, _p35) {
				...
				var _p40 = _p38._0;
				var _p39 = _p38._1;
				if (_user$project$DjOps$tracksTabEntryIsDirty(_p42)) {
					var extraCmd = A2(
						...
						}) ? A3(_user$project$DjOps$deleteEpisodeTrack, _p40, _p41, _p42) : A3(_user$project$DjOps$upsertEpisodeTrack, _p40, _p41, _p42);
					return A2(
						_ccapndave$elm_update_extra$Update_Extra$addCmd,
						extraCmd,
						{ctor: '_Tuple2', _0: _p40, _1: _p39});
				} else {
					return {ctor: '_Tuple2', _0: _p40, _1: _p39};
				}
			});
		return (_elm_lang$core$Native_Utils.cmp(_p43.keyboardIdleTime, minIdle) > -1) ? A3(
			_elm_lang$core$List$foldl,
			reducer,
			{ctor: '_Tuple2', _0: _p43, _1: _p34._1},
			_elm_lang$core$Array$toIndexedList(_p43.tracksTabEntries)) : {ctor: '_Tuple2', _0: _p43, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$DjOps$tick_SaveTracksTab = function (_p44) {
	var _p45 = _p44;
	return A2(
...
var _user$project$DjOps$fetchTracksTabData = function (_p46) {
	var _p47 = _p46;
	var _p51 = _p47._0;
	var _p48 = {ctor: '_Tuple2', _0: _p51.selectedShow, _1: _p51.selectedShowDate};
	if (((_p48.ctor === '_Tuple2') && (_p48._0.ctor === 'Just')) && (_p48._1.ctor === 'Just')) {
		var _p50 = _p48._1._0;
		var _p49 = _p48._0._0;
		var tagger = A2(_user$project$DjOps$EpisodeList_Result, _p49, _p50);
		var dateFilter = _user$project$XisRestApi$EpisodeDateEquals(
			_user$project$CalendarDate$fromDate(_p50));
		var showFilter = _user$project$XisRestApi$EpisodeShowEquals(_p49.id);
		var fetchCmd = A2(
			_p51.xis.listEpisodes,
			{
				ctor: '::',
				_0: showFilter,
				_1: {
			...
			tagger);
		return {ctor: '_Tuple2', _0: _p51, _1: fetchCmd};
	} else {
		return {ctor: '_Tuple2', _0: _p51, _1: _p47._1};
	}
};
...
var _user$project$DjOps$fetchBroadcastData = function (_p52) {
	var _p53 = _p52;
	var _p56 = _p53._0;
	var _p55 = _p53._1;
	var _p54 = _p56.episode;
	if (_p54.ctor === 'Just') {
		...
		var epiFilter = _user$project$XisRestApi$BroadcastsWithEpisodeIdEqualTo(_p54._0.id);
		var fetchCmd = A2(
			_p56.xis.listBroadcasts,
			{
				ctor: '::',
				_0: epiFilter,
				_1: {
					...
					_1: {
						...
						_0: function () {
							if (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.episode) || _elm_community$maybe_extra$Maybe_Extra$isNothing(model.member)) {
								...
								var _p57 = model.selectedShowDate;
								if (_p57.ctor === 'Just') {
									return (!_elm_lang$core$Native_Utils.eq(
										_user$project$CalendarDate$fromDate(_p57._0),
	...
	function (action, model) {
		...
		switch (_p59.ctor) {
			...
			case 'BeginBroadcast_Clicked':
				var _p60 = model.episode;
				if (_p60.ctor === 'Just') {
					var bcData = {
						episode: model.xis.episodeUrl(_p60._0.id),
			...
			case 'Login_Clicked':
				var _p71 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p71.ctor === '_Tuple2') && (_p71._0.ctor === 'Just')) && (_p71._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A3(model.xis.authenticate, _p71._0._0, _p71._1._0, _user$project$DjOps$Authenticate_Result)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p59._0, model);
			case 'PasswordInput':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							password: _elm_lang$core$Maybe$Just(_p59._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'PlayTrack_Clicked':
				var _p75 = _p59._1;
				var _p74 = _p75.episodeTrackId;
				if (_p74.ctor === 'Just') {
					var callback = A2(_user$project$DjOps$TrackBroadastCreate_Result, _p59._0, _p75);
					var trackBroadcastData = {
						...
						nonLibraryTrack: _elm_lang$core$Maybe$Just(
							model.xis.episodeTrackUrl(_p74._0)),
					...
					var dummy = A2(_elm_lang$core$Debug$log, 'EpisodeTrackId is Nothing: ', _p75);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'SelectTab':
				return A2(
			...
			case 'SetDatePicker':
				var _p76 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p59._0, model.datePicker);
				var newDatePicker = _p76._0;
				var datePickerCmd = _p76._1;
				var dateEvent = _p76._2;
				var _p77 = dateEvent;
				if (_p77.ctor === 'NoChange') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return _user$project$DjOps$fetchTracksTabData(
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{selectedShowDate: _p77._0, datePicker: newDatePicker}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$DjOps$SetDatePicker, datePickerCmd)
						});
				}
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p59._0._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'ShowWasChosen':
				var _p79 = _p59._0;
				var _p78 = _elm_lang$core$Result$toMaybe(
					_elm_lang$core$String$toInt(_p79));
				if (_p78.ctor === 'Just') {
					var show = A2(
						_elm_community$list_extra$List_Extra$find,
						function (s) {
							return _elm_lang$core$Native_Utils.eq(s.id, _p78._0);
						},
						model.shows);
					return _user$project$DjOps$fetchTracksTabData(
						{
					...
					var dummy = A2(_elm_lang$core$Debug$log, 'Couldn\'t convert to Int', _p79);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Tick':
				return _user$project$DjOps$tick_SaveTracksTab(
					_user$project$DjOps$tick_Idle(
						_user$project$DjOps$tick_NowPlaying(
							{
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
			...
			case 'TrackFieldUpdate':
				...
				var tte1 = A2(
					...
					A2(_elm_lang$core$Array$get, _p81, model.tracksTabEntries));
				var tte2 = function () {
					var _p80 = _p59._1;
					switch (_p80.ctor) {
						case 'ArtistColumn':
						...
						default:
							return _elm_lang$core$Native_Utils.update(
								tte1,
								{
									duration: _user$project$DjOps$mmss_mask(_p82)
								});
					}
				}();
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						tracksTabEntries: A3(_elm_lang$core$Array$set, _p81, tte2, model.tracksTabEntries)
					});
			...
			case 'UseridInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							userid: _elm_lang$core$Maybe$Just(_p59._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Authenticate_Result':
				if (_p59._0.ctor === 'Ok') {
					if (_p59._0._0.isAuthentic) {
						...
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								member: _p59._0._0.authenticatedMember,
								xis: A2(
			...
			case 'EpisodeTrackDelete_Result':
				if (_p59._1.ctor === 'Ok') {
					var newTtes = A3(_elm_lang$core$Array$set, _p59._0, _user$project$DjOps$blankTracksTabEntry, model.tracksTabEntries);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p59._1._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'EpisodeTrackUpsert_Result':
				if (_p59._0.ctor === 'Ok') {
					var _p70 = _p59._0._0;
					var _p69 = A2(_elm_lang$core$Array$get, _p70.data.sequence, model.tracksTabEntries);
					if (_p69.ctor === 'Just') {
						var newTte = _elm_lang$core$Native_Utils.update(
							_p69._0,
							{
								episodeTrackId: _elm_lang$core$Maybe$Just(_p70.id),
								savedArtist: _p70.data.artist,
								savedTitle: _p70.data.title,
								savedDuration: _p70.data.duration
							});
						var newTtes = A3(_elm_lang$core$Array$set, _p70.data.sequence, newTte, model.tracksTabEntries);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
						...
						var dummy = A2(_elm_lang$core$Debug$log, 'Couldn\'t find row for', _p70);
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				} else {
					return {
			...
			case 'NowPlaying_Result':
				if (_p59._0.ctor === 'Ok') {
					var _p73 = _p59._0._0;
					var delaySeconds = function () {
						var _p72 = _p73.track;
						if (_p72.ctor === 'Just') {
							var rs = _p72._0.remainingSeconds;
							return (_elm_lang$core$Native_Utils.cmp(rs, 0) > 0) ? (rs * _elm_lang$core$Time$second) : (((_elm_lang$core$Native_Utils.cmp(rs, 1) < 0) && (_elm_lang$core$Native_Utils.cmp(rs, -5) > 0)) ? (0.1 * _elm_lang$core$Time$second) : (1 * _elm_lang$core$Time$second));
						} else {
							return 1 * _elm_lang$core$Time$second;
						}
					}();
					var nowPlayingCmd = model.xis.nowPlaying(_user$project$DjOps$NowPlaying_Result);
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								nowPlaying: _elm_lang$core$Maybe$Just(_p73)
							}),
						_1: A2(_user$project$DjOps$delay, delaySeconds, _user$project$DjOps$CheckNowPlaying)
					};
				} else {
					var dummy = A2(
						_elm_lang$core$Debug$log,
				...
				if (_p59._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								broadcast: _elm_lang$core$Maybe$Just(_p59._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
						...
						if (_p61._1.ctor === '[]') {
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										broadcast: _elm_lang$core$Maybe$Just(_p61._0)
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						} else {
									...
									model,
									{
										errMsgs: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$core$Basics$toString(_p62),
													_1: {ctor: '[]'}
												}
											}
										}
			...
			case 'EpisodeCreate_Result':
				if (_p59._2.ctor === 'Ok') {
					...
					var msg = A3(
						...
						_p59._1,
						_elm_lang$core$Result$Ok(
							_user$project$DjangoRestFramework$singletonPageOf(_p63)));
					return A3(
						...
						msg,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									episode: _elm_lang$core$Maybe$Just(_p63)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						});
				} else {
					var dummy = A2(
						...
						_elm_lang$core$Basics$toString(_p59._2._0));
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'EpisodeList_Result':
				if (_p59._2.ctor === 'Ok') {
					var _p68 = _p59._1;
					var _p67 = _p59._0;
					var _p66 = _p59._2._0.results;
					var _p65 = _p59._2._0.count;
					if (_elm_lang$core$Native_Utils.eq(_p65, 1)) {
						var episode = _elm_lang$core$List$head(_p66);
						var tracksForTab = A2(
							_elm_lang$core$Maybe$withDefault,
							{ctor: '[]'},
							A2(
						...
						if (_elm_lang$core$Native_Utils.eq(_p65, 0)) {
							var tagger = A2(_user$project$DjOps$EpisodeCreate_Result, _p67, _p68);
							var selShowUrl = model.xis.showUrl(_p67.id);
							var epData = A4(
								_user$project$XisRestApi$EpisodeData,
								selShowUrl,
								_user$project$CalendarDate$fromDate(_p68),
								'',
								{ctor: '[]'});
							var createCmd = A2(model.xis.createEpisode, epData, tagger);
							return {ctor: '_Tuple2', _0: model, _1: createCmd};
						} else {
							var dummy = A2(_elm_lang$core$Debug$log, '>1 Episode', _p66);
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						}
					}
				} else {
			...
			default:
				if (_p59._2.ctor === 'Ok') {
					var newTracksTabEntry = _elm_lang$core$Native_Utils.update(
						_p59._1,
						{
							trackBroadcast: _elm_lang$core$Maybe$Just(_p59._2._0)
						});
					var newTracksTabEntries = A3(_elm_lang$core$Array$set, _p59._0, newTracksTabEntry, model.tracksTabEntries);
					return A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
						_user$project$DjOps$update,
						_user$project$DjOps$CheckNowPlaying,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{tracksTabEntries: newTracksTabEntries}),
							_1: _elm_lang$core$Platform_Cmd$none
						});
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p59._2._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
