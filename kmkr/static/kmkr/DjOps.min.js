...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var _p18 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
				start: {line: 1032, column: 25},
				end: {line: 1032, column: 36}
...
var _user$project$XisRestApi$getPlayFromUrl = F4(
	function (flags, auth, url, resultToMsg) {
		var request = A3(
			_user$project$DjangoRestFramework$getRequest,
			auth,
...
var _user$project$XisRestApi$getTaskFromUrl = F4(
	function (flags, auth, url, resultToMsg) {
		var request = A3(
			...
			auth,
			url,
			_user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodeTaskData));
		return A2(_elm_lang$http$Http$send, resultToMsg, request);
	});
...
var _user$project$XisRestApi$createSession = F2(
	function (flags, auth) {
		return {
			...
			getPlayByUrl: A2(_user$project$XisRestApi$getPlayFromUrl, flags, auth),
