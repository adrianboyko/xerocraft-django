...
var _jackwillis$elm_dialog$Dialog$map = F2(
	function (f, config) {
		return {
...
var _jackwillis$elm_dialog$Dialog$mapMaybe = function (_p0) {
	return _elm_lang$core$Maybe$map(
		_jackwillis$elm_dialog$Dialog$map(_p0));
};
var _jackwillis$elm_dialog$Dialog$backdrop = function (config) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _jackwillis$elm_dialog$Dialog$wrapFooter = function (_p1) {
	var _p2 = _p1;
	var _p3 = _p2.footer;
	if (_p3.ctor === 'Nothing') {
		return _krisajenkins$elm_exts$Exts_Html_Bootstrap$empty;
...
var _jackwillis$elm_dialog$Dialog$wrapBody = function (_p4) {
	var _p5 = _p4;
	var _p6 = _p5.body;
	if (_p6.ctor === 'Nothing') {
		return _krisajenkins$elm_exts$Exts_Html_Bootstrap$empty;
	} else {
		var ariaAttributes = function () {
			var _p7 = _p5.containerId;
			if (_p7.ctor === 'Nothing') {
				return {ctor: '[]'};
			} else {
				return {
					...
					_0: _elm_lang$html$Html_Attributes$id(
						A2(_elm_lang$core$Basics_ops['++'], _p7._0, '_body')),
					_1: {ctor: '[]'}
				};
			}
		}();
...
var _jackwillis$elm_dialog$Dialog$closeButton = function (closeMessage) {
	return A2(
		_elm_lang$html$Html$button,
		{
			ctor: '::',
...
var _jackwillis$elm_dialog$Dialog$wrapHeader = function (_p8) {
	var _p9 = _p8;
	var _p12 = _p9.header;
	var _p11 = _p9.closeMessage;
	if (_elm_lang$core$Native_Utils.eq(_p11, _elm_lang$core$Maybe$Nothing) && _elm_lang$core$Native_Utils.eq(_p12, _elm_lang$core$Maybe$Nothing)) {
		return _krisajenkins$elm_exts$Exts_Html_Bootstrap$empty;
	} else {
		var ariaAttributes = function () {
			var _p10 = _p9.containerId;
			if (_p10.ctor === 'Nothing') {
				return {ctor: '[]'};
			} else {
				return {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id(
						A2(_elm_lang$core$Basics_ops['++'], _p10._0, '_header')),
					_1: {ctor: '[]'}
				};
			}
		}();
		return A2(
			...
			{
				ctor: '::',
				_0: A3(_krisajenkins$elm_exts$Exts_Maybe$maybe, _krisajenkins$elm_exts$Exts_Html_Bootstrap$empty, _jackwillis$elm_dialog$Dialog$closeButton, _p11),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Maybe$withDefault, _krisajenkins$elm_exts$Exts_Html_Bootstrap$empty, _p12),
					_1: {ctor: '[]'}
				}
			});
	}
};
var _jackwillis$elm_dialog$Dialog$view = function (maybeConfig) {
	var maybeContainerId = A2(
		_elm_lang$core$Maybe$andThen,
		function (_) {
			return _.containerId;
		},
		maybeConfig);
	var ariaAttributes = function () {
		var _p13 = maybeContainerId;
		if (_p13.ctor === 'Nothing') {
			return {ctor: '[]'};
		} else {
			var _p14 = _p13._0;
			return {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id(_p14),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html_Attributes$attribute,
							'aria-labelledby',
							A2(_elm_lang$core$Basics_ops['++'], _p14, '_header')),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html_Attributes$attribute,
								'aria-describedby',
								A2(_elm_lang$core$Basics_ops['++'], _p14, '_body')),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	return A2(
		...
		function () {
			...
			if (_p15.ctor === 'Nothing') {
				...
				return {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class(_p15._0),
					_1: {ctor: '[]'}
				};
			}
		}(),
		{
							...
							_0: A2(
								...
								function () {
									...
									if (_p16.ctor === 'Nothing') {
										...
										return {
											ctor: '::',
											_0: _jackwillis$elm_dialog$Dialog$wrapHeader(_p17),
											_1: {
												ctor: '::',
												_0: _jackwillis$elm_dialog$Dialog$wrapBody(_p17),
												_1: {
													ctor: '::',
													_0: _jackwillis$elm_dialog$Dialog$wrapFooter(_p17),
													_1: {ctor: '[]'}
												}
											}
										};
			...
			_1: {
				ctor: '::',
				_0: _jackwillis$elm_dialog$Dialog$backdrop(maybeConfig),
				_1: {ctor: '[]'}
			}
		});
};
var _jackwillis$elm_dialog$Dialog$Config = F6(
	function (a, b, c, d, e, f) {
		return {closeMessage: a, containerClass: b, containerId: c, header: d, body: e, footer: f};
	});
...
var _user$project$CalendarDate$fromPointInTime = _user$project$CalendarDate$fromTime;
...
var _user$project$ClockTime$toString = function (ct) {
	return A2(_user$project$ClockTime$format, '%H:%M', ct);
};
...
var _user$project$ClockTime$fromPointInTime = _user$project$ClockTime$fromTime;
...
var _user$project$DjangoRestFramework$authenticationHeader = function (auth) {
	...
	switch (_p1.ctor) {
		...
		case 'Basic':
			return A2(_kallaspriit$elm_basic_auth$BasicAuth$buildAuthorizationHeader, _p1._0, _p1._1);
		default:
...
var _user$project$DjangoRestFramework$deleteResourceByUrl = F3(
	function (auth, resUrl, tagger) {
		var request = A2(_user$project$DjangoRestFramework$deleteRequest, auth, resUrl);
...
var _user$project$DjangoRestFramework$deleteResourceById = F4(
	function (auth, listUrl, id, tagger) {
		var url = A2(_user$project$DjangoRestFramework$urlFromId, listUrl, id);
		return A3(_user$project$DjangoRestFramework$deleteResourceByUrl, auth, url, tagger);
	});
...
var _user$project$DjangoRestFramework$filteredListUrl = F3(
...
var _user$project$DjangoRestFramework$singletonPageOf = function (x) {
	return A4(
		_user$project$DjangoRestFramework$PageOf,
		1,
		_elm_lang$core$Maybe$Nothing,
		_elm_lang$core$Maybe$Nothing,
		{
...
var _user$project$DjangoRestFramework$createResource = F6(
	function (auth, resourceListUrl, encoder, decoder, data, tagger) {
		var request = _elm_lang$http$Http$request(
			{
				...
				expect: _elm_lang$http$Http$expectJson(
					_user$project$DjangoRestFramework$decodeResource(decoder)),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
		return A2(_elm_lang$http$Http$send, tagger, request);
	});
var _user$project$DjangoRestFramework$listFilteredResources = F6(
	function (auth, resourceListUrl, decoder, filterToStr, filters, tagger) {
		var request = A3(
			_user$project$DjangoRestFramework$getRequest,
			auth,
			A3(_user$project$DjangoRestFramework$filteredListUrl, resourceListUrl, filters, filterToStr),
			_user$project$DjangoRestFramework$decodePageOf(
				_user$project$DjangoRestFramework$decodeResource(decoder)));
		return A2(_elm_lang$http$Http$send, tagger, request);
	});
var _user$project$DjangoRestFramework$listResources = F4(
	function (auth, resourceListUrl, decoder, tagger) {
		return A6(
			_user$project$DjangoRestFramework$listFilteredResources,
			auth,
			resourceListUrl,
			decoder,
			_elm_lang$core$Basics$always(''),
...
var _user$project$DjangoRestFramework$getResourceFromUrl = F4(
	function (auth, decoder, resUrl, tagger) {
		var request = A3(
			_user$project$DjangoRestFramework$getRequest,
			auth,
			resUrl,
...
var _user$project$DjangoRestFramework$getResourceById = F5(
	function (auth, listUrl, decoder, memberNum, tagger) {
		var resUrl = A2(_user$project$DjangoRestFramework$urlFromId, listUrl, memberNum);
		return A4(_user$project$DjangoRestFramework$getResourceFromUrl, auth, decoder, resUrl, tagger);
	});
var _user$project$DjangoRestFramework$replaceResource = F6(
	function (auth, listUrl, encoder, decoder, resource, tagger) {
		var request = _elm_lang$http$Http$request(
			{
				method: 'PUT',
				headers: {
				...
				url: A2(_user$project$DjangoRestFramework$urlFromId, listUrl, resource.id),
				body: _elm_lang$http$Http$jsonBody(
					encoder(resource.data)),
				expect: _elm_lang$http$Http$expectJson(
					_user$project$DjangoRestFramework$decodeResource(decoder)),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
...
var _user$project$DjangoRestFramework$Basic = F2(
	function (a, b) {
...
var _user$project$XisRestApi$encodeTrackBroadcastData = function (tbd) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'start',
				_1: _user$project$DjangoRestFramework$encodePointInTime(tbd.start)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'library_track',
					_1: A2(_elm_community$json_extra$Json_Encode_Extra$maybe, _elm_lang$core$Json_Encode$string, tbd.libraryTrack)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'non_library_track',
						_1: A2(_elm_community$json_extra$Json_Encode_Extra$maybe, _elm_lang$core$Json_Encode$string, tbd.nonLibraryTrack)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$XisRestApi$encodeEpisodeTrackData = function (etd) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'episode',
				_1: _elm_lang$core$Json_Encode$string(etd.episode)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'sequence',
					_1: _elm_lang$core$Json_Encode$int(etd.sequence)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'artist',
						_1: _elm_lang$core$Json_Encode$string(etd.artist)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'title',
							_1: _elm_lang$core$Json_Encode$string(etd.title)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'duration',
								_1: _elm_lang$core$Json_Encode$string(etd.duration)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'track_broadcast',
									_1: A2(_elm_community$json_extra$Json_Encode_Extra$maybe, _elm_lang$core$Json_Encode$string, etd.trackBroadcast)
								},
								_1: {ctor: '[]'}
							}
						}
...
var _user$project$XisRestApi$episodeDataNVPs = function (ep) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 'show',
			_1: _elm_lang$core$Json_Encode$string(ep.show)
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'first_broadcast',
				_1: _user$project$DjangoRestFramework$encodeCalendarDate(ep.firstBroadcast)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'title',
					_1: _elm_lang$core$Json_Encode$string(ep.title)
				},
				_1: {ctor: '[]'}
			}
		}
...
var _user$project$XisRestApi$encodeEpisodeData = function (_p1) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$episodeDataNVPs(_p1));
};
var _user$project$XisRestApi$episodeFilterToString = function (filter) {
	var _p2 = filter;
	if (_p2.ctor === 'EpisodeDateEquals') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'first_broadcast=',
			_user$project$CalendarDate$toString(_p2._0));
	} else {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'show=',
...
var _user$project$XisRestApi$broadcastTypeToString = function (x) {
	var _p3 = x;
	if (_p3.ctor === 'FirstBroadcast') {
		return '1ST';
	} else {
		return 'RPT';
	}
};
var _user$project$XisRestApi$encodeBroadcastType = function (theType) {
	return _elm_lang$core$Json_Encode$string(
		_user$project$XisRestApi$broadcastTypeToString(theType));
};
var _user$project$XisRestApi$broadcastFilterToString = function (filter) {
	var _p4 = filter;
	if (_p4.ctor === 'BroadcastsWithEpisodeIdEqualTo') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'episode=',
		...
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'type=',
			_user$project$XisRestApi$broadcastTypeToString(_p4._0));
	}
};
var _user$project$XisRestApi$broadcastDataNVPs = function (bc) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 'episode',
			_1: _elm_lang$core$Json_Encode$string(bc.episode)
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'date',
				_1: _user$project$DjangoRestFramework$encodeCalendarDate(bc.date)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'host_checked_in',
					_1: A2(_elm_community$json_extra$Json_Encode_Extra$maybe, _user$project$DjangoRestFramework$encodeClockTime, bc.hostCheckedIn)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'type',
						_1: _user$project$XisRestApi$encodeBroadcastType(bc.theType)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$XisRestApi$encodeBroadcastData = function (_p5) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$broadcastDataNVPs(_p5));
};
var _user$project$XisRestApi$replaceAll = F2(
	function (_p6, whole) {
		...
		return A4(
			_elm_lang$core$Regex$replace,
			_elm_lang$core$Regex$All,
			_elm_lang$core$Regex$regex(_p7.oldSub),
			function (_p8) {
				return _p7.newSub;
			},
			whole);
...
var _user$project$XisRestApi$visitEventFilterToString = function (filter) {
	var _p12 = filter;
	switch (_p12.ctor) {
		case 'VEF_WhenGreaterOrEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'when__gte=',
				_user$project$PointInTime$isoString(_p12._0));
		case 'VEF_EventTypeEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'event_type=',
				_user$project$XisRestApi$eventTypeString(_p12._0));
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'method=',
				_user$project$XisRestApi$eventMethodString(_p12._0));
	}
};
var _user$project$XisRestApi$visitEventDataNVPs = function (ved) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
...
var _user$project$XisRestApi$encodeVisitEventDataOut = function (_p13) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$visitEventDataNVPs(_p13));
};
var _user$project$XisRestApi$vendLogDataNVPs = function (log) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 'who_for',
			_1: _elm_lang$core$Json_Encode$string(log.whoFor)
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'when',
				_1: _user$project$DjangoRestFramework$encodePointInTime(log.when)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'product',
					_1: _elm_lang$core$Json_Encode$string(log.product)
				},
				_1: {ctor: '[]'}
			}
		}
...
var _user$project$XisRestApi$encodeVendLogData = function (_p14) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$vendLogDataNVPs(_p14));
};
...
var _user$project$XisRestApi$coverTime = F2(
	function (memberships, now) {
		var _p15 = _user$project$XisRestApi$mostRecentMembership(memberships);
		if (_p15.ctor === 'Nothing') {
			return false;
		} else {
			var _p16 = _p15._0;
			var membershipRange = A2(_user$project$RangeOfTime$fromCalendarDates, _p16.data.startDate, _p16.data.endDate);
			return A2(_user$project$RangeOfTime$containsPoint, membershipRange, now);
		}
	});
var _user$project$XisRestApi$membershipFilterToString = function (filter) {
	var _p17 = filter;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'member=',
...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var bd = block.data;
		var _p18 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
				start: {line: 930, column: 25},
				end: {line: 930, column: 36}
...
var _user$project$XisRestApi$memberFilterToString = function (filter) {
	var _p21 = filter;
	switch (_p21.ctor) {
		...
		case 'EmailEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__email__iexact=', _p21._0);
		case 'UsernameEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__iexact=', _p21._0);
		case 'UsernameContains':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__icontains=', _p21._0);
		case 'UsernameStartsWith':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__istartswith=', _p21._0);
		case 'LastNameStartsWith':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__last_name__istartswith=', _p21._0);
		case 'LastNameEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__last_name__iexact=', _p21._0);
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
...
var _user$project$XisRestApi$playDataNVPs = function (pd) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 'playing_member',
			_1: _elm_lang$core$Json_Encode$string(pd.playingMember)
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'play_date',
				_1: _user$project$DjangoRestFramework$encodeCalendarDate(pd.playDate)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'play_duration',
					_1: A2(_elm_community$json_extra$Json_Encode_Extra$maybe, _user$project$DjangoRestFramework$encodeDuration, pd.playDuration)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'play_start_time',
						_1: A2(_elm_community$json_extra$Json_Encode_Extra$maybe, _user$project$DjangoRestFramework$encodeClockTime, pd.playStartTime)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$XisRestApi$encodePlayData = function (_p22) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$playDataNVPs(_p22));
};
var _user$project$XisRestApi$playFilterToString = function (filter) {
	var _p23 = filter;
	switch (_p23.ctor) {
		case 'PlayDurationIsNull':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'play_duration__isnull=',
				_elm_lang$core$String$toLower(
					_elm_lang$core$Basics$toString(_p23._0)));
		case 'PlayingMemberEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'playing_member=',
				_elm_lang$core$Basics$toString(_p23._0));
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'play_date=',
				_user$project$CalendarDate$toString(_p23._0));
	}
};
var _user$project$XisRestApi$setPlaysDuration = F2(
	function (newSetting, oldPlay) {
		var data = oldPlay.data;
		var newData = _elm_lang$core$Native_Utils.update(
			data,
			{playDuration: newSetting});
		return _elm_lang$core$Native_Utils.update(
			oldPlay,
			{data: newData});
	});
...
var _user$project$XisRestApi$encodeWorkNoteData = function (_p24) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$workNoteDataNVPs(_p24));
};
...
var _user$project$XisRestApi$encodeWorkData = function (_p25) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$workDataNVPs(_p25));
};
var _user$project$XisRestApi$workFilterToString = function (filter) {
	var _p26 = filter;
	if (_p26.ctor === 'WorkedClaimEquals') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'claim=',
...
var _user$project$XisRestApi$encodeClaimData = function (_p28) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$claimDataNVPs(_p28));
};
...
var _user$project$XisRestApi$claimFilterToString = function (filter) {
	var _p30 = filter;
	switch (_p30.ctor) {
		case 'ClaimStatusEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'status=',
				_user$project$XisRestApi$claimStatusValue(_p30._0));
...
var _user$project$XisRestApi$memberHasStatusOnTask = F4(
	function (flags, memberNum, questionedStatus, task) {
		...
		var _p33 = actualStatus;
		if (_p33.ctor === 'Nothing') {
			return false;
		} else {
			return _elm_lang$core$Native_Utils.eq(_p33._0, questionedStatus);
		}
	});
var _user$project$XisRestApi$taskFilterToString = function (filter) {
	var _p34 = filter;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'scheduled_date=',
		_user$project$CalendarDate$toString(_p34._0));
};
																		...
																		return function (s) {
																			return function (t) {
																				return function (u) {
																					return function (v) {
																						return function (w) {
																							return {authenticateUrl: a, broadcastListUrl: b, claimListUrl: c, discoveryMethodListUrl: d, emailMembershipInfoUrl: e, episodeListUrl: f, episodeTrackListUrl: g, logMessageUrl: h, memberListUrl: i, membershipListUrl: j, nowPlayingUrl: k, playListUrl: l, productListUrl: m, showListUrl: n, taskListUrl: o, timeBlockListUrl: p, timeBlockTypeListUrl: q, trackBroadcastListUrl: r, trackListUrl: s, vendLogListUrl: t, visitEventListUrl: u, workListUrl: v, workNoteListUrl: w};
																						};
																					};
																				};
																			};
																																																															...
																																																															return function (_38) {
																																																																return function (_39) {
																																																																	return function (_40) {
																																																																		return function (_41) {
																																																																			return function (_42) {
																																																																				return {getMembershipById: a, getPlayByUrl: b, getTaskById: c, getTaskFromUrl: d, getWorkFromUrl: e, createBroadcast: f, createClaim: g, createEpisodeTrack: h, createPlay: i, createEpisode: j, createTrackBroadcast: k, createVendLog: l, createVisitEvent: m, createWork: n, createWorkNote: o, deleteEpisodeTrackById: p, deleteEpisodeTrackByUrl: q, deletePlayById: r, deletePlayByUrl: s, deleteWorkById: t, deleteWorkByUrl: u, listBroadcasts: v, listClaims: w, listDiscoveryMethods: x, listEpisodes: y, listMembers: z, listMemberships: _1, listPlays: _2, listShows: _3, listTasks: _4, listTimeBlocks: _5, listTimeBlockTypes: _6, listVisitEvents: _7, listWorks: _8, moreVisitEvents: _9, replaceClaim: _10, replaceEpisodeTrack: _11, replaceWork: _12, replacePlay: _13, replaceEpisode: _14, broadcastUrl: _15, claimUrl: _16, episodeUrl: _17, episodeTrackUrl: _18, memberUrl: _19, productUrl: _20, showUrl: _21, taskUrl: _22, trackBroadcastUrl: _23, vendLogUrl: _24, visitEventUrl: _25, workUrl: _26, workNoteUrl: _27, authenticate: _28, blockHasType: _29, coverTime: _30, defaultBlockType: _31, emailMembershipInfo: _32, logMessage: _33, getBlocksTypes: _34, memberCanClaimTask: _35, memberHasStatusOnTask: _36, membersClaimOnTask: _37, membersStatusOnTask: _38, membersWithStatusOnTask: _39, mostRecentMembership: _40, nowPlaying: _41, pitInBlock: _42};
																																																																			};
																																																																		};
																																																																	};
																																																																};
...
var _user$project$XisRestApi$decodeWorkNoteData = A3(
	...
	A2(
		...
		function (_p35) {
			return _elm_community$json_extra$Json_Decode_Extra$fromResult(
				_user$project$PointInTime$fromString(_p35));
		},
		_elm_lang$core$Json_Decode$string),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
...
var _user$project$XisRestApi$PlayData = F4(
	function (a, b, c, d) {
		return {playingMember: a, playDate: b, playDuration: c, playStartTime: d};
	});
var _user$project$XisRestApi$decodePlayData = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'play_start_time',
	_elm_lang$core$Json_Decode$maybe(_user$project$DjangoRestFramework$decodeClockTime),
	A3(
		...
		A3(
			...
			A3(
				...
				'playing_member',
				_user$project$DjangoRestFramework$decodeResourceUrl,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$XisRestApi$PlayData)))));
var _user$project$XisRestApi$listPlays = F4(
	function (flags, auth, filters, resultToMsg) {
		var request = A3(
			_user$project$DjangoRestFramework$getRequest,
			auth,
			A3(_user$project$DjangoRestFramework$filteredListUrl, flags.playListUrl, filters, _user$project$XisRestApi$playFilterToString),
			_user$project$DjangoRestFramework$decodePageOf(
				_user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodePlayData)));
...
var _user$project$XisRestApi$decodeMemberData = A3(
	...
	A3(
		...
		A3(
			...
			_elm_lang$core$Json_Decode$maybe(
				_user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodeMembershipData)),
			A4(
...
var _user$project$XisRestApi$VendLogData = F3(
	function (a, b, c) {
		return {whoFor: a, when: b, product: c};
	});
var _user$project$XisRestApi$decodeVendLogData = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'product',
	_user$project$DjangoRestFramework$decodeResourceUrl,
	A3(
		...
		A3(
			...
			'who_for',
			_user$project$DjangoRestFramework$decodeResourceUrl,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$XisRestApi$VendLogData))));
...
var _user$project$XisRestApi$ShowData = F6(
	function (a, b, c, d, e, f) {
		return {title: a, duration: b, description: c, active: d, hosts: e, remainingSeconds: f};
	});
var _user$project$XisRestApi$decodeShowData = A4(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
	'remaining_seconds',
	_elm_lang$core$Json_Decode$float,
	0.0,
			...
			A3(
				...
				A3(
					...
					A3(
						...
						'title',
						_elm_lang$core$Json_Decode$string,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$XisRestApi$ShowData)))))));
var _user$project$XisRestApi$decodeShow = _user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodeShowData);
var _user$project$XisRestApi$BroadcastData = F4(
	function (a, b, c, d) {
		return {episode: a, date: b, hostCheckedIn: c, theType: d};
	});
var _user$project$XisRestApi$EpisodeData = F4(
	function (a, b, c, d) {
		return {show: a, firstBroadcast: b, title: c, tracks: d};
	});
var _user$project$XisRestApi$EpisodeTrackData = F6(
	function (a, b, c, d, e, f) {
		return {episode: a, sequence: b, artist: c, title: d, duration: e, trackBroadcast: f};
	});
var _user$project$XisRestApi$decodeEpisodeTrackData = A7(
	_elm_lang$core$Json_Decode$map6,
	_user$project$XisRestApi$EpisodeTrackData,
	A2(_elm_lang$core$Json_Decode$field, 'episode', _user$project$DjangoRestFramework$decodeResourceUrl),
	A2(_elm_lang$core$Json_Decode$field, 'sequence', _elm_lang$core$Json_Decode$int),
	...
	A2(
		...
		'track_broadcast',
		_elm_lang$core$Json_Decode$maybe(_user$project$DjangoRestFramework$decodeResourceUrl)));
var _user$project$XisRestApi$decodeEpisodeData = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$XisRestApi$EpisodeData,
	A2(_elm_lang$core$Json_Decode$field, 'show', _user$project$DjangoRestFramework$decodeResourceUrl),
	A2(_elm_lang$core$Json_Decode$field, 'first_broadcast', _user$project$DjangoRestFramework$decodeCalendarDate),
	A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode$field,
		'tracks_embed',
		_elm_lang$core$Json_Decode$list(
			_user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodeEpisodeTrackData))));
var _user$project$XisRestApi$TrackBroadcastData = F5(
	function (a, b, c, d, e) {
		return {start: a, libraryTrack: b, nonLibraryTrack: c, libraryTrackEmbed: d, nonLibraryTrackEmbed: e};
	});
var _user$project$XisRestApi$TrackData = F6(
	function (a, b, c, d, e, f) {
		return {artist: a, durationSeconds: b, radioDjId: c, title: d, trackType: e, remainingSeconds: f};
	});
var _user$project$XisRestApi$decodeTrackData = A7(
	_elm_lang$core$Json_Decode$map6,
	_user$project$XisRestApi$TrackData,
	A2(_elm_lang$core$Json_Decode$field, 'artist', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'duration_seconds', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode$field, 'radiodj_id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'track_type', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'remaining_seconds', _elm_lang$core$Json_Decode$float));
var _user$project$XisRestApi$decodeTrackBroadcastData = A6(
	_elm_lang$core$Json_Decode$map5,
	_user$project$XisRestApi$TrackBroadcastData,
	A2(_elm_lang$core$Json_Decode$field, 'start', _user$project$DjangoRestFramework$decodePointInTime),
	A2(
		_elm_lang$core$Json_Decode$field,
		'library_track',
		_elm_lang$core$Json_Decode$maybe(_user$project$DjangoRestFramework$decodeResourceUrl)),
	...
	A2(
		...
		'library_track_embed',
		_elm_lang$core$Json_Decode$maybe(
			_user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodeTrackData))),
	A2(
		_elm_lang$core$Json_Decode$field,
...
var _user$project$XisRestApi$decodeAuthenticationResult = A4(
	...
	_elm_lang$core$Json_Decode$maybe(
		_user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodeMemberData)),
	_elm_lang$core$Maybe$Nothing,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'is_authentic',
...
var _user$project$XisRestApi$NowPlaying = F2(
	function (a, b) {
		return {show: a, track: b};
	});
var _user$project$XisRestApi$decodeNowPlaying = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$XisRestApi$NowPlaying,
	A2(
		_elm_lang$core$Json_Decode$field,
		'show',
		_elm_lang$core$Json_Decode$maybe(_user$project$XisRestApi$decodeShowData)),
	A2(
		_elm_lang$core$Json_Decode$field,
		'track',
		_elm_lang$core$Json_Decode$maybe(_user$project$XisRestApi$decodeTrackData)));
var _user$project$XisRestApi$nowPlaying = F3(
	function (flags, auth, tagger) {
		var request = A3(_user$project$DjangoRestFramework$getRequest, auth, flags.nowPlayingUrl, _user$project$XisRestApi$decodeNowPlaying);
		return A2(_elm_lang$http$Http$send, tagger, request);
	});
...
var _user$project$XisRestApi$taskPriorityDecoder = A2(
	...
	function (str) {
		...
		switch (_p36) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown priority: ', _p36));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$staffingStatusDecoder = A2(
	...
	function (str) {
		...
		switch (_p37) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown staffing status: ', _p37));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeClaimStatus = A2(
	...
	function (str) {
		...
		switch (_p38) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown claim status: ', _p38));
		}
	},
	_elm_lang$core$Json_Decode$string);
																...
																A3(
																	...
																	A3(
																		...
																		A3(
																			...
																			'claim_set',
																			_elm_lang$core$Json_Decode$list(
																				_user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodeClaimData)),
																			A3(
																				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
																				'anybody_is_eligible',
																				_elm_lang$core$Json_Decode$bool,
...
var _user$project$XisRestApi$PlayDateEquals = function (a) {
	return {ctor: 'PlayDateEquals', _0: a};
};
var _user$project$XisRestApi$PlayingMemberEquals = function (a) {
	return {ctor: 'PlayingMemberEquals', _0: a};
};
var _user$project$XisRestApi$PlayDurationIsNull = function (a) {
	return {ctor: 'PlayDurationIsNull', _0: a};
};
...
var _user$project$XisRestApi$decodeVisitEventMethod = A2(
	...
	function (str) {
		...
		switch (_p39) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown visit event type: ', _p39));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeVisitEventReason = A2(
	...
	function (str) {
		...
		switch (_p40) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown visit event type: ', _p40));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeVisitEventType = A2(
	...
	function (str) {
		...
		switch (_p41) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown visit event type: ', _p41));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$moreVisitEvents = F4(
	function (flags, auth, pageUrl, resultToMsg) {
		var request = A3(
			...
			pageUrl,
			_user$project$DjangoRestFramework$decodePageOf(
				_user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodeVisitEventDataIn)));
		return A2(_elm_lang$http$Http$send, resultToMsg, request);
	});
...
var _user$project$XisRestApi$createVisitEvent = F4(
	function (auth, listUrl, visitEventData, resultToMsg) {
		var request = _elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {
				...
				body: _elm_lang$http$Http$jsonBody(
					_elm_lang$core$Json_Encode$object(
						_user$project$XisRestApi$visitEventDataNVPs(visitEventData))),
...
var _user$project$XisRestApi$RepeatBroadcast = {ctor: 'RepeatBroadcast'};
var _user$project$XisRestApi$FirstBroadcast = {ctor: 'FirstBroadcast'};
var _user$project$XisRestApi$broadcastTypeDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (str) {
		var _p42 = str;
		switch (_p42) {
			case '1ST':
				return _elm_lang$core$Json_Decode$succeed(_user$project$XisRestApi$FirstBroadcast);
			case 'RPT':
				return _elm_lang$core$Json_Decode$succeed(_user$project$XisRestApi$RepeatBroadcast);
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown broadcast type: ', _p42));
		}
	},
	_elm_lang$core$Json_Decode$string);
var _user$project$XisRestApi$decodeBroadcastData = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$XisRestApi$BroadcastData,
	A2(_elm_lang$core$Json_Decode$field, 'episode', _user$project$DjangoRestFramework$decodeResourceUrl),
	A2(_elm_lang$core$Json_Decode$field, 'date', _user$project$DjangoRestFramework$decodeCalendarDate),
	A2(
		_elm_lang$core$Json_Decode$field,
		'host_checked_in',
		_elm_lang$core$Json_Decode$maybe(_user$project$DjangoRestFramework$decodeClockTime)),
	A2(_elm_lang$core$Json_Decode$field, 'type', _user$project$XisRestApi$broadcastTypeDecoder));
var _user$project$XisRestApi$createSession = F2(
	function (flags, auth) {
		return {
			getMembershipById: A3(_user$project$DjangoRestFramework$getResourceById, auth, flags.membershipListUrl, _user$project$XisRestApi$decodeMembershipData),
			getPlayByUrl: A2(_user$project$DjangoRestFramework$getResourceFromUrl, auth, _user$project$XisRestApi$decodePlayData),
			getTaskById: A3(_user$project$DjangoRestFramework$getResourceById, auth, flags.taskListUrl, _user$project$XisRestApi$decodeTaskData),
			getTaskFromUrl: A2(_user$project$DjangoRestFramework$getResourceFromUrl, auth, _user$project$XisRestApi$decodeTaskData),
			getWorkFromUrl: A2(_user$project$DjangoRestFramework$getResourceFromUrl, auth, _user$project$XisRestApi$decodeWorkData),
			createBroadcast: A4(_user$project$DjangoRestFramework$createResource, auth, flags.broadcastListUrl, _user$project$XisRestApi$encodeBroadcastData, _user$project$XisRestApi$decodeBroadcastData),
			createClaim: A4(_user$project$DjangoRestFramework$createResource, auth, flags.claimListUrl, _user$project$XisRestApi$encodeClaimData, _user$project$XisRestApi$decodeClaimData),
			createEpisodeTrack: A4(_user$project$DjangoRestFramework$createResource, auth, flags.episodeTrackListUrl, _user$project$XisRestApi$encodeEpisodeTrackData, _user$project$XisRestApi$decodeEpisodeTrackData),
			createPlay: A4(_user$project$DjangoRestFramework$createResource, auth, flags.playListUrl, _user$project$XisRestApi$encodePlayData, _user$project$XisRestApi$decodePlayData),
			createEpisode: A4(_user$project$DjangoRestFramework$createResource, auth, flags.episodeListUrl, _user$project$XisRestApi$encodeEpisodeData, _user$project$XisRestApi$decodeEpisodeData),
			createTrackBroadcast: A4(_user$project$DjangoRestFramework$createResource, auth, flags.trackBroadcastListUrl, _user$project$XisRestApi$encodeTrackBroadcastData, _user$project$XisRestApi$decodeTrackBroadcastData),
			createVendLog: A4(_user$project$DjangoRestFramework$createResource, auth, flags.vendLogListUrl, _user$project$XisRestApi$encodeVendLogData, _user$project$XisRestApi$decodeVendLogData),
			createVisitEvent: A2(_user$project$XisRestApi$createVisitEvent, auth, flags.visitEventListUrl),
			createWork: A4(_user$project$DjangoRestFramework$createResource, auth, flags.workListUrl, _user$project$XisRestApi$encodeWorkData, _user$project$XisRestApi$decodeWorkData),
			createWorkNote: A4(_user$project$DjangoRestFramework$createResource, auth, flags.workNoteListUrl, _user$project$XisRestApi$encodeWorkNoteData, _user$project$XisRestApi$decodeWorkNoteData),
			deleteEpisodeTrackById: A2(_user$project$DjangoRestFramework$deleteResourceById, auth, flags.episodeTrackListUrl),
			deleteEpisodeTrackByUrl: _user$project$DjangoRestFramework$deleteResourceByUrl(auth),
			deletePlayById: A2(_user$project$DjangoRestFramework$deleteResourceById, auth, flags.playListUrl),
			deletePlayByUrl: _user$project$DjangoRestFramework$deleteResourceByUrl(auth),
			deleteWorkById: A2(_user$project$DjangoRestFramework$deleteResourceById, auth, flags.workListUrl),
			deleteWorkByUrl: _user$project$DjangoRestFramework$deleteResourceByUrl(auth),
			listBroadcasts: A4(_user$project$DjangoRestFramework$listFilteredResources, auth, flags.broadcastListUrl, _user$project$XisRestApi$decodeBroadcastData, _user$project$XisRestApi$broadcastFilterToString),
			listClaims: A4(_user$project$DjangoRestFramework$listFilteredResources, auth, flags.claimListUrl, _user$project$XisRestApi$decodeClaimData, _user$project$XisRestApi$claimFilterToString),
			listDiscoveryMethods: A3(_user$project$DjangoRestFramework$listResources, auth, flags.discoveryMethodListUrl, _user$project$XisRestApi$decodeDiscoveryMethodData),
			listEpisodes: A4(_user$project$DjangoRestFramework$listFilteredResources, auth, flags.episodeListUrl, _user$project$XisRestApi$decodeEpisodeData, _user$project$XisRestApi$episodeFilterToString),
			listMembers: A4(_user$project$DjangoRestFramework$listFilteredResources, auth, flags.memberListUrl, _user$project$XisRestApi$decodeMemberData, _user$project$XisRestApi$memberFilterToString),
			listMemberships: A4(_user$project$DjangoRestFramework$listFilteredResources, auth, flags.membershipListUrl, _user$project$XisRestApi$decodeMembershipData, _user$project$XisRestApi$membershipFilterToString),
			listPlays: A4(_user$project$DjangoRestFramework$listFilteredResources, auth, flags.playListUrl, _user$project$XisRestApi$decodePlayData, _user$project$XisRestApi$playFilterToString),
			listShows: A3(_user$project$DjangoRestFramework$listResources, auth, flags.showListUrl, _user$project$XisRestApi$decodeShowData),
			listTasks: A4(_user$project$DjangoRestFramework$listFilteredResources, auth, flags.taskListUrl, _user$project$XisRestApi$decodeTaskData, _user$project$XisRestApi$taskFilterToString),
			listTimeBlocks: A3(_user$project$DjangoRestFramework$listResources, auth, flags.timeBlockListUrl, _user$project$XisRestApi$decodeTimeBlockData),
			listTimeBlockTypes: A3(_user$project$DjangoRestFramework$listResources, auth, flags.timeBlockTypeListUrl, _user$project$XisRestApi$decodeTimeBlockTypeData),
			listVisitEvents: A4(_user$project$DjangoRestFramework$listFilteredResources, auth, flags.visitEventListUrl, _user$project$XisRestApi$decodeVisitEventDataIn, _user$project$XisRestApi$visitEventFilterToString),
			listWorks: A4(_user$project$DjangoRestFramework$listFilteredResources, auth, flags.workListUrl, _user$project$XisRestApi$decodeWorkData, _user$project$XisRestApi$workFilterToString),
			moreVisitEvents: A2(_user$project$XisRestApi$moreVisitEvents, flags, auth),
			replaceClaim: A4(_user$project$DjangoRestFramework$replaceResource, auth, flags.claimListUrl, _user$project$XisRestApi$encodeClaimData, _user$project$XisRestApi$decodeClaimData),
			replaceEpisodeTrack: A4(_user$project$DjangoRestFramework$replaceResource, auth, flags.episodeTrackListUrl, _user$project$XisRestApi$encodeEpisodeTrackData, _user$project$XisRestApi$decodeEpisodeTrackData),
			replaceWork: A4(_user$project$DjangoRestFramework$replaceResource, auth, flags.workListUrl, _user$project$XisRestApi$encodeWorkData, _user$project$XisRestApi$decodeWorkData),
			replacePlay: A4(_user$project$DjangoRestFramework$replaceResource, auth, flags.playListUrl, _user$project$XisRestApi$encodePlayData, _user$project$XisRestApi$decodePlayData),
			replaceEpisode: A4(_user$project$DjangoRestFramework$replaceResource, auth, flags.episodeListUrl, _user$project$XisRestApi$encodeEpisodeData, _user$project$XisRestApi$decodeEpisodeData),
			broadcastUrl: _user$project$DjangoRestFramework$urlFromId(flags.broadcastListUrl),
			claimUrl: _user$project$DjangoRestFramework$urlFromId(flags.claimListUrl),
			episodeUrl: _user$project$DjangoRestFramework$urlFromId(flags.episodeListUrl),
			episodeTrackUrl: _user$project$DjangoRestFramework$urlFromId(flags.episodeTrackListUrl),
			memberUrl: _user$project$DjangoRestFramework$urlFromId(flags.memberListUrl),
			productUrl: _user$project$DjangoRestFramework$urlFromId(flags.productListUrl),
			showUrl: _user$project$DjangoRestFramework$urlFromId(flags.showListUrl),
			taskUrl: _user$project$DjangoRestFramework$urlFromId(flags.taskListUrl),
			trackBroadcastUrl: _user$project$DjangoRestFramework$urlFromId(flags.trackBroadcastListUrl),
			vendLogUrl: _user$project$DjangoRestFramework$urlFromId(flags.visitEventListUrl),
			...
			nowPlaying: A2(_user$project$XisRestApi$nowPlaying, flags, auth),
			pitInBlock: _user$project$XisRestApi$pitInBlock
		};
	});
var _user$project$XisRestApi$BroadcastsWithTypeEqualTo = function (a) {
	return {ctor: 'BroadcastsWithTypeEqualTo', _0: a};
};
var _user$project$XisRestApi$BroadcastsWithEpisodeIdEqualTo = function (a) {
	return {ctor: 'BroadcastsWithEpisodeIdEqualTo', _0: a};
};
var _user$project$XisRestApi$EpisodeShowEquals = function (a) {
	return {ctor: 'EpisodeShowEquals', _0: a};
};
var _user$project$XisRestApi$EpisodeDateEquals = function (a) {
	return {ctor: 'EpisodeDateEquals', _0: a};
};
...
var _user$project$DjOps$restTdStyle = {
	ctor: '::',
	_0: A2(_debois$elm_mdl$Material_Options$css, 'border-style', 'none'),
	_1: {
		ctor: '::',
		_0: A2(_debois$elm_mdl$Material_Options$css, 'padding-top', '0'),
		_1: {ctor: '[]'}
	}
};
var _user$project$DjOps$firstTdStyle = {
	ctor: '::',
	_0: A2(_debois$elm_mdl$Material_Options$css, 'border-style', 'none'),
	_1: {
		ctor: '::',
		_0: A2(_debois$elm_mdl$Material_Options$css, 'color', 'gray'),
		_1: {
			ctor: '::',
			_0: A2(_debois$elm_mdl$Material_Options$css, 'font-size', '26pt'),
			_1: {
				ctor: '::',
...
var _user$project$DjOps_ops = _user$project$DjOps_ops || {};
_user$project$DjOps_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _user$project$DjOps$userIdPwInputStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: A2(_user$project$DjOps_ops['=>'], 'margin-left', '50px'),
		_1: {ctor: '[]'}
	});
var _user$project$DjOps$mmss_mask = function (val) {
	var trimLeftZeros = A3(
		_elm_lang$core$Regex$replace,
		_elm_lang$core$Regex$AtMost(1),
		_elm_lang$core$Regex$regex('^0*'),
		_elm_lang$core$Basics$always(''));
	var digits = A2(
		_elm_lang$core$String$left,
		4,
		trimLeftZeros(
			A3(
				...
				':',
				'',
				_elm_lang$core$String$trim(val))));
	var len = _elm_lang$core$String$length(digits);
	var padded = A3(
		_elm_lang$core$String$padLeft,
		4,
		_elm_lang$core$Native_Utils.chr('0'),
		digits);
	return _elm_lang$core$Native_Utils.eq(len, 0) ? '' : A3(_elm_community$string_extra$String_Extra$insertAt, ':', -2, padded);
};
var _user$project$DjOps$delay = F2(
	function (time, msg) {
		return A2(
			_elm_lang$core$Task$perform,
			function (_p0) {
...
var _user$project$DjOps$tracksTabEntryIcon = F3(
	function (model, row, tte) {
		var maybeTrack = A2(
			_elm_lang$core$Maybe$andThen,
			function (_) {
				return _.track;
		...
		var remaining = A2(
			...
			A2(
				_elm_lang$core$Maybe$map,
				function (_) {
					return _.remainingSeconds;
				},
				maybeTrack));
		return _debois$elm_mdl$Material_Icon$i(
			(_elm_lang$core$Native_Utils.eq(tte.artist, artist) && (_elm_lang$core$Native_Utils.eq(tte.title, title) && (_elm_community$maybe_extra$Maybe_Extra$isJust(tte.trackBroadcast) && (_elm_lang$core$Native_Utils.cmp(remaining, 0.0) > 0)))) ? 'hourglass_full' : (_elm_community$maybe_extra$Maybe_Extra$isJust(tte.trackBroadcast) ? 'done' : (_elm_community$maybe_extra$Maybe_Extra$isJust(tte.episodeTrackId) ? 'play_arrow' : 'none')));
	});
var _user$project$DjOps$dots = '...';
var _user$project$DjOps$dashes = '--';
var _user$project$DjOps$stackedPair = F4(
	function (name1, val1, name2, val2) {
		var theStyle = _elm_lang$html$Html_Attributes$style(
			{
				ctor: '::',
				_0: A2(_user$project$DjOps_ops['=>'], 'display', 'inline-block'),
				_1: {
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'vertical-align', 'bottom'),
					_1: {
						ctor: '::',
						_0: A2(_user$project$DjOps_ops['=>'], 'font-size', '14pt'),
						_1: {
							ctor: '::',
							_0: A2(_user$project$DjOps_ops['=>'], 'width', '375px'),
							_1: {
								ctor: '::',
								_0: A2(_user$project$DjOps_ops['=>'], 'text-overflow', 'ellipsis'),
								_1: {
									ctor: '::',
									_0: A2(_user$project$DjOps_ops['=>'], 'overflow', 'hidden'),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$DjOps$timeRemaining = F2(
	function (min, sec) {
		var colonStyle = _elm_lang$html$Html_Attributes$style(
			{
				ctor: '::',
				_0: A2(_user$project$DjOps_ops['=>'], 'margin-right', '-2px'),
				_1: {
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'margin-bottom', '3px'),
					_1: {ctor: '[]'}
				}
			});
		var digitStyle = _elm_lang$html$Html_Attributes$style(
			{
				ctor: '::',
				_0: A2(_user$project$DjOps_ops['=>'], 'font-family', '\'Share Tech Mono\', monospace'),
				_1: {
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'letter-spacing', '-3px'),
					_1: {ctor: '[]'}
				}
			});
		var sec0 = (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$String$length(sec),
			2) < 0) ? A2(_elm_lang$core$Basics_ops['++'], '0', sec) : sec;
		var min0 = (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$String$length(min),
			2) < 0) ? A2(_elm_lang$core$Basics_ops['++'], '0', min) : min;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_user$project$DjOps_ops['=>'], 'padding-left', '3px'),
								_1: {
									ctor: '::',
									_0: A2(_user$project$DjOps_ops['=>'], 'padding-right', '3px'),
									_1: {
										ctor: '::',
										_0: A2(_user$project$DjOps_ops['=>'], 'margin-right', '10px'),
										_1: {
											ctor: '::',
											_0: A2(_user$project$DjOps_ops['=>'], 'font-size', '26pt'),
											_1: {
												ctor: '::',
												_0: A2(_user$project$DjOps_ops['=>'], 'border', 'solid white 1px'),
												_1: {ctor: '[]'}
											}
										}
									}
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(min0),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(sec0),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$DjOps$layout_header_col_trackInfo = function (model) {
	var divStyle = _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
			_0: A2(_user$project$DjOps_ops['=>'], 'width', '450px'),
			_1: {
				ctor: '::',
				_0: A2(_user$project$DjOps_ops['=>'], 'white-space', 'nowrap'),
				_1: {
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'margin-right', '50px'),
					_1: {ctor: '[]'}
				}
			}
		});
	...
	var blankInfo = {
		ctor: '::',
		_0: A2(_user$project$DjOps$timeRemaining, _user$project$DjOps$dashes, _user$project$DjOps$dashes),
		_1: {
			ctor: '::',
			_0: A4(_user$project$DjOps$stackedPair, titleLabel, _user$project$DjOps$dots, artistLabel, _user$project$DjOps$dots),
			_1: {ctor: '[]'}
		}
	};
	return A2(
		...
		function () {
			var _p1 = model.nowPlaying;
			if (_p1.ctor === 'Just') {
				var _p2 = _p1._0.track;
				if (_p2.ctor === 'Just') {
					var _p3 = _p2._0;
					return (_elm_lang$core$Native_Utils.cmp(_p3.remainingSeconds, 0) > 0) ? {
						ctor: '::',
						_0: A2(
							_user$project$DjOps$timeRemaining,
							_elm_lang$core$Basics$toString(
								_elm_lang$core$Basics$floor(_p3.remainingSeconds / 60)),
							_elm_lang$core$Basics$toString(
								A2(
									_elm_lang$core$Basics$rem,
									_elm_lang$core$Basics$floor(_p3.remainingSeconds),
									60))),
						_1: {
							ctor: '::',
							_0: A4(_user$project$DjOps$stackedPair, titleLabel, _p3.title, artistLabel, _p3.artist),
							_1: {ctor: '[]'}
						}
					} : blankInfo;
				} else {
...
var _user$project$DjOps$layout_header_col_showInfo = function (model) {
	var hostLabel = 'Host';
	var showLabel = 'Show';
	var blankInfo = {
		ctor: '::',
		...
		_1: {
			ctor: '::',
			_0: A4(_user$project$DjOps$stackedPair, showLabel, _user$project$DjOps$dots, hostLabel, _user$project$DjOps$dots),
			_1: {ctor: '[]'}
		}
	};
	return A2(
		...
		function () {
			var _p4 = model.nowPlaying;
			if (_p4.ctor === 'Just') {
				var _p5 = _p4._0.show;
				if (_p5.ctor === 'Just') {
					var _p6 = _p5._0;
					return (_elm_lang$core$Native_Utils.cmp(_p6.remainingSeconds, 0) > 0) ? {
						ctor: '::',
						_0: A2(
							_user$project$DjOps$timeRemaining,
							_elm_lang$core$Basics$toString(
								_elm_lang$core$Basics$floor(_p6.remainingSeconds / 60)),
							_elm_lang$core$Basics$toString(
								A2(
									_elm_lang$core$Basics$rem,
									_elm_lang$core$Basics$floor(_p6.remainingSeconds),
									60))),
						_1: {
							ctor: '::',
							_0: A4(
								_user$project$DjOps$stackedPair,
								showLabel,
								_p6.title,
								hostLabel,
								A2(_elm_lang$core$String$join, ' & ', _p6.hosts)),
							_1: {ctor: '[]'}
						}
					} : blankInfo;
				} else {
...
var _user$project$DjOps$layout_header_col_appName = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'font-size', '20pt'),
					_1: {
						ctor: '::',
						_0: A2(_user$project$DjOps_ops['=>'], 'margin-right', '50px'),
						_1: {ctor: '[]'}
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$span,
				{
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							ctor: '::',
							_0: A2(_user$project$DjOps_ops['=>'], 'margin-right', '8px'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text('DJ Ops'),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$DjOps$layout_header = function (model) {
	return {
		ctor: '::',
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$DjOps$layout_header_col_appName(model),
						_1: {
							ctor: '::',
							_0: _user$project$DjOps$layout_header_col_trackInfo(model),
							_1: {
								ctor: '::',
								_0: _user$project$DjOps$layout_header_col_showInfo(model),
								_1: {ctor: '[]'}
							}
						}
					}),
...
var _user$project$DjOps$tagattr = function (x) {
	return A2(_elm_lang$html$Html_Attributes$attribute, x, x);
};
var _user$project$DjOps$tracksTabTitle = function (model) {
	var filter = function (_p7) {
		return _elm_community$maybe_extra$Maybe_Extra$isJust(
			function (_) {
				return _.episodeTrackId;
			}(_p7));
	};
	var trackCount = _elm_lang$core$Array$length(
		A2(_elm_lang$core$Array$filter, filter, model.tracksTabEntries));
	return (_elm_lang$core$Native_Utils.cmp(trackCount, 0) > 0) ? A2(
		_debois$elm_mdl$Material_Options$span,
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Badge$add(
				_elm_lang$core$Basics$toString(trackCount)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('tracks'),
			_1: {ctor: '[]'}
		}) : A2(
		_elm_lang$html$Html$span,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'margin-right', '24px'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
...
var _user$project$DjOps$tabs = function (model) {
	return {
		ctor: '_Tuple2',
		_0: {
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _user$project$DjOps$tracksTabTitle(model),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text('underwriting'),
					_1: {
						ctor: '::',
...
var _user$project$DjOps$tick_NowPlayingClocks = function (_p8) {
	var _p9 = _p8;
	var _p13 = _p9._0;
	var _p12 = _p9._1;
	var _p10 = _p13.nowPlaying;
	if (_p10.ctor === 'Just') {
		var _p11 = _p10._0;
		var decRemaining = function (x) {
			return _elm_lang$core$Native_Utils.update(
				x,
				{remainingSeconds: x.remainingSeconds - 1.0});
		};
		var updatedTrack = A2(_elm_lang$core$Maybe$map, decRemaining, _p11.track);
		var updatedShow = A2(_elm_lang$core$Maybe$map, decRemaining, _p11.show);
		var updatedNowPlaying = A2(_user$project$XisRestApi$NowPlaying, updatedShow, updatedTrack);
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				_p13,
				{
					nowPlaying: _elm_lang$core$Maybe$Just(updatedNowPlaying)
				}),
			_1: _p12
		};
	} else {
...
var _user$project$DjOps$tick_Idle = function (_p14) {
	var _p15 = _p14;
	var _p16 = _p15._0;
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			_p16,
			{keyboardIdleTime: _p16.keyboardIdleTime + 1}),
		_1: _p15._1
	};
};
var _user$project$DjOps$nowPlayingTimeRemaining = function (model) {
	var remaining = function (x) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			0.0,
			A2(
				...
				A2(_elm_lang$core$Maybe$andThen, x, model.nowPlaying)));
	};
	return {
		showSecsLeft: remaining(
			function (_) {
				return _.show;
			}),
		trackSecsLeft: remaining(
			function (_) {
				return _.track;
			})
	};
};
var _user$project$DjOps$tracksTabEntryIsEmpty = function (tte) {
	var e = function (_p17) {
		return _elm_lang$core$String$isEmpty(
			_elm_lang$core$String$trim(_p17));
	};
	return e(tte.artist) && (e(tte.title) && e(tte.duration));
};
var _user$project$DjOps$tracksTabEntryColumnIsDirty = F2(
	function (tte, col) {
		var st = _elm_lang$core$String$trim;
		var _p18 = col;
		switch (_p18.ctor) {
			case 'ArtistColumn':
				return !_elm_lang$core$Native_Utils.eq(
			...
			default:
				return !_elm_lang$core$Native_Utils.eq(
					st(tte.duration),
					st(tte.savedDuration));
		}
	});
var _user$project$DjOps$tracksTabEntryIsDirty = function (tte) {
	var st = _elm_lang$core$String$trim;
	var curr = {
		ctor: '_Tuple4',
		_0: st(tte.artist),
		_1: st(tte.title),
		_2: st(tte.duration),
		_3: tte.trackBroadcast
	};
	var saved = {
		ctor: '_Tuple4',
		_0: st(tte.savedArtist),
		_1: st(tte.savedTitle),
		_2: st(tte.savedDuration),
		_3: tte.savedTrackBroadcast
	};
	return !_elm_lang$core$Native_Utils.eq(curr, saved);
};
var _user$project$DjOps$trackTabEntryColumnId = function (col) {
	var _p19 = col;
	switch (_p19.ctor) {
		case 'ArtistColumn':
			return 1;
...
var _user$project$DjOps$numTrackRows = 60;
var _user$project$DjOps$finishTabId = 3;
var _user$project$DjOps$logoutButtonId = {
	ctor: '::',
	_0: _user$project$DjOps$finishTabId,
	_1: {
		ctor: '::',
		_0: 1,
		_1: {ctor: '[]'}
...
var _user$project$DjOps$underwritingTabId = 2;
var _user$project$DjOps$tracksTabId = 1;
var _user$project$DjOps$pasteTextButtonId = {
	ctor: '::',
	_0: _user$project$DjOps$tracksTabId,
	_1: {
		ctor: '::',
		_0: 1,
		_1: {ctor: '[]'}
...
var _user$project$DjOps$startTabId = 0;
var _user$project$DjOps$userIdFieldId = {
	ctor: '::',
	_0: _user$project$DjOps$startTabId,
	_1: {
		ctor: '::',
		_0: 1,
		_1: {ctor: '[]'}
...
var _user$project$DjOps$passwordFieldId = {
	ctor: '::',
	_0: _user$project$DjOps$startTabId,
	_1: {
		ctor: '::',
...
var _user$project$DjOps$loginButtonId = {
	ctor: '::',
	_0: _user$project$DjOps$startTabId,
	_1: {
		ctor: '::',
...
var _user$project$DjOps$beginBroadcastButtonId = {
	ctor: '::',
	_0: _user$project$DjOps$startTabId,
	_1: {
		ctor: '::',
...
var _user$project$DjOps$processButtonId = {
	ctor: '::',
	_0: _user$project$DjOps$startTabId,
	_1: {
		ctor: '::',
...
var _user$project$DjOps$jjpButtonId = {
	ctor: '::',
	_0: _user$project$DjOps$startTabId,
	_1: {
		ctor: '::',
...
var _user$project$DjOps$Flags = F2(
	function (a, b) {
		return {csrfToken: a, xisRestFlags: b};
	});
var _user$project$DjOps$TracksTabEntry = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {episodeTrackId: a, artist: b, title: c, duration: d, trackBroadcast: e, savedArtist: f, savedTitle: g, savedDuration: h, savedTrackBroadcast: i};
	});
var _user$project$DjOps$blankTracksTabEntry = A9(_user$project$DjOps$TracksTabEntry, _elm_lang$core$Maybe$Nothing, '', '', '', _elm_lang$core$Maybe$Nothing, '', '', '', _elm_lang$core$Maybe$Nothing);
var _user$project$DjOps$ingestBatchEntry = F6(
	function (lines, row, mArtist, mTitle, mDuration, model) {
		ingestBatchEntry:
		while (true) {
			var _p20 = lines;
			if (_p20.ctor === '[]') {
				...
				var _p22 = _p20._1;
				var _p21 = _p20._0;
				if (_elm_lang$core$String$isEmpty(_p21)) {
					if (_elm_community$maybe_extra$Maybe_Extra$isNothing(mArtist) && (_elm_community$maybe_extra$Maybe_Extra$isNothing(mTitle) && _elm_community$maybe_extra$Maybe_Extra$isNothing(mDuration))) {
						var _v10 = _p22,
							_v11 = row,
							_v12 = _elm_lang$core$Maybe$Nothing,
							_v13 = _elm_lang$core$Maybe$Nothing,
						...
						mDuration = _v14;
						model = _v15;
						continue ingestBatchEntry;
					} else {
						var mCurrEpTrackId = A2(
							_elm_lang$core$Maybe$andThen,
							function (_) {
								return _.episodeTrackId;
							},
							A2(_elm_lang$core$Array$get, row, model.tracksTabEntries));
						var def = _elm_lang$core$Maybe$withDefault('');
						var artist = def(mArtist);
						var title = def(mTitle);
						var duration = _user$project$DjOps$mmss_mask(
							def(mDuration));
						var tte = A9(_user$project$DjOps$TracksTabEntry, mCurrEpTrackId, artist, title, duration, _elm_lang$core$Maybe$Nothing, '', '', '', _elm_lang$core$Maybe$Nothing);
						var newTtes = A3(_elm_lang$core$Array$set, row, tte, model.tracksTabEntries);
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{tracksTabEntries: newTtes});
						var _v16 = _p22,
							_v17 = row + 1,
							_v18 = _elm_lang$core$Maybe$Nothing,
							_v19 = _elm_lang$core$Maybe$Nothing,
							_v20 = _elm_lang$core$Maybe$Nothing,
							_v21 = newModel;
						lines = _v16;
						row = _v17;
						mArtist = _v18;
					...
					if (_elm_community$maybe_extra$Maybe_Extra$isNothing(mArtist)) {
						var _v22 = _p22,
							_v23 = row,
							_v24 = _elm_lang$core$Maybe$Just(_p21),
							_v25 = _elm_lang$core$Maybe$Nothing,
							_v26 = _elm_lang$core$Maybe$Nothing,
							_v27 = model;
						lines = _v22;
						row = _v23;
						mArtist = _v24;
						...
						if (_elm_community$maybe_extra$Maybe_Extra$isNothing(mTitle)) {
							var _v28 = _p22,
								_v29 = row,
								_v30 = mArtist,
								_v31 = _elm_lang$core$Maybe$Just(_p21),
								_v32 = _elm_lang$core$Maybe$Nothing,
								_v33 = model;
							lines = _v28;
							row = _v29;
							mArtist = _v30;
							...
							var _v34 = _p22,
								...
								_v36 = mArtist,
								_v37 = mTitle,
								_v38 = _elm_lang$core$Maybe$Just(_p21),
								_v39 = model;
							lines = _v34;
							row = _v35;
							mArtist = _v36;
...
var _user$project$DjOps$populateTracksTabData_Helper = F2(
	function (model, etsRemaining) {
		populateTracksTabData_Helper:
		while (true) {
			var _p23 = etsRemaining;
			if (_p23.ctor === '[]') {
				return model;
			} else {
				var _p24 = _p23._0;
				var tte = A9(
					_user$project$DjOps$TracksTabEntry,
					_elm_lang$core$Maybe$Just(_p24.id),
					_p24.data.artist,
					_p24.data.title,
					_p24.data.duration,
					_p24.data.trackBroadcast,
					_p24.data.artist,
					_p24.data.title,
					_p24.data.duration,
					_p24.data.trackBroadcast);
				var seq = _p24.data.sequence;
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						tracksTabEntries: A3(_elm_lang$core$Array$set, seq, tte, model.tracksTabEntries)
					});
				var _v41 = newModel,
					_v42 = _p23._1;
				model = _v41;
				etsRemaining = _v42;
				continue populateTracksTabData_Helper;
			}
		}
	});
var _user$project$DjOps$populateTracksTabData = F2(
	function (ets, model) {
		var newModel = _elm_lang$core$Native_Utils.update(
			model,
			{
				tracksTabEntries: A2(_elm_lang$core$Array$repeat, _user$project$DjOps$numTrackRows, _user$project$DjOps$blankTracksTabEntry)
			});
		return A2(_user$project$DjOps$populateTracksTabData_Helper, newModel, ets);
	});
var _user$project$DjOps$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
																...
																return function (q) {
																	return function (r) {
																		return function (s) {
																			return function (t) {
																				return function (u) {
																					return {errMsgs: a, keyboardIdleTime: b, mdl: c, xisFlags: d, xis: e, currTime: f, selectedTab: g, shows: h, selectedShow: i, selectedShowDate: j, episode: k, broadcast: l, datePicker: m, member: n, nowPlaying: o, showBatchEntryDialog: p, batchEntryText: q, tracksTabEntries: r, tracksTabEntriesChanging: s, userid: t, password: u};
																				};
																			};
																		};
																	};
...
var _user$project$DjOps$DurationColumn = {ctor: 'DurationColumn'};
var _user$project$DjOps$TitleColumn = {ctor: 'TitleColumn'};
var _user$project$DjOps$ArtistColumn = {ctor: 'ArtistColumn'};
var _user$project$DjOps$UseridInput = function (a) {
	return {ctor: 'UseridInput', _0: a};
};
var _user$project$DjOps$TrackFieldUpdate = F3(
	function (a, b, c) {
		return {ctor: 'TrackFieldUpdate', _0: a, _1: b, _2: c};
	});
var _user$project$DjOps$TrackBroadastCreate_Result = F3(
	function (a, b, c) {
		return {ctor: 'TrackBroadastCreate_Result', _0: a, _1: b, _2: c};
	});
var _user$project$DjOps$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$DjOps$SetDatePicker = function (a) {
	return {ctor: 'SetDatePicker', _0: a};
};
var _user$project$DjOps$showDateSelector = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'margin-left', '0px'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$map,
				_user$project$DjOps$SetDatePicker,
				A3(_elm_community$elm_datepicker$DatePicker$view, model.selectedShowDate, _elm_community$elm_datepicker$DatePicker$defaultSettings, model.datePicker)),
			_1: {ctor: '[]'}
		});
};
var _user$project$DjOps$SelectTab = function (a) {
	return {ctor: 'SelectTab', _0: a};
};
var _user$project$DjOps$ShowWasChosen = function (a) {
	return {ctor: 'ShowWasChosen', _0: a};
};
var _user$project$DjOps$showSelector = function (model) {
	return A2(
		_elm_lang$html$Html$select,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onInput(_user$project$DjOps$ShowWasChosen),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(
					{
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'value', ''),
					_1: {
						ctor: '::',
						_0: _user$project$DjOps$tagattr(
							_elm_community$maybe_extra$Maybe_Extra$isNothing(model.selectedShow) ? 'selected' : 'dummy'),
						_1: {
							ctor: '::',
							_0: _user$project$DjOps$tagattr('disabled'),
							_1: {
								ctor: '::',
								_0: _user$project$DjOps$tagattr('hidden'),
								_1: {ctor: '[]'}
							}
						}
					}
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Please pick a show...'),
					_1: {ctor: '[]'}
				}),
			_1: A2(
				_elm_lang$core$List$map,
					...
					return A2(
						_elm_lang$html$Html$option,
						{
							...
							_0: A2(
								_elm_lang$html$Html_Attributes$attribute,
								'value',
								_elm_lang$core$Basics$toString(show.id)),
							_1: {
								ctor: '::',
								_0: _user$project$DjOps$tagattr(
									function () {
										var _p25 = model.selectedShow;
										if (_p25.ctor === 'Just') {
											return _elm_lang$core$Native_Utils.eq(show.id, _p25._0.id) ? 'selected' : 'dummy';
										} else {
											return 'dummy';
										}
									}()),
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(show.data.title),
							_1: {ctor: '[]'}
						});
				},
				model.shows)
...
var _user$project$DjOps$ShowList_Result = function (a) {
	return {ctor: 'ShowList_Result', _0: a};
};
var _user$project$DjOps$PlayTrack_Clicked = F2(
	function (a, b) {
		return {ctor: 'PlayTrack_Clicked', _0: a, _1: b};
	});
var _user$project$DjOps$PasswordInput = function (a) {
	return {ctor: 'PasswordInput', _0: a};
};
var _user$project$DjOps$NowPlaying_Result = function (a) {
	return {ctor: 'NowPlaying_Result', _0: a};
};
var _user$project$DjOps$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$DjOps$init = function (flags) {
	var _p26 = _elm_community$elm_datepicker$DatePicker$init;
	var datePicker = _p26._0;
	var datePickerCmd = _p26._1;
	var model = {
		errMsgs: {ctor: '[]'},
		keyboardIdleTime: 0,
		mdl: _debois$elm_mdl$Material$model,
		xisFlags: flags.xisRestFlags,
		xis: A2(_user$project$XisRestApi$createSession, flags.xisRestFlags, _user$project$DjangoRestFramework$NoAuthorization),
		currTime: 0,
		selectedTab: 0,
		shows: {ctor: '[]'},
		selectedShow: _elm_lang$core$Maybe$Nothing,
		selectedShowDate: _elm_lang$core$Maybe$Nothing,
		episode: _elm_lang$core$Maybe$Nothing,
		broadcast: _elm_lang$core$Maybe$Nothing,
		datePicker: datePicker,
		member: _elm_lang$core$Maybe$Nothing,
		nowPlaying: _elm_lang$core$Maybe$Nothing,
		showBatchEntryDialog: false,
		batchEntryText: _elm_lang$core$Maybe$Nothing,
		tracksTabEntries: A2(_elm_lang$core$Array$repeat, _user$project$DjOps$numTrackRows, _user$project$DjOps$blankTracksTabEntry),
		tracksTabEntriesChanging: _elm_lang$core$Set$empty,
		userid: _elm_lang$core$Maybe$Nothing,
		password: _elm_lang$core$Maybe$Nothing
	};
	var getShowsCmd = model.xis.listShows(_user$project$DjOps$ShowList_Result);
	return {
		ctor: '_Tuple2',
		_0: model,
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				...
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$DjOps$SetDatePicker, datePickerCmd),
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Layout$sub0(_user$project$DjOps$Mdl),
						_1: {ctor: '[]'}
					}
				}
			})
...
var _user$project$DjOps$tracks_tableRow = F2(
	function (model, r) {
		var mmss = _elm_lang$core$Regex$regex('^\\d*\\:\\d\\d$');
		var aTd = F4(
			function (s, tte, c, opts) {
				return A2(
					_debois$elm_mdl$Material_Table$td,
					A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$DjOps$restTdStyle,
						{
							ctor: '::',
							_0: A2(
								_debois$elm_mdl$Material_Options$css,
								'color',
								A2(_user$project$DjOps$tracksTabEntryColumnIsDirty, tte, c) ? 'red' : 'black'),
							_1: {ctor: '[]'}
						}),
					{
						ctor: '::',
						_0: A5(
							...
							_user$project$DjOps$Mdl,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _user$project$DjOps$trackTabEntryColumnId(c),
										_1: {ctor: '[]'}
									}
								}
							},
							...
							A2(
								...
								{
									ctor: '::',
									_0: _debois$elm_mdl$Material_Textfield$label(s),
									_1: {
										ctor: '::',
										_0: A2(
											_debois$elm_mdl$Material_Options$when,
											_elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$DurationColumn),
											_debois$elm_mdl$Material_Textfield$maxlength(6)),
										_1: {
											ctor: '::',
											...
											_1: {
												...
												_0: A2(
													_debois$elm_mdl$Material_Options$when,
													_elm_community$maybe_extra$Maybe_Extra$isNothing(model.member) || _elm_community$maybe_extra$Maybe_Extra$isNothing(model.episode),
													_debois$elm_mdl$Material_Textfield$disabled),
												_1: {
													ctor: '::',
													_0: A2(
														_debois$elm_mdl$Material_Options$when,
														_elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$DurationColumn) && ((_elm_lang$core$Native_Utils.cmp(
															_elm_lang$core$String$length(tte.duration),
															0) > 0) && function (_p28) {
															return !A2(_elm_lang$core$Regex$contains, mmss, _p28);
														}(tte.duration)),
														_debois$elm_mdl$Material_Textfield$error('Must be MM:SS')),
													_1: {
														ctor: '::',
														_0: _debois$elm_mdl$Material_Options$onInput(
															A2(_user$project$DjOps$TrackFieldUpdate, r, c)),
														_1: {ctor: '[]'}
													}
												}
											}
		...
		var _p29 = A2(_elm_lang$core$Array$get, r, model.tracksTabEntries);
		if (_p29.ctor === 'Just') {
			var _p30 = _p29._0;
			return A2(
				_debois$elm_mdl$Material_Table$tr,
				{
					...
					_0: A2(
						_debois$elm_mdl$Material_Options$css,
						'color',
						_user$project$DjOps$tracksTabEntryIsDirty(_p30) ? 'red' : 'black'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						_debois$elm_mdl$Material_Table$td,
						_user$project$DjOps$firstTdStyle,
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
					...
					_1: {
						...
						_0: A4(
							...
							'Artist',
							_p30,
							_user$project$DjOps$ArtistColumn,
							{ctor: '[]'}),
						_1: {
							ctor: '::',
							_0: A4(
								...
								'Title',
								_p30,
								_user$project$DjOps$TitleColumn,
								{ctor: '[]'}),
							_1: {
								ctor: '::',
								_0: A4(
									...
									'Dur',
									_p30,
									_user$project$DjOps$DurationColumn,
									{
										ctor: '::',
										_0: A2(_debois$elm_mdl$Material_Options$css, 'width', '55px'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
										...
										_user$project$DjOps$firstTdStyle,
										{
											...
											_0: A5(
												...
												model.mdl,
												{
													...
													_1: {
														ctor: '::',
														_0: _debois$elm_mdl$Material_Button$plain,
														_1: {
															ctor: '::',
															_0: _debois$elm_mdl$Material_Options$onClick(
																A2(_user$project$DjOps$PlayTrack_Clicked, r, _p30)),
															_1: {
																ctor: '::',
																_0: A2(
																	_debois$elm_mdl$Material_Options$when,
												...
												{
													ctor: '::',
													_0: A3(_user$project$DjOps$tracksTabEntryIcon, model, r, _p30),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
			...
			var dummy = _elm_lang$core$Debug$log('Couldn\'t get row.');
			return A2(
				_debois$elm_mdl$Material_Table$tr,
				{ctor: '[]'},
				{ctor: '[]'});
...
var _user$project$DjOps$tracks_table = function (model) {
	return A2(
		_debois$elm_mdl$Material_Table$table,
		{
			ctor: '::',
			_0: A2(_debois$elm_mdl$Material_Options$css, 'margin', '20px'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				A2(
					_elm_lang$core$List$map,
					_user$project$DjOps$tracks_tableRow(model),
					A2(_elm_lang$core$List$range, 1, _user$project$DjOps$numTrackRows))),
			_1: {ctor: '[]'}
		});
};
var _user$project$DjOps$Logout_Clicked = {ctor: 'Logout_Clicked'};
var _user$project$DjOps$tab_finish = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'margin', '50px'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			...
			_0: A5(
				_debois$elm_mdl$Material_Button$render,
				_user$project$DjOps$Mdl,
				_user$project$DjOps$logoutButtonId,
				model.mdl,
				{
					ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$onClick(_user$project$DjOps$Logout_Clicked),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$DjOps$Login_Clicked = {ctor: 'Login_Clicked'};
var _user$project$DjOps$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _user$project$DjOps$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$DjOps$Tick),
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$downs(_user$project$DjOps$KeyDown),
				_1: {
					ctor: '::',
					_0: A2(_debois$elm_mdl$Material_Layout$subs, _user$project$DjOps$Mdl, model.mdl),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$DjOps$EpisodeTrackUpsert_Result = F2(
	function (a, b) {
		return {ctor: 'EpisodeTrackUpsert_Result', _0: a, _1: b};
	});
var _user$project$DjOps$upsertEpisodeTrack = F3(
	function (model, row, tte) {
		var _p31 = model.episode;
		if (_p31.ctor === 'Just') {
			var etData = A6(
				_user$project$XisRestApi$EpisodeTrackData,
				model.xis.episodeUrl(_p31._0.id),
				row,
				tte.artist,
				tte.title,
				tte.duration,
				tte.trackBroadcast);
			var _p32 = tte.episodeTrackId;
			if (_p32.ctor === 'Just') {
				return A2(
					model.xis.replaceEpisodeTrack,
					A2(_user$project$DjangoRestFramework$Resource, _p32._0, etData),
					_user$project$DjOps$EpisodeTrackUpsert_Result(row));
			} else {
				return A2(
			...
			var dummy = A2(
				...
				'Episode is Nothing',
				{ctor: '_Tuple2', _0: model.selectedShow, _1: model.selectedShowDate});
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
var _user$project$DjOps$EpisodeTrackDelete_Result = F2(
	function (a, b) {
		return {ctor: 'EpisodeTrackDelete_Result', _0: a, _1: b};
	});
var _user$project$DjOps$deleteEpisodeTrack = F3(
	function (model, row, tte) {
		var _p33 = tte.episodeTrackId;
		if (_p33.ctor === 'Just') {
			return A2(
				model.xis.deleteEpisodeTrackById,
				_p33._0,
				_user$project$DjOps$EpisodeTrackDelete_Result(row));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
var _user$project$DjOps$saveTracksTab = F2(
	function (minIdle, _p34) {
		var _p35 = _p34;
		var _p44 = _p35._0;
		var reducer = F2(
			function (_p37, _p36) {
				...
				var _p41 = _p39._0;
				var _p40 = _p39._1;
				if (_user$project$DjOps$tracksTabEntryIsDirty(_p43) && (!A2(_elm_lang$core$Set$member, _p42, _p41.tracksTabEntriesChanging))) {
					var newTtesChanging = A2(_elm_lang$core$Set$insert, _p42, _p41.tracksTabEntriesChanging);
					var extraCmd = A2(
						...
						}) ? A3(_user$project$DjOps$deleteEpisodeTrack, _p41, _p42, _p43) : A3(_user$project$DjOps$upsertEpisodeTrack, _p41, _p42, _p43);
					return A2(
						...
						extraCmd,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								_p41,
								{tracksTabEntriesChanging: newTtesChanging}),
							_1: _p40
						});
				} else {
		...
		return (_elm_lang$core$Native_Utils.cmp(_p44.keyboardIdleTime, minIdle) > -1) ? A3(
			_elm_lang$core$List$foldl,
			reducer,
			{ctor: '_Tuple2', _0: _p44, _1: _p35._1},
			_elm_lang$core$Array$toIndexedList(_p44.tracksTabEntries)) : {ctor: '_Tuple2', _0: _p44, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$DjOps$tick_SaveTracksTab = function (_p45) {
	var _p46 = _p45;
	return A2(
		_user$project$DjOps$saveTracksTab,
		5,
		{ctor: '_Tuple2', _0: _p46._0, _1: _p46._1});
};
var _user$project$DjOps$EpisodeList_Result = F3(
	function (a, b, c) {
		return {ctor: 'EpisodeList_Result', _0: a, _1: b, _2: c};
	});
var _user$project$DjOps$fetchTracksTabData = function (_p47) {
	var _p48 = _p47;
	var _p52 = _p48._0;
	var _p49 = {ctor: '_Tuple2', _0: _p52.selectedShow, _1: _p52.selectedShowDate};
	if (((_p49.ctor === '_Tuple2') && (_p49._0.ctor === 'Just')) && (_p49._1.ctor === 'Just')) {
		var _p51 = _p49._1._0;
		var _p50 = _p49._0._0;
		var tagger = A2(_user$project$DjOps$EpisodeList_Result, _p50, _p51);
		var dateFilter = _user$project$XisRestApi$EpisodeDateEquals(
			_user$project$CalendarDate$fromDate(_p51));
		var showFilter = _user$project$XisRestApi$EpisodeShowEquals(_p50.id);
		var fetchCmd = A2(
			_p52.xis.listEpisodes,
			{
				ctor: '::',
				_0: showFilter,
				_1: {
			...
			tagger);
		return {ctor: '_Tuple2', _0: _p52, _1: fetchCmd};
	} else {
		return {ctor: '_Tuple2', _0: _p52, _1: _p48._1};
	}
};
var _user$project$DjOps$EpisodeCreate_Result = F3(
	function (a, b, c) {
		return {ctor: 'EpisodeCreate_Result', _0: a, _1: b, _2: c};
	});
var _user$project$DjOps$CheckNowPlaying = {ctor: 'CheckNowPlaying'};
var _user$project$DjOps$tick_NowPlayingCheck = function (_p53) {
	var _p54 = _p53;
	var _p56 = _p54._0;
	var _p55 = _user$project$DjOps$nowPlayingTimeRemaining(_p56);
	var showSecsLeft = _p55.showSecsLeft;
	var trackSecsLeft = _p55.trackSecsLeft;
	var trackCmd = ((_elm_lang$core$Native_Utils.cmp(trackSecsLeft, 1.0) < 0) && (_elm_lang$core$Native_Utils.cmp(trackSecsLeft, -5.0) > 0)) ? _elm_lang$core$Platform_Cmd$batch(
		{
			ctor: '::',
			_0: A2(_user$project$DjOps$delay, 0.25 * _elm_lang$core$Time$second, _user$project$DjOps$CheckNowPlaying),
			_1: {
				ctor: '::',
				_0: A2(_user$project$DjOps$delay, 0.5 * _elm_lang$core$Time$second, _user$project$DjOps$CheckNowPlaying),
				_1: {
					ctor: '::',
					_0: A2(_user$project$DjOps$delay, 0.75 * _elm_lang$core$Time$second, _user$project$DjOps$CheckNowPlaying),
					_1: {
						ctor: '::',
						_0: A2(_user$project$DjOps$delay, 1.0 * _elm_lang$core$Time$second, _user$project$DjOps$CheckNowPlaying),
						_1: {ctor: '[]'}
					}
				}
			}
		}) : ((_elm_lang$core$Native_Utils.cmp(trackSecsLeft, -5.0) < 1) ? A2(_user$project$DjOps$delay, 0.5 * _elm_lang$core$Time$second, _user$project$DjOps$CheckNowPlaying) : _elm_lang$core$Platform_Cmd$none);
	var showCmd = ((_elm_lang$core$Native_Utils.cmp(showSecsLeft, 0.0) < 1) && (_elm_lang$core$Native_Utils.cmp(trackSecsLeft, 1.0) > -1)) ? A2(_user$project$DjOps$delay, 0.5 * _elm_lang$core$Time$second, _user$project$DjOps$CheckNowPlaying) : _elm_lang$core$Platform_Cmd$none;
	return A2(
		_ccapndave$elm_update_extra$Update_Extra$addCmd,
		showCmd,
		A2(
			_ccapndave$elm_update_extra$Update_Extra$addCmd,
			trackCmd,
			{ctor: '_Tuple2', _0: _p56, _1: _p54._1}));
};
var _user$project$DjOps$BroadcastExists_Result = function (a) {
	return {ctor: 'BroadcastExists_Result', _0: a};
};
var _user$project$DjOps$fetchBroadcastData = function (_p57) {
	var _p58 = _p57;
	var _p61 = _p58._0;
	var _p60 = _p58._1;
	var _p59 = _p61.episode;
	if (_p59.ctor === 'Just') {
		var tagger = _user$project$DjOps$BroadcastExists_Result;
		var typeFilter = _user$project$XisRestApi$BroadcastsWithTypeEqualTo(_user$project$XisRestApi$FirstBroadcast);
		var epiFilter = _user$project$XisRestApi$BroadcastsWithEpisodeIdEqualTo(_p59._0.id);
		var fetchCmd = A2(
			_p61.xis.listBroadcasts,
			{
				ctor: '::',
				_0: epiFilter,
				_1: {
		...
		return A2(
			_ccapndave$elm_update_extra$Update_Extra$addCmd,
			fetchCmd,
			{ctor: '_Tuple2', _0: _p61, _1: _p60});
	} else {
		return {ctor: '_Tuple2', _0: _p61, _1: _p60};
	}
};
var _user$project$DjOps$BroadcastCheckInUpdate_Result = function (a) {
	return {ctor: 'BroadcastCheckInUpdate_Result', _0: a};
};
var _user$project$DjOps$BeginBroadcast_Clicked = {ctor: 'BeginBroadcast_Clicked'};
var _user$project$DjOps$beginBroadcast_Button = function (model) {
	return A5(
		_debois$elm_mdl$Material_Button$render,
		_user$project$DjOps$Mdl,
		_user$project$DjOps$beginBroadcastButtonId,
		model.mdl,
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Button$raised,
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: function () {
							if (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.episode) || _elm_community$maybe_extra$Maybe_Extra$isNothing(model.member)) {
								return _debois$elm_mdl$Material_Button$disabled;
							} else {
								var _p62 = model.selectedShowDate;
								if (_p62.ctor === 'Just') {
									return (!_elm_lang$core$Native_Utils.eq(
										_user$project$CalendarDate$fromDate(_p62._0),
										_user$project$CalendarDate$fromTime(model.currTime))) ? _debois$elm_mdl$Material_Button$disabled : _debois$elm_mdl$Material_Options$nop;
								} else {
									return _debois$elm_mdl$Material_Button$disabled;
								}
							}
						...
						_1: {
							ctor: '::',
							_0: _debois$elm_mdl$Material_Options$onClick(_user$project$DjOps$BeginBroadcast_Clicked),
							_1: {ctor: '[]'}
						}
					}
				}
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Begin Broadcast!'),
			_1: {ctor: '[]'}
		});
};
var _user$project$DjOps$tab_start = function (model) {
	var $break = A2(
		_elm_lang$html$Html$br,
		{ctor: '[]'},
		{ctor: '[]'});
	var row = _elm_lang$html$Html$tr(
		{ctor: '[]'});
	var para = _elm_lang$html$Html$p(
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'margin-top', '10px'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
	var checkTd = _elm_lang$html$Html$td(
		{ctor: '[]'});
	var instTd = _elm_lang$html$Html$td(
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'padding-left', '15px'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
	var numTd = function (isSet) {
		return _elm_lang$html$Html$td(
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: A2(_user$project$DjOps_ops['=>'], 'padding-left', '5px'),
						_1: {
							ctor: '::',
							_0: A2(_user$project$DjOps_ops['=>'], 'font-size', '24pt'),
							_1: {
								ctor: '::',
								_0: A2(
									_user$project$DjOps_ops['=>'],
									'color',
									isSet ? 'green' : 'red'),
								_1: {ctor: '[]'}
							}
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'margin', '30px'),
					_1: {
						ctor: '::',
						_0: A2(_user$project$DjOps_ops['=>'], 'zoom', '1'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Welcome to the DJ Ops Console!'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
						...
						_0: row(
							{
								...
								_0: A2(
									numTd,
									_elm_community$maybe_extra$Maybe_Extra$isJust(model.userid) && (_elm_community$maybe_extra$Maybe_Extra$isJust(model.password) && _elm_community$maybe_extra$Maybe_Extra$isJust(model.member)),
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('❶ '),
										_1: {ctor: '[]'}
											...
											_0: para(
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: A2(_elm_lang$html$Html_Attributes$attribute, 'placeholder', 'userid'),
															_1: {
																ctor: '::',
																_0: A2(
																	_elm_lang$html$Html_Attributes$attribute,
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onInput(_user$project$DjOps$UseridInput),
																	_1: {ctor: '[]'}
																}
															}
														},
														...
														_1: {
															...
															_0: A2(
																_elm_lang$html$Html$input,
																{
																	...
																	_0: _elm_lang$html$Html_Attributes$style(
																		{
																			ctor: '::',
																			_0: A2(_user$project$DjOps_ops['=>'], 'margin-top', '3px'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		_0: A2(_elm_lang$html$Html_Attributes$attribute, 'placeholder', 'password'),
																		_1: {
																			ctor: '::',
																			...
																			_1: {
																				...
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Events$onInput(_user$project$DjOps$PasswordInput),
																					_1: {ctor: '[]'}
																				}
																			}
																		}
															...
															_1: {
																...
																_0: A5(
																	_debois$elm_mdl$Material_Button$render,
																	_user$project$DjOps$Mdl,
																	_user$project$DjOps$loginButtonId,
																	model.mdl,
																	{
																		ctor: '::',
																		_0: A2(_debois$elm_mdl$Material_Options$css, 'position', 'relative'),
																		_1: {
																			ctor: '::',
																			_0: A2(_debois$elm_mdl$Material_Options$css, 'bottom', '20px'),
																			_1: {
																				ctor: '::',
																				...
																				_1: {
																					...
																					_1: {
																						...
																						_1: {
																							...
																							_1: {
																								ctor: '::',
																								_0: _debois$elm_mdl$Material_Options$onClick(_user$project$DjOps$Login_Clicked),
																								_1: {ctor: '[]'}
																							}
																						}
																					}
							...
							_0: row(
								{
									...
									_0: A2(
										numTd,
										_elm_community$maybe_extra$Maybe_Extra$isJust(model.selectedShow),
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('❷ '),
											_1: {ctor: '[]'}
										...
										_0: instTd(
											{
												...
												_0: para(
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Choose a show to work on: '),
														_1: {
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html$br,
															...
															_1: {
																ctor: '::',
																_0: _user$project$DjOps$showSelector(model),
																_1: {ctor: '[]'}
															}
														}
													}),
								...
								_0: row(
									{
										...
										_0: A2(
											numTd,
											_elm_community$maybe_extra$Maybe_Extra$isJust(model.selectedShowDate),
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('❸ '),
												_1: {ctor: '[]'}
											...
											_0: instTd(
												{
													...
													_0: para(
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Specify the show date: '),
															_1: {
																ctor: '::',
																_0: _user$project$DjOps$showDateSelector(model),
																_1: {ctor: '[]'}
															}
														}),
													_1: {ctor: '[]'}
									...
									_0: row(
										{
											...
											_0: A2(
												numTd,
												_elm_community$maybe_extra$Maybe_Extra$isJust(model.broadcast),
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('❹ '),
													_1: {ctor: '[]'}
												...
												_0: instTd(
													{
														...
														_0: para(
															_elm_community$maybe_extra$Maybe_Extra$isJust(model.broadcast) ? {
																ctor: '::',
																_0: _elm_lang$html$Html$text('Host has checked in!'),
																_1: {ctor: '[]'}
															} : {
																ctor: '::',
																_0: _elm_lang$html$Html$text('ONLY when it\'s time to start your LIVE show:'),
																_1: {
																	ctor: '::',
																	_0: A2(
																		_elm_lang$html$Html$br,
																	...
																	_1: {
																		ctor: '::',
																		_0: _user$project$DjOps$beginBroadcast_Button(model),
																		_1: {ctor: '[]'}
																	}
																}
															}),
...
var _user$project$DjOps$BatchEntry_Process_Clicked = {ctor: 'BatchEntry_Process_Clicked'};
var _user$project$DjOps$BatchEntry_JJP_Clicked = {ctor: 'BatchEntry_JJP_Clicked'};
var _user$project$DjOps$track_entry_footer = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A5(
				...
				model.mdl,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _debois$elm_mdl$Material_Options$onClick(_user$project$DjOps$BatchEntry_JJP_Clicked),
							_1: {
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'margin-right', '15px'),
								_1: {ctor: '[]'}
							}
						}
					}
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('JJP'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A5(
					_debois$elm_mdl$Material_Button$render,
					_user$project$DjOps$Mdl,
					_user$project$DjOps$processButtonId,
					model.mdl,
					{
						ctor: '::',
						_0: _debois$elm_mdl$Material_Button$raised,
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$onClick(_user$project$DjOps$BatchEntry_Process_Clicked),
								_1: {ctor: '[]'}
							}
						}
					},
...
var _user$project$DjOps$BatchEntry_Input = function (a) {
	return {ctor: 'BatchEntry_Input', _0: a};
};
var _user$project$DjOps$track_entry_textarea = function (model) {
	return A2(
		_elm_lang$html$Html$textarea,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'width', '100%'),
					_1: {
						ctor: '::',
						_0: A2(_user$project$DjOps_ops['=>'], 'height', '400px'),
						_1: {
							ctor: '::',
							_0: A2(_user$project$DjOps_ops['=>'], 'font-size', '14pt'),
							_1: {
								ctor: '::',
								_0: A2(_user$project$DjOps_ops['=>'], 'line-height', '1'),
								_1: {ctor: '[]'}
							}
						}
					}
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$placeholder('Artist Name\nTrack Title\nMM:SS\n\nArtist Name\nTrack Title\nMM:SS\n\n'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$value(
						A2(_elm_lang$core$Maybe$withDefault, '', model.batchEntryText)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$DjOps$BatchEntry_Input),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$DjOps$BatchEntry_Closed = {ctor: 'BatchEntry_Closed'};
var _user$project$DjOps$batch_track_entry = function (model) {
	return model.showBatchEntryDialog ? _elm_lang$core$Maybe$Just(
		{
			closeMessage: _elm_lang$core$Maybe$Just(_user$project$DjOps$BatchEntry_Closed),
			containerClass: _elm_lang$core$Maybe$Nothing,
			containerId: _elm_lang$core$Maybe$Nothing,
			header: _elm_lang$core$Maybe$Just(
				_elm_lang$html$Html$text('Batch Track Entry')),
			body: _elm_lang$core$Maybe$Just(
				_user$project$DjOps$track_entry_textarea(model)),
			footer: _elm_lang$core$Maybe$Just(
				_user$project$DjOps$track_entry_footer(model))
		}) : _elm_lang$core$Maybe$Nothing;
};
var _user$project$DjOps$BatchEntry_Clicked = {ctor: 'BatchEntry_Clicked'};
var _user$project$DjOps$tracks_info = function (model) {
	var para = _elm_lang$html$Html$p(
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					...
					_1: {
						ctor: '::',
						_0: A2(_user$project$DjOps_ops['=>'], 'margin-bottom', '0'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'float', 'right'),
					_1: {
						ctor: '::',
						_0: A2(_user$project$DjOps_ops['=>'], 'position', 'fixed'),
						_1: {
							ctor: '::',
							_0: A2(_user$project$DjOps_ops['=>'], 'right', '50px'),
							_1: {
								ctor: '::',
								_0: A2(_user$project$DjOps_ops['=>'], 'top', '150px'),
								_1: {
									ctor: '::',
									_0: A2(_user$project$DjOps_ops['=>'], 'background-color', 'lemonchiffon'),
									_1: {
										ctor: '::',
										_0: A2(_user$project$DjOps_ops['=>'], 'padding', '10px'),
										_1: {
											ctor: '::',
											_0: A2(_user$project$DjOps_ops['=>'], 'border', 'solid 1px'),
											_1: {
												ctor: '::',
												_0: A2(_user$project$DjOps_ops['=>'], 'width', '250px'),
												_1: {ctor: '[]'}
											}
										}
									}
		...
		function () {
			var _p63 = {ctor: '_Tuple3', _0: model.selectedShow, _1: model.selectedShowDate, _2: model.member};
			if ((((_p63.ctor === '_Tuple3') && (_p63._0.ctor === 'Just')) && (_p63._1.ctor === 'Just')) && (_p63._2.ctor === 'Just')) {
				return {
					ctor: '::',
					_0: para(
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text('Manually enter tracks for'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(' '),
									_1: {
										...
										_0: A2(
											_elm_lang$html$Html$span,
											{
												...
												_0: _elm_lang$html$Html_Attributes$style(
													{
														ctor: '::',
														_0: A2(_user$project$DjOps_ops['=>'], 'font-style', 'italic'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(_p63._0._0.data.title),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											...
											_1: {
												...
												_0: _elm_lang$html$Html$text(
													A2(
														_user$project$CalendarDate$format,
														'%a %b %ddd',
														_user$project$CalendarDate$fromDate(_p63._1._0))),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html$text('.'),
													_1: {ctor: '[]'}
						...
						_0: para(
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text('Or use: '),
									_1: {
										ctor: '::',
										_0: A5(
											_debois$elm_mdl$Material_Button$render,
											_user$project$DjOps$Mdl,
											_user$project$DjOps$pasteTextButtonId,
											model.mdl,
											{
												ctor: '::',
												_0: _debois$elm_mdl$Material_Button$raised,
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _debois$elm_mdl$Material_Options$onClick(_user$project$DjOps$BatchEntry_Clicked),
														_1: {
															ctor: '::',
															_0: A2(
																_debois$elm_mdl$Material_Options$when,
																A2(
																	...
																	function (_p64) {
																		return _elm_community$maybe_extra$Maybe_Extra$isJust(
																			function (_) {
																				return _.trackBroadcast;
																			}(_p64));
																	},
																	_elm_lang$core$Array$toList(model.tracksTabEntries)),
																_debois$elm_mdl$Material_Button$disabled),
															_1: {ctor: '[]'}
														}
													}
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Batch Entry'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
				...
				return {
					...
					_0: para(
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('You must first log in and specify an episode on the START tab.'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				};
...
var _user$project$DjOps$tab_tracks = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$DjOps$tracks_info(model),
			_1: {
				ctor: '::',
				_0: _user$project$DjOps$tracks_table(model),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$DjOps$layout_main = function (model) {
	var _p65 = model.selectedTab;
	switch (_p65) {
		case 0:
			return _user$project$DjOps$tab_start(model);
		case 1:
			return _user$project$DjOps$tab_tracks(model);
		case 3:
			return _user$project$DjOps$tab_finish(model);
		default:
			return A2(
				_elm_lang$html$Html$p,
				{
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_1: {
								ctor: '::',
								_0: A2(_user$project$DjOps_ops['=>'], 'font-size', '16pt'),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('This tab is not yet implemented.'),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$DjOps$Authenticate_Result = function (a) {
	return {ctor: 'Authenticate_Result', _0: a};
};
var _user$project$DjOps$update = F2(
	function (action, model) {
		var xis = model.xis;
		var _p66 = action;
		switch (_p66.ctor) {
			case 'AcknowledgeErrorDialog':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'BatchEntry_Clicked':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{showBatchEntryDialog: true}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'BatchEntry_Closed':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'BatchEntry_Input':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							batchEntryText: _elm_lang$core$Maybe$Just(_p66._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'BatchEntry_JJP_Clicked':
				var ensureFinalEol = function (s) {
					return A2(_elm_lang$core$String$endsWith, '\n', s) ? s : A2(_elm_lang$core$Basics_ops['++'], s, '\n');
				};
				var dashToEol = A3(
					_elm_lang$core$Regex$replace,
					_elm_lang$core$Regex$All,
				...
				var doubleEol = A3(
					...
					_elm_lang$core$Regex$regex('\\n'),
					_elm_lang$core$Basics$always('\n\n'));
				var jjpTransform = function (_p67) {
					return ensureFinalEol(
						dashToEol(
							doubleEol(_p67)));
				};
				var transformed = A2(_elm_lang$core$Maybe$map, jjpTransform, model.batchEntryText);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{batchEntryText: transformed}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'BatchEntry_Process_Clicked':
				var _p68 = model.batchEntryText;
				if (_p68.ctor === 'Just') {
					var lines = A2(
						_elm_lang$core$List$map,
						_elm_lang$core$String$trim,
					...
					return A3(
						...
						_user$project$DjOps$update,
						_user$project$DjOps$BatchEntry_Closed,
						A2(
							_ccapndave$elm_update_extra$Update_Extra$updateModel,
							function (m) {
								return A6(_user$project$DjOps$ingestBatchEntry, lines, 1, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, m);
							},
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none}));
				} else {
					return A3(
			...
			case 'BeginBroadcast_Clicked':
				var _p69 = model.episode;
				if (_p69.ctor === 'Just') {
					var bcData = {
						episode: model.xis.episodeUrl(_p69._0.id),
						date: _user$project$CalendarDate$fromPointInTime(model.currTime),
						hostCheckedIn: _elm_lang$core$Maybe$Just(
							_user$project$ClockTime$fromPointInTime(model.currTime)),
						theType: _user$project$XisRestApi$FirstBroadcast
					};
					var createCmd = A2(model.xis.createBroadcast, bcData, _user$project$DjOps$BroadcastCheckInUpdate_Result);
					return {ctor: '_Tuple2', _0: model, _1: createCmd};
				} else {
					var dummy = A2(_elm_lang$core$Debug$log, 'ERR', 'BeginBroadcast_Clicked');
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'CheckNowPlaying':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: model.xis.nowPlaying(_user$project$DjOps$NowPlaying_Result)
				};
			case 'KeyDown':
				return {
					ctor: '_Tuple2',
			...
			case 'Login_Clicked':
				var _p81 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p81.ctor === '_Tuple2') && (_p81._0.ctor === 'Just')) && (_p81._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A3(model.xis.authenticate, _p81._0._0, _p81._1._0, _user$project$DjOps$Authenticate_Result)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			...
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p66._0, model);
			case 'PasswordInput':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							password: _elm_lang$core$Maybe$Just(_p66._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'PlayTrack_Clicked':
				var _p86 = _p66._1;
				var _p85 = _p86.episodeTrackId;
				if (_p85.ctor === 'Just') {
					var callback = A2(_user$project$DjOps$TrackBroadastCreate_Result, _p66._0, _p86);
					var trackBroadcastData = {
						start: model.currTime,
						libraryTrack: _elm_lang$core$Maybe$Nothing,
						nonLibraryTrack: _elm_lang$core$Maybe$Just(
							model.xis.episodeTrackUrl(_p85._0)),
						libraryTrackEmbed: _elm_lang$core$Maybe$Nothing,
						nonLibraryTrackEmbed: _elm_lang$core$Maybe$Nothing
					};
					var cmd = A2(model.xis.createTrackBroadcast, trackBroadcastData, callback);
					return A2(
						_user$project$DjOps$saveTracksTab,
						0,
						{ctor: '_Tuple2', _0: model, _1: cmd});
				} else {
					var dummy = A2(_elm_lang$core$Debug$log, 'EpisodeTrackId is Nothing: ', _p86);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'SelectTab':
				return A2(
			...
			case 'SetDatePicker':
				var _p87 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p66._0, model.datePicker);
				var newDatePicker = _p87._0;
				var datePickerCmd = _p87._1;
				var dateEvent = _p87._2;
				var _p88 = dateEvent;
				if (_p88.ctor === 'NoChange') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{datePicker: newDatePicker}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$DjOps$SetDatePicker, datePickerCmd)
					};
				} else {
					return _user$project$DjOps$fetchTracksTabData(
						{
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{selectedShowDate: _p88._0, datePicker: newDatePicker}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$DjOps$SetDatePicker, datePickerCmd)
						});
				}
			case 'ShowList_Result':
				if (_p66._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{shows: _p66._0._0.results}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p66._0._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'ShowWasChosen':
				var _p90 = _p66._0;
				var _p89 = _elm_lang$core$Result$toMaybe(
					_elm_lang$core$String$toInt(_p90));
				if (_p89.ctor === 'Just') {
					var show = A2(
						_elm_community$list_extra$List_Extra$find,
						function (s) {
							return _elm_lang$core$Native_Utils.eq(s.id, _p89._0);
						},
						model.shows);
					return _user$project$DjOps$fetchTracksTabData(
						{
					...
					var dummy = A2(_elm_lang$core$Debug$log, 'Couldn\'t convert to Int', _p90);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Tick':
				return _user$project$DjOps$tick_SaveTracksTab(
					_user$project$DjOps$tick_Idle(
						_user$project$DjOps$tick_NowPlayingCheck(
							_user$project$DjOps$tick_NowPlayingClocks(
								{
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
			...
			case 'TrackFieldUpdate':
				var _p93 = _p66._2;
				var _p92 = _p66._0;
				var tte1 = A2(
					_elm_lang$core$Maybe$withDefault,
					_user$project$DjOps$blankTracksTabEntry,
					A2(_elm_lang$core$Array$get, _p92, model.tracksTabEntries));
				var tte2 = function () {
					var _p91 = _p66._1;
					switch (_p91.ctor) {
						case 'ArtistColumn':
						...
						default:
							return _elm_lang$core$Native_Utils.update(
								tte1,
								{
									duration: _user$project$DjOps$mmss_mask(_p93)
								});
					}
				}();
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						tracksTabEntries: A3(_elm_lang$core$Array$set, _p92, tte2, model.tracksTabEntries)
					});
			...
			case 'UseridInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							userid: _elm_lang$core$Maybe$Just(_p66._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Authenticate_Result':
				if (_p66._0.ctor === 'Ok') {
					if (_p66._0._0.isAuthentic) {
						var password = A2(_elm_lang$core$Maybe$withDefault, 'NO_PW', model.password);
						var userid = A2(_elm_lang$core$Maybe$withDefault, 'NO_ID', model.userid);
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								member: _p66._0._0.authenticatedMember,
								xis: A2(
									_user$project$XisRestApi$createSession,
									model.xisFlags,
									A2(_user$project$DjangoRestFramework$Basic, userid, password))
							});
						return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
					} else {
						var errMsgs = {
							ctor: '::',
							_0: 'Bad userid and/or password provided.',
							_1: {
								ctor: '::',
								_0: 'Close this dialog and try again.',
								_1: {ctor: '[]'}
							}
						};
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{member: _elm_lang$core$Maybe$Nothing, errMsgs: errMsgs});
						return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
					}
				} else {
					return {
			...
			case 'EpisodeTrackDelete_Result':
				if (_p66._1.ctor === 'Ok') {
					var _p78 = _p66._0;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								tracksTabEntries: A3(_elm_lang$core$Array$set, _p78, _user$project$DjOps$blankTracksTabEntry, model.tracksTabEntries),
								tracksTabEntriesChanging: A2(_elm_lang$core$Set$remove, _p78, model.tracksTabEntriesChanging)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p66._1._0),
									_1: {ctor: '[]'}
								},
								tracksTabEntriesChanging: A2(_elm_lang$core$Set$remove, _p66._0, model.tracksTabEntriesChanging)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'EpisodeTrackUpsert_Result':
				if (_p66._1.ctor === 'Ok') {
					var _p80 = _p66._1._0;
					var _p79 = A2(_elm_lang$core$Array$get, _p80.data.sequence, model.tracksTabEntries);
					if (_p79.ctor === 'Just') {
						var newTtesChanging = A2(_elm_lang$core$Set$remove, _p66._0, model.tracksTabEntriesChanging);
						var newTte = _elm_lang$core$Native_Utils.update(
							_p79._0,
							{
								episodeTrackId: _elm_lang$core$Maybe$Just(_p80.id),
								savedArtist: _p80.data.artist,
								savedTitle: _p80.data.title,
								savedDuration: _p80.data.duration,
								savedTrackBroadcast: _p80.data.trackBroadcast
							});
						var newTtes = A3(_elm_lang$core$Array$set, _p80.data.sequence, newTte, model.tracksTabEntries);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{tracksTabEntries: newTtes, tracksTabEntriesChanging: newTtesChanging}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
						var dummy = A2(_elm_lang$core$Debug$log, 'Couldn\'t find row for', _p80);
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				} else {
					return {
			...
			case 'NowPlaying_Result':
				if (_p66._0.ctor === 'Ok') {
					var _p84 = _p66._0._0;
					var _p82 = model.nowPlaying;
					if (_p82.ctor === 'Just') {
						var _p83 = _p82._0;
						var show = A2(
							_elm_lang$core$Maybe$withDefault,
						...
						var mTitle = A2(
							...
							A2(
								...
								_p83.track));
						var joinHosts = _elm_lang$core$Maybe$map(
							_elm_lang$core$String$join(', '));
						var mHost = A2(
							_elm_lang$core$Maybe$withDefault,
							'',
						...
						var modifiedNP = A2(
							_user$project$XisRestApi$NowPlaying,
							((!_elm_lang$core$Native_Utils.eq(mShow, show)) || (!_elm_lang$core$Native_Utils.eq(mHost, host))) ? _p84.show : _p83.show,
							((!_elm_lang$core$Native_Utils.eq(mTitle, title)) || (!_elm_lang$core$Native_Utils.eq(mArtist, artist))) ? _p84.track : _p83.track);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									nowPlaying: _elm_lang$core$Maybe$Just(modifiedNP)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									nowPlaying: _elm_lang$core$Maybe$Just(_p84)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
					...
					var dummy = A2(
						_elm_lang$core$Debug$log,
						'NowPlaying_Result',
						_elm_lang$core$Basics$toString(_p66._0._0));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
			...
			case 'BroadcastCheckInUpdate_Result':
				if (_p66._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								broadcast: _elm_lang$core$Maybe$Just(_p66._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'BroadcastExists_Result':
				if (_p66._0.ctor === 'Ok') {
					var _p71 = _p66._0._0.results;
					var _p70 = _p71;
					if (_p70.ctor === '[]') {
						return {
							ctor: '_Tuple2',
						...
						if (_p70._1.ctor === '[]') {
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										broadcast: _elm_lang$core$Maybe$Just(_p70._0)
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						} else {
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										errMsgs: {
											ctor: '::',
											_0: 'Multiple matching broadcast records.',
											_1: {
												ctor: '::',
												_0: 'Please contact Admin.',
												_1: {
													ctor: '::',
													_0: _elm_lang$core$Basics$toString(_p71),
													_1: {ctor: '[]'}
												}
											}
										}
			...
			case 'EpisodeCreate_Result':
				if (_p66._2.ctor === 'Ok') {
					var _p72 = _p66._2._0;
					var msg = A3(
						_user$project$DjOps$EpisodeList_Result,
						_p66._0,
						_p66._1,
						_elm_lang$core$Result$Ok(
							_user$project$DjangoRestFramework$singletonPageOf(_p72)));
					return A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
						_user$project$DjOps$update,
						msg,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									episode: _elm_lang$core$Maybe$Just(_p72)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						});
				} else {
					var dummy = A2(
						_elm_lang$core$Debug$log,
						'EpisodeCreate_Result',
						_elm_lang$core$Basics$toString(_p66._2._0));
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'EpisodeList_Result':
				if (_p66._2.ctor === 'Ok') {
					var _p77 = _p66._1;
					var _p76 = _p66._0;
					var _p75 = _p66._2._0.results;
					var _p74 = _p66._2._0.count;
					if (_elm_lang$core$Native_Utils.eq(_p74, 1)) {
						var episode = _elm_lang$core$List$head(_p75);
						var tracksForTab = A2(
							_elm_lang$core$Maybe$withDefault,
							{ctor: '[]'},
							A2(
								...
								episode));
						return _user$project$DjOps$fetchBroadcastData(
							A2(
								_ccapndave$elm_update_extra$Update_Extra$updateModel,
								_user$project$DjOps$populateTracksTabData(tracksForTab),
								{
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
						...
						if (_elm_lang$core$Native_Utils.eq(_p74, 0)) {
							var tagger = A2(_user$project$DjOps$EpisodeCreate_Result, _p76, _p77);
							var selShowUrl = model.xis.showUrl(_p76.id);
							var epData = A4(
								_user$project$XisRestApi$EpisodeData,
								selShowUrl,
								_user$project$CalendarDate$fromDate(_p77),
								'',
								{ctor: '[]'});
							var createCmd = A2(model.xis.createEpisode, epData, tagger);
							return {ctor: '_Tuple2', _0: model, _1: createCmd};
						} else {
							var dummy = A2(_elm_lang$core$Debug$log, '>1 Episode', _p75);
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						}
					}
				} else {
			...
			default:
				if (_p66._2.ctor === 'Ok') {
					var trackBroadcastUrl = model.xis.trackBroadcastUrl(_p66._2._0.id);
					var newTte = _elm_lang$core$Native_Utils.update(
						_p66._1,
						{
							trackBroadcast: _elm_lang$core$Maybe$Just(trackBroadcastUrl)
						});
					var newTtes = A3(_elm_lang$core$Array$set, _p66._0, newTte, model.tracksTabEntries);
					return A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
						_user$project$DjOps$update,
						_user$project$DjOps$CheckNowPlaying,
						A2(
							_user$project$DjOps$saveTracksTab,
							0,
							{
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p66._2._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
...
var _user$project$DjOps$AcknowledgeErrorDialog = {ctor: 'AcknowledgeErrorDialog'};
var _user$project$DjOps$err_dialog_config = function (model) {
	return (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$List$length(model.errMsgs),
		0) > 0) ? _elm_lang$core$Maybe$Just(
		{
			closeMessage: _elm_lang$core$Maybe$Just(_user$project$DjOps$AcknowledgeErrorDialog),
			containerClass: _elm_lang$core$Maybe$Nothing,
			containerId: _elm_lang$core$Maybe$Nothing,
			header: _elm_lang$core$Maybe$Just(
						...
						function (_p94) {
							return A2(
								...
								_elm_lang$core$List$singleton(
									_elm_lang$html$Html$text(_p94)));
						},
						model.errMsgs))),
			footer: _elm_lang$core$Maybe$Nothing
		}) : _elm_lang$core$Maybe$Nothing;
};
var _user$project$DjOps$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A4(
				...
				model.mdl,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _debois$elm_mdl$Material_Layout$onSelectTab(_user$project$DjOps$SelectTab),
							_1: {
								ctor: '::',
				...
				{
					header: _user$project$DjOps$layout_header(model),
					drawer: {ctor: '[]'},
					tabs: _user$project$DjOps$tabs(model),
					main: {
						ctor: '::',
						_0: _user$project$DjOps$layout_main(model),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				ctor: '::',
				_0: _jackwillis$elm_dialog$Dialog$view(
					_user$project$DjOps$err_dialog_config(model)),
				_1: {
					ctor: '::',
					_0: _jackwillis$elm_dialog$Dialog$view(
						_user$project$DjOps$batch_track_entry(model)),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$DjOps$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$DjOps$init, view: _user$project$DjOps$view, update: _user$project$DjOps$update, subscriptions: _user$project$DjOps$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (csrfToken) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				function (xisRestFlags) {
					return _elm_lang$core$Json_Decode$succeed(
						{csrfToken: csrfToken, xisRestFlags: xisRestFlags});
				},
				A2(
					_elm_lang$core$Json_Decode$field,
					'xisRestFlags',
					A2(
						...
						function (authenticateUrl) {
							return A2(
												...
												function (discoveryMethodListUrl) {
													return A2(
														...
														function (emailMembershipInfoUrl) {
															return A2(
																_elm_lang$core$Json_Decode$andThen,
																function (episodeListUrl) {
																	return A2(
																		_elm_lang$core$Json_Decode$andThen,
																		function (episodeTrackListUrl) {
																			return A2(
																				_elm_lang$core$Json_Decode$andThen,
																																...
																																function (showListUrl) {
																																	return A2(
																																		...
																																		function (taskListUrl) {
																																			return A2(
																																				_elm_lang$core$Json_Decode$andThen,
																																				function (timeBlockListUrl) {
																																					return A2(
																																						_elm_lang$core$Json_Decode$andThen,
																																						function (timeBlockTypeListUrl) {
																																							return A2(
																																								_elm_lang$core$Json_Decode$andThen,
																																								function (trackBroadcastListUrl) {
																																									return A2(
																																										_elm_lang$core$Json_Decode$andThen,
																																										function (trackListUrl) {
																																											return A2(
																																												_elm_lang$core$Json_Decode$andThen,
																																												function (vendLogListUrl) {
																																													return A2(
																																														_elm_lang$core$Json_Decode$andThen,
																																																...
																																																function (workListUrl) {
																																																	return A2(
																																																		...
																																																		function (workNoteListUrl) {
																																																			return _elm_lang$core$Json_Decode$succeed(
																																																				{authenticateUrl: authenticateUrl, broadcastListUrl: broadcastListUrl, claimListUrl: claimListUrl, discoveryMethodListUrl: discoveryMethodListUrl, emailMembershipInfoUrl: emailMembershipInfoUrl, episodeListUrl: episodeListUrl, episodeTrackListUrl: episodeTrackListUrl, logMessageUrl: logMessageUrl, memberListUrl: memberListUrl, membershipListUrl: membershipListUrl, nowPlayingUrl: nowPlayingUrl, playListUrl: playListUrl, productListUrl: productListUrl, showListUrl: showListUrl, taskListUrl: taskListUrl, timeBlockListUrl: timeBlockListUrl, timeBlockTypeListUrl: timeBlockTypeListUrl, trackBroadcastListUrl: trackBroadcastListUrl, trackListUrl: trackListUrl, vendLogListUrl: vendLogListUrl, visitEventListUrl: visitEventListUrl, workListUrl: workListUrl, workNoteListUrl: workNoteListUrl});
																																																		},
																																												...
																																												A2(_elm_lang$core$Json_Decode$field, 'vendLogListUrl', _elm_lang$core$Json_Decode$string));
																																										},
																																										A2(_elm_lang$core$Json_Decode$field, 'trackListUrl', _elm_lang$core$Json_Decode$string));
																																								},
																																								A2(_elm_lang$core$Json_Decode$field, 'trackBroadcastListUrl', _elm_lang$core$Json_Decode$string));
																																						},
																																						A2(_elm_lang$core$Json_Decode$field, 'timeBlockTypeListUrl', _elm_lang$core$Json_Decode$string));
																																				},
																																				A2(_elm_lang$core$Json_Decode$field, 'timeBlockListUrl', _elm_lang$core$Json_Decode$string));
																																		},
																																		A2(_elm_lang$core$Json_Decode$field, 'taskListUrl', _elm_lang$core$Json_Decode$string));
																																},
																																A2(_elm_lang$core$Json_Decode$field, 'showListUrl', _elm_lang$core$Json_Decode$string));
																														},
																														A2(_elm_lang$core$Json_Decode$field, 'productListUrl', _elm_lang$core$Json_Decode$string));
																												},
																												A2(_elm_lang$core$Json_Decode$field, 'playListUrl', _elm_lang$core$Json_Decode$string));
																										},
																										A2(_elm_lang$core$Json_Decode$field, 'nowPlayingUrl', _elm_lang$core$Json_Decode$string));
																								},
																		...
																		A2(_elm_lang$core$Json_Decode$field, 'episodeTrackListUrl', _elm_lang$core$Json_Decode$string));
																},
																A2(_elm_lang$core$Json_Decode$field, 'episodeListUrl', _elm_lang$core$Json_Decode$string));
														},
								...
								A2(_elm_lang$core$Json_Decode$field, 'broadcastListUrl', _elm_lang$core$Json_Decode$string));
						},
...
var Elm = {};
Elm['DjOps'] = Elm['DjOps'] || {};
if (typeof _user$project$DjOps$main !== 'undefined') {
    _user$project$DjOps$main(Elm['DjOps'], 'DjOps', undefined);
}
