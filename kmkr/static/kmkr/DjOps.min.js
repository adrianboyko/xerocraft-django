...
var _user$project$XisRestApi$ShowData = F4(
	function (a, b, c, d) {
		return {title: a, duration: b, description: c, active: d};
	});
var _user$project$XisRestApi$decodeShowData = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$XisRestApi$ShowData,
...
var _user$project$DjOps$titleAndArtist = F2(
...
var _user$project$DjOps$layout_header_col_trackInfo = function (model) {
	var blankInfo = {
		...
		_1: {
			ctor: '::',
			_0: A2(_user$project$DjOps$titleAndArtist, '...', '...'),
			_1: {ctor: '[]'}
		}
	};
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'width', '80%'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
			...
			if (_p2.ctor === 'Just') {
				...
				if (_p3.ctor === 'Just') {
					...
					return (_elm_lang$core$Native_Utils.cmp(_p4.remainingSeconds, 0) > 0) ? {
						...
						_1: {
							ctor: '::',
							_0: A2(_user$project$DjOps$titleAndArtist, _p4.title, _p4.artist),
							_1: {ctor: '[]'}
						}
					} : blankInfo;
				} else {
...
var _user$project$DjOps$TrackTick = {ctor: 'TrackTick'};
					...
					return A2(
						_elm_lang$html$Html$option,
						{
							...
							_1: {
								...
								_0: _user$project$DjOps$tagattr(
									function () {
										var _p5 = model.chosenShowsId;
										if (_p5.ctor === 'Just') {
											return _elm_lang$core$Native_Utils.eq(show.id, _p5._0) ? 'selected' : 'dummy';
										} else {
											return 'dummy';
										}
									}()),
...
var _user$project$DjOps$checkAnRfid = function (model) {
	...
	switch (_p6.ctor) {
		...
		case 'FoundRfidToBe':
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		default:
			var _p7 = model.rfidsToCheck;
			if (_p7.ctor === '::') {
				var memberFilters = {
					ctor: '::',
					_0: _user$project$XisRestApi$RfidNumberEquals(_p7._0),
					_1: {ctor: '[]'}
				};
...
var _user$project$DjOps$init = function (flags) {
	...
	var datePickerCmd = _p8._1;
	var auth = function () {
		var _p9 = flags.csrfToken;
		if (_p9.ctor === 'Just') {
			return _user$project$DjangoRestFramework$LoggedIn(_p9._0);
		} else {
...
var _user$project$DjOps$update = F2(
	function (action, model) {
		...
		switch (_p11.ctor) {
			...
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p11._0, model);
			case 'SelectTab':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'UseridInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							userid: _elm_lang$core$Maybe$Just(_p11._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'PasswordInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							password: _elm_lang$core$Maybe$Just(_p11._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			...
			case 'SetDatePicker':
				var _p12 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p11._0, model.datePicker);
				var newDatePicker = _p12._0;
				var datePickerCmd = _p12._1;
				var dateEvent = _p12._2;
				var date = function () {
					var _p13 = dateEvent;
					if (_p13.ctor === 'NoChange') {
			...
			case 'KeyDownAuthenticate':
				var _p14 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p14.ctor === '_Tuple2') && (_p14._0.ctor === 'Just')) && (_p14._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _elm_lang$core$Native_Utils.eq(_p11._0, 13) ? A3(model.xis.authenticate, _p14._0._0, _p14._1._0, _user$project$DjOps$Authenticate_Result) : _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Authenticate_Result':
				if (_p11._0.ctor === 'Ok') {
					var errMsgs = _p11._0._0.isAuthentic ? {ctor: '[]'} : {
						ctor: '::',
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{member: _p11._0._0.authenticatedMember, errMsgs: errMsgs}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
			...
			case 'KeyDownRfid':
						...
						default:
							return A2(
								...
								_elm_lang$core$String$fromChar(
									_elm_lang$core$Char$fromCode(_p15)));
					}
				}();
				...
				if (_elm_lang$core$List$isEmpty(finds)) {
					...
					var hexToInt = function (_p16) {
						return _rtfeldman$hex$Hex$fromString(
							_elm_lang$core$String$toLower(_p16));
					};
			...
			case 'RfidTick':
				...
				if (_p21.ctor === 'CheckingAnRfid') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$DjOps$CheckingAnRfid(_p21._0 + 1)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'TrackFieldUpdate':
				...
				var _p23 = _p11._0;
				var _p22 = _p11._1;
				var newModel = _elm_lang$core$Native_Utils.eq(_p22, _user$project$DjOps$artistColId) ? _elm_lang$core$Native_Utils.update(
					model,
					{
						artists: A3(_elm_lang$core$Array$set, _p23, _p24, model.artists)
					}) : (_elm_lang$core$Native_Utils.eq(_p22, _user$project$DjOps$titleColId) ? _elm_lang$core$Native_Utils.update(
					model,
					{
						titles: A3(_elm_lang$core$Array$set, _p23, _p24, model.titles)
					}) : (_elm_lang$core$Native_Utils.eq(_p22, _user$project$DjOps$durationColId) ? _elm_lang$core$Native_Utils.update(
					model,
					{
						durations: A3(_elm_lang$core$Array$set, _p23, _p24, model.durations)
					}) : model));
				return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
			case 'TrackTick':
				var _p25 = model.nowPlaying;
				if (_p25.ctor === 'Just') {
					var _p28 = _p25._0;
					var _p26 = _p28.track;
					if (_p26.ctor === 'Just') {
						...
						var updatedTrack = _elm_lang$core$Native_Utils.update(
							_p27,
							{remainingSeconds: _p27.remainingSeconds - 1});
				...
				if (_p11._0.ctor === 'Ok') {
						...
						if (_p17._1.ctor === '[]') {
							...
							var newModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									...
									rfidsToCheck: {ctor: '[]'},
									typed: '',
									loggedAsPresent: A2(_elm_lang$core$Set$insert, _p18.id, model.loggedAsPresent)
								});
							var cmd2 = A2(_elm_lang$core$Set$member, _p18.id, model.loggedAsPresent) ? _elm_lang$core$Platform_Cmd$none : A2(
								model.xis.createVisitEvent,
								{
									who: model.xis.memberUrl(_p18.id),
									when: model.currTime,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$DjOps$HitAnHttpErr(_p11._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			default:
				if (_p11._0.ctor === 'Ok') {
					...
					var delaySeconds = function () {
						var _p19 = _p20.track;
						if (_p19.ctor === 'Just') {
							var rs = _p19._0.remainingSeconds;
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								nowPlaying: _elm_lang$core$Maybe$Just(_p20)
							}),
