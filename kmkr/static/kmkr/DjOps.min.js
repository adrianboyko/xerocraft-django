...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var _p18 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
				start: {line: 1135, column: 25},
				end: {line: 1135, column: 36}
...
var _user$project$XisRestApi$listWorks = F4(
	function (flags, auth, filters, resultToMsg) {
		var request = A3(
			...
			auth,
			A3(_user$project$XisRestApi$filteredListUrl, flags.workListUrl, filters, _user$project$XisRestApi$workFilterToString),
...
var _user$project$XisRestApi$listMembers = F4(
	function (flags, auth, filters, resultToMsg) {
		var request = A3(
			_user$project$DjangoRestFramework$getRequest,
			auth,
			A3(_user$project$XisRestApi$filteredListUrl, flags.memberListUrl, filters, _user$project$XisRestApi$memberFilterToString),
...
var _user$project$XisRestApi$listMemberships = F4(
	function (flags, auth, filters, resultToMsg) {
		var request = A3(
			_user$project$DjangoRestFramework$getRequest,
			auth,
			A3(_user$project$XisRestApi$filteredListUrl, flags.membershipListUrl, filters, _user$project$XisRestApi$membershipFilterToString),
...
var _user$project$XisRestApi$listShows = F3(
	function (model, auth, resultToMsg) {
		var request = A2(
			_elm_lang$http$Http$get,
			model.showListUrl,
			_user$project$DjangoRestFramework$decodePageOf(_user$project$XisRestApi$decodeShow));
		return A2(_elm_lang$http$Http$send, resultToMsg, request);
	});
...
var _user$project$XisRestApi$listEpisodes = F4(
	function (flags, auth, filters, resultToMsg) {
		var request = A3(
			_user$project$DjangoRestFramework$getRequest,
			auth,
			A3(_user$project$XisRestApi$filteredListUrl, flags.episodeListUrl, filters, _user$project$XisRestApi$episodeFilterToString),
			_user$project$DjangoRestFramework$decodePageOf(
...
var _user$project$XisRestApi$decodeTrack = _user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodeTrackData);
var _user$project$XisRestApi$listTracks = F3(
	function (model, auth, resultToMsg) {
		var request = A2(
			_elm_lang$http$Http$get,
			model.trackListUrl,
			_user$project$DjangoRestFramework$decodePageOf(_user$project$XisRestApi$decodeTrack));
		return A2(_elm_lang$http$Http$send, resultToMsg, request);
	});
...
var _user$project$XisRestApi$listTasks = F4(
	function (flags, auth, filters, resultToMsg) {
		var request = A3(
			_user$project$DjangoRestFramework$getRequest,
			auth,
			A3(_user$project$XisRestApi$filteredListUrl, flags.taskListUrl, filters, _user$project$XisRestApi$taskFilterToString),
...
var _user$project$XisRestApi$listClaims = F4(
	function (flags, auth, filters, resultToMsg) {
		var request = A3(
			_user$project$DjangoRestFramework$getRequest,
			auth,
			A3(_user$project$XisRestApi$filteredListUrl, flags.claimListUrl, filters, _user$project$XisRestApi$claimFilterToString),
...
var _user$project$XisRestApi$listVisitEvents = F4(
	function (flags, auth, filters, resultToMsg) {
		var request = A3(
			_user$project$DjangoRestFramework$getRequest,
			auth,
			A3(_user$project$XisRestApi$filteredListUrl, flags.visitEventListUrl, filters, _user$project$XisRestApi$visitEventFilterToString),
			_user$project$DjangoRestFramework$decodePageOf(
...
var _user$project$XisRestApi$createSession = F2(
	function (flags, auth) {
		return {
			...
			listPlays: A2(_user$project$XisRestApi$listPlays, flags, auth),
			listShows: A2(_user$project$XisRestApi$listShows, flags, auth),
			listEpisodes: A2(_user$project$XisRestApi$listEpisodes, flags, auth),
																																														...
																																														function (workListUrl) {
																																															return A2(
																																																...
																																																function (workNoteListUrl) {
																																																	return _elm_lang$core$Json_Decode$succeed(
																																																		{authenticateUrl: authenticateUrl, broadcastListUrl: broadcastListUrl, claimListUrl: claimListUrl, discoveryMethodListUrl: discoveryMethodListUrl, emailMembershipInfoUrl: emailMembershipInfoUrl, episodeListUrl: episodeListUrl, episodeTrackListUrl: episodeTrackListUrl, logMessageUrl: logMessageUrl, memberListUrl: memberListUrl, membershipListUrl: membershipListUrl, nowPlayingUrl: nowPlayingUrl, playListUrl: playListUrl, productListUrl: productListUrl, showListUrl: showListUrl, taskListUrl: taskListUrl, timeBlockTypesUrl: timeBlockTypesUrl, timeBlocksUrl: timeBlocksUrl, trackListUrl: trackListUrl, vendLogListUrl: vendLogListUrl, visitEventListUrl: visitEventListUrl, workListUrl: workListUrl, workNoteListUrl: workNoteListUrl});
																																																},
