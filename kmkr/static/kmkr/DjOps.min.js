...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var _p13 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
				start: {line: 1200, column: 25},
				end: {line: 1200, column: 36}
...
var _user$project$XisRestApi$ShowInstanceData = F4(
	function (a, b, c, d) {
		return {title: a, duration: b, description: c, active: d};
	});
var _user$project$XisRestApi$decodeShowInstanceData = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$XisRestApi$ShowInstanceData,
	A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'duration', _user$project$DjangoRestFramework$decodeDuration),
	A2(_elm_lang$core$Json_Decode$field, 'description', _elm_lang$core$Json_Decode$string),
...
var _user$project$XisRestApi$ShowEquals = function (a) {
	return {ctor: 'ShowEquals', _0: a};
};
var _user$project$XisRestApi$DateEquals = function (a) {
	return {ctor: 'DateEquals', _0: a};
};
...
var _user$project$DjOps$send = function (msg) {
	return A2(
		_elm_lang$core$Task$perform,
		_elm_lang$core$Basics$identity,
		_elm_lang$core$Task$succeed(msg));
															...
															return function (p) {
																return function (q) {
																	return function (r) {
																		return function (s) {
																			return function (t) {
																				return {errMsgs: a, mdl: b, xis: c, currTime: d, selectedTab: e, shows: f, chosenShowsId: g, showDate: h, datePicker: i, member: j, nowPlaying: k, artists: l, titles: m, durations: n, state: o, typed: p, rfidsToCheck: q, loggedAsPresent: r, userid: s, password: t};
																			};
																		};
																	};
																};
				...
				_elm_lang$html$Html$option,
				{
					...
					_1: {
						...
						_0: _user$project$DjOps$tagattr(
							_elm_community$maybe_extra$Maybe_Extra$isNothing(model.chosenShowsId) ? 'selected' : 'dummy'),
						_1: {
							ctor: '::',
					...
					return A2(
						_elm_lang$html$Html$option,
						{
							...
							_1: {
								...
								_0: _user$project$DjOps$tagattr(
									function () {
										var _p8 = model.chosenShowsId;
										if (_p8.ctor === 'Just') {
											return _elm_lang$core$Native_Utils.eq(show.id, _p8._0) ? 'selected' : 'dummy';
										} else {
											return 'dummy';
										}
									}()),
...
var _user$project$DjOps$checkAnRfid = function (model) {
	...
	switch (_p9.ctor) {
		...
		case 'FoundRfidToBe':
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		default:
			var _p10 = model.rfidsToCheck;
			if (_p10.ctor === '::') {
				var memberFilters = {
					ctor: '::',
					_0: _user$project$XisRestApi$RfidNumberEquals(_p10._0),
					_1: {ctor: '[]'}
				};
...
var _user$project$DjOps$init = function (flags) {
	...
	var datePickerCmd = _p11._1;
	var auth = function () {
		var _p12 = flags.csrfToken;
		if (_p12.ctor === 'Just') {
			return _user$project$DjangoRestFramework$LoggedIn(_p12._0);
		} else {
	...
	var model = {
		...
		selectedTab: 0,
		shows: {ctor: '[]'},
		chosenShowsId: _elm_lang$core$Maybe$Nothing,
							...
							_0: row(
								{
									...
									_0: A2(
										numTd,
										_elm_community$maybe_extra$Maybe_Extra$isJust(model.chosenShowsId),
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('❷ '),
											_1: {ctor: '[]'}
																			...
																			model.mdl,
																			{
																				...
																				_1: {
																					...
																					_1: {
																						...
																						_1: {
																							ctor: '::',
																							_0: (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.chosenShowsId) || (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.member) || _elm_community$maybe_extra$Maybe_Extra$isNothing(model.showDate))) ? _debois$elm_mdl$Material_Button$disabled : _debois$elm_mdl$Material_Options$nop,
																							_1: {ctor: '[]'}
																						}
																					}
																				}
...
var _user$project$DjOps$LoadTracksTabData = {ctor: 'LoadTracksTabData'};
	...
	function (action, model) {
		...
		switch (_p14.ctor) {
			...
			case 'KeyDownAuthenticate':
				var _p15 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p15.ctor === '_Tuple2') && (_p15._0.ctor === 'Just')) && (_p15._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _elm_lang$core$Native_Utils.eq(_p14._0, 13) ? A3(model.xis.authenticate, _p15._0._0, _p15._1._0, _user$project$DjOps$Authenticate_Result) : _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
						...
						default:
							return A2(
								...
								_elm_lang$core$String$fromChar(
									_elm_lang$core$Char$fromCode(_p16)));
					}
				}();
			...
			case 'LoadTracksTabData':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p14._0, model);
			case 'NowPlaying_Tick':
				var _p22 = model.nowPlaying;
				if (_p22.ctor === 'Just') {
					var _p25 = _p22._0;
					var _p23 = _p25.track;
					if (_p23.ctor === 'Just') {
						...
						var updatedTrack = _elm_lang$core$Native_Utils.update(
							_p24,
							{remainingSeconds: _p24.remainingSeconds - 1});
			...
			case 'PasswordInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							password: _elm_lang$core$Maybe$Just(_p14._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RfidTick':
				var _p26 = model.state;
				if (_p26.ctor === 'CheckingAnRfid') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$DjOps$CheckingAnRfid(_p26._0 + 1)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'SetDatePicker':
				var _p27 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p14._0, model.datePicker);
				var newDatePicker = _p27._0;
				var datePickerCmd = _p27._1;
				var dateEvent = _p27._2;
				var date = function () {
					var _p28 = dateEvent;
					if (_p28.ctor === 'NoChange') {
						return model.showDate;
					} else {
						return _p28._0;
					}
				}();
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{showDate: date, datePicker: newDatePicker}),
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p14._0._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'ShowWasChosen':
				var chosenShowsId = _elm_lang$core$Result$toMaybe(
					_elm_lang$core$String$toInt(_p14._0));
				return A3(
					_ccapndave$elm_update_extra$Update_Extra$andThen,
					_user$project$DjOps$update,
					_user$project$DjOps$LoadTracksTabData,
					{
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{chosenShowsId: chosenShowsId}),
						_1: _elm_lang$core$Platform_Cmd$none
					});
			case 'Tick':
				var newModel = _elm_lang$core$Native_Utils.update(
			...
			case 'TrackFieldUpdate':
				...
				var _p30 = _p14._0;
				var _p29 = _p14._1;
				var newModel = _elm_lang$core$Native_Utils.eq(_p29, _user$project$DjOps$artistColId) ? _elm_lang$core$Native_Utils.update(
					model,
					{
						artists: A3(_elm_lang$core$Array$set, _p30, _p31, model.artists)
					}) : (_elm_lang$core$Native_Utils.eq(_p29, _user$project$DjOps$titleColId) ? _elm_lang$core$Native_Utils.update(
					model,
					{
						titles: A3(_elm_lang$core$Array$set, _p30, _p31, model.titles)
					}) : (_elm_lang$core$Native_Utils.eq(_p29, _user$project$DjOps$durationColId) ? _elm_lang$core$Native_Utils.update(
					model,
					{
						durations: A3(_elm_lang$core$Array$set, _p30, _p31, model.durations)
					}) : model));
			...
			case 'UseridInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							userid: _elm_lang$core$Maybe$Just(_p14._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Authenticate_Result':
				if (_p14._0.ctor === 'Ok') {
					var errMsgs = _p14._0._0.isAuthentic ? {ctor: '[]'} : {
						ctor: '::',
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{member: _p14._0._0.authenticatedMember, errMsgs: errMsgs}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
				...
				if (_p14._0.ctor === 'Ok') {
						...
						if (_p18._1.ctor === '[]') {
							...
							var newModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									...
									rfidsToCheck: {ctor: '[]'},
									typed: '',
									loggedAsPresent: A2(_elm_lang$core$Set$insert, _p19.id, model.loggedAsPresent)
								});
							var cmd2 = A2(_elm_lang$core$Set$member, _p19.id, model.loggedAsPresent) ? _elm_lang$core$Platform_Cmd$none : A2(
								model.xis.createVisitEvent,
								{
									who: model.xis.memberUrl(_p19.id),
									when: model.currTime,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$DjOps$HitAnHttpErr(_p14._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			default:
				if (_p14._0.ctor === 'Ok') {
					...
					var delaySeconds = function () {
						var _p20 = _p21.track;
						if (_p20.ctor === 'Just') {
							var rs = _p20._0.remainingSeconds;
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								nowPlaying: _elm_lang$core$Maybe$Just(_p21)
							}),
