...
var _user$project$XisRestApi$deleteManualPlayListEntryByUrl = F4(
	function (flags, auth, url, tagger) {
		var request = A2(_user$project$DjangoRestFramework$deleteRequest, auth, url);
		return A2(_elm_lang$http$Http$send, tagger, request);
	});
var _user$project$XisRestApi$deleteManualPlayListEntryById = F4(
	function (flags, auth, id, tagger) {
		var url = A2(_user$project$DjangoRestFramework$urlFromId, flags.manualPlayListEntryListUrl, id);
		return A4(_user$project$XisRestApi$deleteManualPlayListEntryByUrl, flags, auth, url, tagger);
	});
var _user$project$XisRestApi$manualPlayListEntryDataNVPs = function (mple) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 'live_show_instance',
			_1: _elm_lang$core$Json_Encode$string(mple.liveShowInstance)
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'sequence',
				_1: _elm_lang$core$Json_Encode$int(mple.sequence)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'artist',
					_1: _elm_lang$core$Json_Encode$string(mple.artist)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'title',
						_1: _elm_lang$core$Json_Encode$string(mple.title)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'duration',
							_1: _elm_lang$core$Json_Encode$string(mple.duration)
						},
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$XisRestApi$encodeManualPlayListEntryData = function (_p1) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$manualPlayListEntryDataNVPs(_p1));
};
var _user$project$XisRestApi$encodeManualPlayListEntry = _user$project$DjangoRestFramework$encodeResource(_user$project$XisRestApi$manualPlayListEntryDataNVPs);
var _user$project$XisRestApi$showInstanceDataNVPs = function (sid) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 'show',
			_1: _elm_lang$core$Json_Encode$string(sid.show)
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'date',
				_1: _user$project$DjangoRestFramework$encodeCalendarDate(sid.date)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'host_checked_in',
					_1: A2(_elm_community$json_extra$Json_Encode_Extra$maybe, _user$project$DjangoRestFramework$encodeClockTime, sid.hostCheckedIn)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'repeat_of',
						_1: A2(_elm_community$json_extra$Json_Encode_Extra$maybe, _elm_lang$core$Json_Encode$string, sid.repeatOf)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$XisRestApi$encodeShowInstance = _user$project$DjangoRestFramework$encodeResource(_user$project$XisRestApi$showInstanceDataNVPs);
var _user$project$XisRestApi$encodeShowInstanceData = function (_p2) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$showInstanceDataNVPs(_p2));
};
var _user$project$XisRestApi$showInstanceFilterToString = function (filter) {
	var _p3 = filter;
	if (_p3.ctor === 'SI_DateEquals') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'date=',
...
var _user$project$XisRestApi$replaceAll = F2(
	function (_p4, whole) {
		...
		return A4(
			_elm_lang$core$Regex$replace,
			_elm_lang$core$Regex$All,
			_elm_lang$core$Regex$regex(_p5.oldSub),
			function (_p6) {
				return _p5.newSub;
			},
			whole);
...
var _user$project$XisRestApi$vendLogDataNVPs = F2(
	function (flags, log) {
		return {
			ctor: '::',
			_0: {
...
var _user$project$XisRestApi$coverTime = F2(
	function (memberships, now) {
		var _p12 = _user$project$XisRestApi$mostRecentMembership(memberships);
		if (_p12.ctor === 'Nothing') {
			return false;
		} else {
			var _p13 = _p12._0;
			var membershipRange = A2(_user$project$RangeOfTime$fromCalendarDates, _p13.data.startDate, _p13.data.endDate);
...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var bd = block.data;
		var _p15 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
				start: {line: 1217, column: 25},
				end: {line: 1217, column: 36}
...
var _user$project$XisRestApi$memberFilterToString = function (filter) {
	...
	switch (_p18.ctor) {
		...
		case 'EmailEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__email__iexact=', _p18._0);
		case 'UsernameEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__iexact=', _p18._0);
		case 'UsernameContains':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__icontains=', _p18._0);
		case 'UsernameStartsWith':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__istartswith=', _p18._0);
		case 'LastNameStartsWith':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__last_name__istartswith=', _p18._0);
		case 'LastNameEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__last_name__iexact=', _p18._0);
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
...
var _user$project$XisRestApi$encodePlayData = function (_p19) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$playDataNVPs(_p19));
};
	...
	switch (_p20.ctor) {
		...
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'play_date=',
				_user$project$CalendarDate$toString(_p20._0));
	}
};
...
var _user$project$XisRestApi$encodeWorkData = function (_p21) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$workDataNVPs(_p21));
};
...
var _user$project$XisRestApi$workFilterToString = function (filter) {
	var _p22 = filter;
	if (_p22.ctor === 'WorkedClaimEquals') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'claim=',
...
var _user$project$XisRestApi$encodeClaimData = function (_p24) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$claimDataNVPs(_p24));
};
	...
	switch (_p26.ctor) {
		case 'ClaimStatusEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'status=',
				_user$project$XisRestApi$claimStatusValue(_p26._0));
...
var _user$project$XisRestApi$memberHasStatusOnTask = F4(
	function (flags, memberNum, questionedStatus, task) {
		...
		var _p29 = actualStatus;
		if (_p29.ctor === 'Nothing') {
			return false;
		} else {
			return _elm_lang$core$Native_Utils.eq(_p29._0, questionedStatus);
		}
	});
var _user$project$XisRestApi$taskFilterToString = function (filter) {
	...
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'scheduled_date=',
		_user$project$CalendarDate$toString(_p30._0));
};
																...
																return function (q) {
																	return function (r) {
																		return function (s) {
																			return function (t) {
																				return function (u) {
																					return {authenticateUrl: a, claimListUrl: b, discoveryMethodListUrl: c, emailMembershipInfoUrl: d, logMessageUrl: e, manualPlayListEntryListUrl: f, memberListUrl: g, membershipListUrl: h, nowPlayingUrl: i, playListUrl: j, productListUrl: k, showListUrl: l, showInstanceListUrl: m, taskListUrl: n, timeBlocksUrl: o, timeBlockTypesUrl: p, trackListUrl: q, vendLogListUrl: r, visitEventListUrl: s, workListUrl: t, workNoteListUrl: u};
																				};
																			};
																		};
																	};
																																																									...
																																																									return function (_32) {
																																																										return function (_33) {
																																																											return function (_34) {
																																																												return function (_35) {
																																																													return function (_36) {
																																																														return {getMembershipById: a, getPlayByUrl: b, getTaskById: c, getTaskFromUrl: d, getWorkFromUrl: e, createClaim: f, createManualPlayListEntry: g, createPlay: h, createShowInstance: i, createVendLog: j, createVisitEvent: k, createWork: l, createWorkNote: m, deleteManualPlayListEntryById: n, deleteManualPlayListEntryByUrl: o, deletePlayById: p, deletePlayByUrl: q, deleteWorkById: r, deleteWorkByUrl: s, listClaims: t, listDiscoveryMethods: u, listMembers: v, listMemberships: w, listPlays: x, listShows: y, listShowInstances: z, listTasks: _1, listTimeBlocks: _2, listTimeBlockTypes: _3, listVisitEvents: _4, listWorks: _5, moreVisitEvents: _6, replaceClaim: _7, replaceManualPlayListEntry: _8, replaceWork: _9, replacePlay: _10, replaceShowInstance: _11, claimUrl: _12, memberUrl: _13, productUrl: _14, showUrl: _15, showInstanceUrl: _16, taskUrl: _17, vendLogUrl: _18, visitEventUrl: _19, workUrl: _20, workNoteUrl: _21, authenticate: _22, blockHasType: _23, coverTime: _24, defaultBlockType: _25, emailMembershipInfo: _26, logMessage: _27, getBlocksTypes: _28, memberCanClaimTask: _29, memberHasStatusOnTask: _30, membersClaimOnTask: _31, membersStatusOnTask: _32, membersWithStatusOnTask: _33, mostRecentMembership: _34, nowPlaying: _35, pitInBlock: _36};
																																																													};
																																																												};
																																																											};
																																																										};
...
var _user$project$XisRestApi$decodeWorkNoteData = A3(
	...
	A2(
		...
		function (_p31) {
			return _elm_community$json_extra$Json_Decode_Extra$fromResult(
				_user$project$PointInTime$fromString(_p31));
		},
		_elm_lang$core$Json_Decode$string),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
...
var _user$project$XisRestApi$decodePlay = _user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodePlayData);
var _user$project$XisRestApi$listPlays = F4(
	function (flags, auth, filters, resultToMsg) {
		var request = A3(
			...
			_user$project$DjangoRestFramework$decodePageOf(_user$project$XisRestApi$decodePlay));
		return A2(_elm_lang$http$Http$send, resultToMsg, request);
	});
var _user$project$XisRestApi$getPlayFromUrl = F4(
	function (flags, auth, url, resultToMsg) {
		var request = A3(_user$project$DjangoRestFramework$getRequest, auth, url, _user$project$XisRestApi$decodePlay);
		return A2(_elm_lang$http$Http$send, resultToMsg, request);
	});
var _user$project$XisRestApi$createPlay = F4(
	function (flags, auth, playData, resultToMsg) {
		var request = _elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {
				...
				body: _elm_lang$http$Http$jsonBody(
					_user$project$XisRestApi$encodePlayData(playData)),
				expect: _elm_lang$http$Http$expectJson(_user$project$XisRestApi$decodePlay),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
		return A2(_elm_lang$http$Http$send, resultToMsg, request);
...
var _user$project$XisRestApi$decodeVendLog = _user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodeVendLogData);
var _user$project$XisRestApi$createVendLog = F4(
	function (flags, auth, vendLogData, resultToMsg) {
		var request = _elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {
				...
				body: _elm_lang$http$Http$jsonBody(
					_elm_lang$core$Json_Encode$object(
						A2(_user$project$XisRestApi$vendLogDataNVPs, flags, vendLogData))),
				expect: _elm_lang$http$Http$expectJson(_user$project$XisRestApi$decodeVendLog),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
		return A2(_elm_lang$http$Http$send, resultToMsg, request);
...
var _user$project$XisRestApi$ShowInstanceData = F5(
	function (a, b, c, d, e) {
		return {show: a, date: b, hostCheckedIn: c, repeatOf: d, manualPlayList: e};
	});
var _user$project$XisRestApi$ManualPlayListEntryData = F5(
	function (a, b, c, d, e) {
		return {liveShowInstance: a, sequence: b, artist: c, title: d, duration: e};
	});
var _user$project$XisRestApi$decodeManualPlayListEntryData = A6(
	_elm_lang$core$Json_Decode$map5,
	_user$project$XisRestApi$ManualPlayListEntryData,
	A2(_elm_lang$core$Json_Decode$field, 'live_show_instance', _user$project$DjangoRestFramework$decodeResourceUrl),
...
var _user$project$XisRestApi$decodeManualPlayListEntry = _user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodeManualPlayListEntryData);
var _user$project$XisRestApi$decodeShowInstanceData = A6(
	_elm_lang$core$Json_Decode$map5,
	_user$project$XisRestApi$ShowInstanceData,
	...
	A2(
		_elm_lang$core$Json_Decode$field,
		'playlist_embed',
		_elm_lang$core$Json_Decode$list(_user$project$XisRestApi$decodeManualPlayListEntry)));
var _user$project$XisRestApi$decodeShowInstance = _user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodeShowInstanceData);
var _user$project$XisRestApi$listShowInstances = F4(
	function (flags, auth, filters, resultToMsg) {
		var request = A3(
			_user$project$DjangoRestFramework$getRequest,
			auth,
			A3(_user$project$XisRestApi$filteredListUrl, flags.showInstanceListUrl, filters, _user$project$XisRestApi$showInstanceFilterToString),
			_user$project$DjangoRestFramework$decodePageOf(_user$project$XisRestApi$decodeShowInstance));
		return A2(_elm_lang$http$Http$send, resultToMsg, request);
	});
var _user$project$XisRestApi$createShowInstance = F4(
	function (flags, auth, sid, resultToMsg) {
		var request = _elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {
				...
				body: _elm_lang$http$Http$jsonBody(
					_user$project$XisRestApi$encodeShowInstanceData(sid)),
				expect: _elm_lang$http$Http$expectJson(_user$project$XisRestApi$decodeShowInstance),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
		return A2(_elm_lang$http$Http$send, resultToMsg, request);
	});
var _user$project$XisRestApi$replaceShowInstance = F4(
	function (flags, auth, showInstance, resultToMsg) {
		var request = _elm_lang$http$Http$request(
			{
				method: 'PUT',
				headers: {
				...
				url: A2(_user$project$DjangoRestFramework$urlFromId, flags.showInstanceListUrl, showInstance.id),
				body: _elm_lang$http$Http$jsonBody(
					_user$project$XisRestApi$encodeShowInstanceData(showInstance.data)),
				expect: _elm_lang$http$Http$expectJson(_user$project$XisRestApi$decodeShowInstance),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
...
var _user$project$XisRestApi$replaceManualPlayListEntry = F4(
		...
		var request = _elm_lang$http$Http$request(
			{
				...
				url: A2(_user$project$DjangoRestFramework$urlFromId, flags.manualPlayListEntryListUrl, mple.id),
				body: _elm_lang$http$Http$jsonBody(
					_user$project$XisRestApi$encodeManualPlayListEntryData(mple.data)),
				expect: _elm_lang$http$Http$expectJson(_user$project$XisRestApi$decodeManualPlayListEntry),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
		return A2(_elm_lang$http$Http$send, resultToMsg, request);
	});
var _user$project$XisRestApi$createManualPlayListEntry = F4(
	function (flags, auth, mpleData, resultToMsg) {
		var request = _elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {
				...
				body: _elm_lang$http$Http$jsonBody(
					_user$project$XisRestApi$encodeManualPlayListEntryData(mpleData)),
				expect: _elm_lang$http$Http$expectJson(_user$project$XisRestApi$decodeManualPlayListEntry),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
...
var _user$project$XisRestApi$taskPriorityDecoder = A2(
	...
	function (str) {
		...
		switch (_p32) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown priority: ', _p32));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$staffingStatusDecoder = A2(
	...
	function (str) {
		...
		switch (_p33) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown staffing status: ', _p33));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeClaimStatus = A2(
	...
	function (str) {
		...
		switch (_p34) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown claim status: ', _p34));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeVisitEventMethod = A2(
	...
	function (str) {
		...
		switch (_p35) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown visit event type: ', _p35));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeVisitEventReason = A2(
	...
	function (str) {
		...
		switch (_p36) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown visit event type: ', _p36));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeVisitEventType = A2(
	...
	function (str) {
		...
		switch (_p37) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown visit event type: ', _p37));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$createSession = F2(
	function (flags, auth) {
		return {
			...
			createManualPlayListEntry: A2(_user$project$XisRestApi$createManualPlayListEntry, flags, auth),
			createPlay: A2(_user$project$XisRestApi$createPlay, flags, auth),
			createShowInstance: A2(_user$project$XisRestApi$createShowInstance, flags, auth),
			createVendLog: A2(_user$project$XisRestApi$createVendLog, flags, auth),
			...
			deleteManualPlayListEntryById: A2(_user$project$XisRestApi$deleteManualPlayListEntryById, flags, auth),
			deleteManualPlayListEntryByUrl: A2(_user$project$XisRestApi$deleteManualPlayListEntryByUrl, flags, auth),
			...
			listShowInstances: A2(_user$project$XisRestApi$listShowInstances, flags, auth),
			...
			replaceManualPlayListEntry: A2(_user$project$XisRestApi$replaceManualPlayListEntry, flags, auth),
			...
			replaceShowInstance: A2(_user$project$XisRestApi$replaceShowInstance, flags, auth),
			...
			showInstanceUrl: _user$project$DjangoRestFramework$urlFromId(flags.showInstanceListUrl),
...
var _user$project$XisRestApi$SI_ShowEquals = function (a) {
	return {ctor: 'SI_ShowEquals', _0: a};
};
var _user$project$XisRestApi$SI_DateEquals = function (a) {
	return {ctor: 'SI_DateEquals', _0: a};
};
												...
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return {errMsgs: a, keyboardIdleTime: b, mdl: c, xisFlags: d, xis: e, currTime: f, selectedTab: g, shows: h, selectedShow: i, selectedShowDate: j, showInstance: k, datePicker: l, member: m, nowPlaying: n, tracksTabEntries: o, userid: p, password: q};
																};
															};
														};
													};
...
var _user$project$DjOps$ShowInstanceList_Result = F3(
	function (a, b, c) {
		return {ctor: 'ShowInstanceList_Result', _0: a, _1: b, _2: c};
	});
var _user$project$DjOps$fetchTracksTabData = function (model) {
	var _p14 = {ctor: '_Tuple2', _0: model.selectedShow, _1: model.selectedShowDate};
	if (((_p14.ctor === '_Tuple2') && (_p14._0.ctor === 'Just')) && (_p14._1.ctor === 'Just')) {
		var _p16 = _p14._1._0;
		var _p15 = _p14._0._0;
		var tagger = A2(_user$project$DjOps$ShowInstanceList_Result, _p15, _p16);
		var dateFilter = _user$project$XisRestApi$SI_DateEquals(
			_user$project$CalendarDate$fromDate(_p16));
		var showFilter = _user$project$XisRestApi$SI_ShowEquals(_p15.id);
		var fetchCmd = A2(
			model.xis.listShowInstances,
			{
				ctor: '::',
				_0: showFilter,
				_1: {
...
var _user$project$DjOps$ShowInstanceCreate_Result = F3(
	function (a, b, c) {
		return {ctor: 'ShowInstanceCreate_Result', _0: a, _1: b, _2: c};
	});
var _user$project$DjOps$ShowInstanceCheckInUpdate_Result = function (a) {
	return {ctor: 'ShowInstanceCheckInUpdate_Result', _0: a};
};
...
var _user$project$DjOps$init = function (flags) {
	var _p17 = _elm_community$elm_datepicker$DatePicker$init;
	var datePicker = _p17._0;
	var datePickerCmd = _p17._1;
	var model = {
		errMsgs: {ctor: '[]'},
		keyboardIdleTime: 0,
		...
		showInstance: _elm_lang$core$Maybe$Nothing,
...
var _user$project$DjOps$tracks_tableRow = F2(
	function (model, r) {
		...
		var _p19 = A2(_elm_lang$core$Array$get, r, model.tracksTabEntries);
		if (_p19.ctor === 'Just') {
			var _p20 = _p19._0;
			return A2(
				_debois$elm_mdl$Material_Table$tr,
				{
					...
					_0: A2(
						_debois$elm_mdl$Material_Options$css,
						'color',
						_user$project$DjOps$tracksTabEntryIsDirty(_p20) ? 'red' : 'black'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _user$project$DjOps$ManualPlayListEntryUpsert_Result = function (a) {
	return {ctor: 'ManualPlayListEntryUpsert_Result', _0: a};
};
var _user$project$DjOps$upsertManualPlayListEntry = F3(
	function (model, row, tte) {
		var _p21 = model.showInstance;
		if (_p21.ctor === 'Just') {
			var mpleData = A5(
				_user$project$XisRestApi$ManualPlayListEntryData,
				model.xis.showInstanceUrl(_p21._0.id),
				row,
				tte.artist,
				tte.title,
				tte.duration);
			var _p22 = tte.playListEntryId;
			if (_p22.ctor === 'Just') {
				return A2(
					model.xis.replaceManualPlayListEntry,
					A2(_user$project$DjangoRestFramework$Resource, _p22._0, mpleData),
					_user$project$DjOps$ManualPlayListEntryUpsert_Result);
			} else {
				return A2(model.xis.createManualPlayListEntry, mpleData, _user$project$DjOps$ManualPlayListEntryUpsert_Result);
			}
		} else {
			var dummy = A2(
				_elm_lang$core$Debug$log,
				'Show instance is Nothing',
				{ctor: '_Tuple2', _0: model.selectedShow, _1: model.selectedShowDate});
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
var _user$project$DjOps$ManualPlayListEntryDelete_Result = F2(
	function (a, b) {
		return {ctor: 'ManualPlayListEntryDelete_Result', _0: a, _1: b};
	});
var _user$project$DjOps$deleteManualPlayListEntry = F3(
	function (model, row, tte) {
		var _p23 = tte.playListEntryId;
		if (_p23.ctor === 'Just') {
			return A2(
				model.xis.deleteManualPlayListEntryById,
				_p23._0,
				_user$project$DjOps$ManualPlayListEntryDelete_Result(row));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, minIdle) {
		var reducer = F2(
			function (_p25, _p24) {
				...
				var _p29 = _p27._0;
				var _p28 = _p27._1;
				if (_user$project$DjOps$tracksTabEntryIsDirty(_p31)) {
					var extraCmd = A2(
						...
						}) ? A3(_user$project$DjOps$deleteManualPlayListEntry, _p29, _p30, _p31) : A3(_user$project$DjOps$upsertManualPlayListEntry, _p29, _p30, _p31);
					return A2(
																				...
																				_1: {
																					...
																					_1: {
																						...
																						_1: {
																							ctor: '::',
																							_0: function () {
																								if (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.showInstance) || _elm_community$maybe_extra$Maybe_Extra$isNothing(model.member)) {
	...
	function (action, model) {
		...
		switch (_p34.ctor) {
			...
			case 'BeginBroadcast_Clicked':
				var _p35 = model.showInstance;
				if (_p35.ctor === 'Just') {
					var _p36 = _p35._0;
					var siData = _p36.data;
					var newSiData = _elm_lang$core$Native_Utils.update(
						siData,
						{
							hostCheckedIn: _elm_lang$core$Maybe$Just(
								_user$project$ClockTime$fromPointInTime(model.currTime))
						});
					var newSi = _elm_lang$core$Native_Utils.update(
						_p36,
						{data: newSiData});
					var updateCmd = A2(model.xis.replaceShowInstance, newSi, _user$project$DjOps$ShowInstanceCheckInUpdate_Result);
					return {ctor: '_Tuple2', _0: model, _1: updateCmd};
				} else {
			...
			case 'SelectTab':
				return A2(
					...
					0);
			case 'SetDatePicker':
				var _p42 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p34._0, model.datePicker);
			...
			case 'ManualPlayListEntryDelete_Result':
				if (_p34._1.ctor === 'Ok') {
			...
			case 'ManualPlayListEntryUpsert_Result':
				if (_p34._0.ctor === 'Ok') {
					var _p39 = _p34._0._0;
			...
			case 'ShowInstanceCheckInUpdate_Result':
				if (_p34._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								showInstance: _elm_lang$core$Maybe$Just(_p34._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'ShowInstanceCreate_Result':
				if (_p34._2.ctor === 'Ok') {
					var _p44 = _p34._2._0;
					var msg = A3(
						_user$project$DjOps$ShowInstanceList_Result,
						_p34._0,
						_p34._1,
						_elm_lang$core$Result$Ok(
					...
					return A3(
						...
						msg,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									showInstance: _elm_lang$core$Maybe$Just(_p44)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						});
				} else {
			...
			default:
				if (_p34._2.ctor === 'Ok') {
					var _p49 = _p34._1;
					var _p48 = _p34._0;
					var _p47 = _p34._2._0.results;
					var _p46 = _p34._2._0.count;
					if (_elm_lang$core$Native_Utils.eq(_p46, 1)) {
						var showInstance = _elm_lang$core$List$head(_p47);
						var tracksForTab = A2(
							_elm_lang$core$Maybe$withDefault,
							{ctor: '[]'},
							A2(
						...
						if (_elm_lang$core$Native_Utils.eq(_p46, 0)) {
							var tagger = A2(_user$project$DjOps$ShowInstanceCreate_Result, _p48, _p49);
							...
							var siData = A5(
								...
								_elm_lang$core$Maybe$Nothing,
								{ctor: '[]'});
							var createCmd = A2(model.xis.createShowInstance, siData, tagger);
							return {ctor: '_Tuple2', _0: model, _1: createCmd};
						} else {
							var dummy = A2(_elm_lang$core$Debug$log, '>1 Show Instance', _p47);
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						}
					}
				} else {
												...
												function (emailMembershipInfoUrl) {
													return A2(
														...
														function (logMessageUrl) {
															return A2(
																_elm_lang$core$Json_Decode$andThen,
																function (manualPlayListEntryListUrl) {
																	return A2(
																		_elm_lang$core$Json_Decode$andThen,
																									...
																									return A2(
																										...
																										function (productListUrl) {
																											return A2(
																																												...
																																												function (workListUrl) {
																																													return A2(
																																														...
																																														function (workNoteListUrl) {
																																															return _elm_lang$core$Json_Decode$succeed(
																																																{authenticateUrl: authenticateUrl, claimListUrl: claimListUrl, discoveryMethodListUrl: discoveryMethodListUrl, emailMembershipInfoUrl: emailMembershipInfoUrl, logMessageUrl: logMessageUrl, manualPlayListEntryListUrl: manualPlayListEntryListUrl, memberListUrl: memberListUrl, membershipListUrl: membershipListUrl, nowPlayingUrl: nowPlayingUrl, playListUrl: playListUrl, productListUrl: productListUrl, showInstanceListUrl: showInstanceListUrl, showListUrl: showListUrl, taskListUrl: taskListUrl, timeBlockTypesUrl: timeBlockTypesUrl, timeBlocksUrl: timeBlocksUrl, trackListUrl: trackListUrl, vendLogListUrl: vendLogListUrl, visitEventListUrl: visitEventListUrl, workListUrl: workListUrl, workNoteListUrl: workNoteListUrl});
																																														},
																												...
																												A2(_elm_lang$core$Json_Decode$field, 'showInstanceListUrl', _elm_lang$core$Json_Decode$string));
																										},
																...
																A2(_elm_lang$core$Json_Decode$field, 'manualPlayListEntryListUrl', _elm_lang$core$Json_Decode$string));
														},
