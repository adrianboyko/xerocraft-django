...
var _user$project$XisRestApi$getResourceFromUrl = F4(
...
var _user$project$XisRestApi$getResourceById = F5(
	function (auth, listUrl, decoder, memberNum, tagger) {
		...
		return A4(_user$project$XisRestApi$getResourceFromUrl, auth, decoder, resUrl, tagger);
	});
var _user$project$XisRestApi$deleteResourceByUrl = F3(
	function (auth, resUrl, tagger) {
		var request = A2(_user$project$DjangoRestFramework$deleteRequest, auth, resUrl);
		return A2(_elm_lang$http$Http$send, tagger, request);
	});
var _user$project$XisRestApi$deleteResourceById = F4(
	function (auth, listUrl, id, tagger) {
		var url = A2(_user$project$DjangoRestFramework$urlFromId, listUrl, id);
		return A3(_user$project$XisRestApi$deleteResourceByUrl, auth, url, tagger);
	});
var _user$project$XisRestApi$createResource = F6(
...
var _user$project$XisRestApi$listFilteredResources = F6(
	function (auth, resourceListUrl, decoder, filterToStr, filters, tagger) {
		var request = A3(
			_user$project$DjangoRestFramework$getRequest,
			auth,
			A3(_user$project$XisRestApi$filteredListUrl, resourceListUrl, filters, filterToStr),
			_user$project$DjangoRestFramework$decodePageOf(
				_user$project$DjangoRestFramework$decodeResource(decoder)));
		return A2(_elm_lang$http$Http$send, tagger, request);
	});
var _user$project$XisRestApi$listResources = F4(
	function (auth, resourceListUrl, decoder, tagger) {
		return A6(
			_user$project$XisRestApi$listFilteredResources,
			auth,
			resourceListUrl,
			decoder,
			_elm_lang$core$Basics$always(''),
...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var _p18 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
				start: {line: 1002, column: 25},
				end: {line: 1002, column: 36}
		...
		var request = _elm_lang$http$Http$request(
			{
				...
				expect: _elm_lang$http$Http$expectJson(
					_user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodeWorkData)),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
...
var _user$project$XisRestApi$listPlays = F4(
	function (flags, auth, filters, resultToMsg) {
		var request = A3(
			_user$project$DjangoRestFramework$getRequest,
			auth,
			A3(_user$project$XisRestApi$filteredListUrl, flags.playListUrl, filters, _user$project$XisRestApi$playFilterToString),
			_user$project$DjangoRestFramework$decodePageOf(
				_user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodePlayData)));
		return A2(_elm_lang$http$Http$send, resultToMsg, request);
	});
var _user$project$XisRestApi$replacePlay = F4(
	function (flags, auth, play, resultToMsg) {
		var request = _elm_lang$http$Http$request(
			{
				method: 'PUT',
				headers: {
				...
				url: A2(_user$project$DjangoRestFramework$urlFromId, flags.playListUrl, play.id),
				body: _elm_lang$http$Http$jsonBody(
					_user$project$XisRestApi$encodePlayData(play.data)),
				expect: _elm_lang$http$Http$expectJson(
					_user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodePlayData)),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
...
var _user$project$XisRestApi$replaceEpisode = F4(
	function (flags, auth, episode, resultToMsg) {
		var request = _elm_lang$http$Http$request(
			{
				method: 'PUT',
				headers: {
				...
				url: A2(_user$project$DjangoRestFramework$urlFromId, flags.episodeListUrl, episode.id),
				body: _elm_lang$http$Http$jsonBody(
					_user$project$XisRestApi$encodeEpisodeData(episode.data)),
				expect: _elm_lang$http$Http$expectJson(
					_user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodeEpisodeData)),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
		return A2(_elm_lang$http$Http$send, resultToMsg, request);
	});
var _user$project$XisRestApi$replaceEpisodeTrack = F4(
	function (flags, auth, mple, resultToMsg) {
		var request = _elm_lang$http$Http$request(
			{
				method: 'PUT',
				headers: {
				...
				url: A2(_user$project$DjangoRestFramework$urlFromId, flags.episodeTrackListUrl, mple.id),
				body: _elm_lang$http$Http$jsonBody(
					_user$project$XisRestApi$encodeEpisodeTrackData(mple.data)),
				expect: _elm_lang$http$Http$expectJson(
					_user$project$DjangoRestFramework$decodeResource(_user$project$XisRestApi$decodeEpisodeTrackData)),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
...
var _user$project$XisRestApi$createSession = F2(
	function (flags, auth) {
		return {
			getMembershipById: A3(_user$project$XisRestApi$getResourceById, auth, flags.membershipListUrl, _user$project$XisRestApi$decodeMembershipData),
			getPlayByUrl: A2(_user$project$XisRestApi$getResourceFromUrl, auth, _user$project$XisRestApi$decodePlayData),
			getTaskById: A3(_user$project$XisRestApi$getResourceById, auth, flags.taskListUrl, _user$project$XisRestApi$decodeTaskData),
			getTaskFromUrl: A2(_user$project$XisRestApi$getResourceFromUrl, auth, _user$project$XisRestApi$decodeTaskData),
			getWorkFromUrl: A2(_user$project$XisRestApi$getResourceFromUrl, auth, _user$project$XisRestApi$decodeWorkData),
			createBroadcast: A4(_user$project$XisRestApi$createResource, auth, flags.broadcastListUrl, _user$project$XisRestApi$encodeBroadcastData, _user$project$XisRestApi$decodeBroadcastData),
			createClaim: A4(_user$project$XisRestApi$createResource, auth, flags.claimListUrl, _user$project$XisRestApi$encodeClaimData, _user$project$XisRestApi$decodeClaimData),
			createEpisodeTrack: A4(_user$project$XisRestApi$createResource, auth, flags.episodeTrackListUrl, _user$project$XisRestApi$encodeEpisodeTrackData, _user$project$XisRestApi$decodeEpisodeTrackData),
			createPlay: A4(_user$project$XisRestApi$createResource, auth, flags.playListUrl, _user$project$XisRestApi$encodePlayData, _user$project$XisRestApi$decodePlayData),
			createEpisode: A4(_user$project$XisRestApi$createResource, auth, flags.episodeListUrl, _user$project$XisRestApi$encodeEpisodeData, _user$project$XisRestApi$decodeEpisodeData),
			createVendLog: A4(_user$project$XisRestApi$createResource, auth, flags.vendLogListUrl, _user$project$XisRestApi$encodeVendLogData, _user$project$XisRestApi$decodeVendLogData),
			createVisitEvent: A2(_user$project$XisRestApi$createVisitEvent, auth, flags.visitEventListUrl),
			createWork: A4(_user$project$XisRestApi$createResource, auth, flags.workListUrl, _user$project$XisRestApi$encodeWorkData, _user$project$XisRestApi$decodeWorkData),
			createWorkNote: A4(_user$project$XisRestApi$createResource, auth, flags.workNoteListUrl, _user$project$XisRestApi$encodeWorkNoteData, _user$project$XisRestApi$decodeWorkNoteData),
			deleteEpisodeTrackById: A2(_user$project$XisRestApi$deleteResourceById, auth, flags.episodeTrackListUrl),
			deleteEpisodeTrackByUrl: _user$project$XisRestApi$deleteResourceByUrl(auth),
			deletePlayById: A2(_user$project$XisRestApi$deleteResourceById, auth, flags.playListUrl),
			deletePlayByUrl: _user$project$XisRestApi$deleteResourceByUrl(auth),
			deleteWorkById: A2(_user$project$XisRestApi$deleteResourceById, auth, flags.workListUrl),
			deleteWorkByUrl: _user$project$XisRestApi$deleteResourceByUrl(auth),
			listClaims: A4(_user$project$XisRestApi$listFilteredResources, auth, flags.claimListUrl, _user$project$XisRestApi$decodeClaimData, _user$project$XisRestApi$claimFilterToString),
			listDiscoveryMethods: A3(_user$project$XisRestApi$listResources, auth, flags.discoveryMethodListUrl, _user$project$XisRestApi$decodeDiscoveryMethodData),
			listEpisodes: A4(_user$project$XisRestApi$listFilteredResources, auth, flags.episodeListUrl, _user$project$XisRestApi$decodeEpisodeData, _user$project$XisRestApi$episodeFilterToString),
			listMembers: A4(_user$project$XisRestApi$listFilteredResources, auth, flags.memberListUrl, _user$project$XisRestApi$decodeMemberData, _user$project$XisRestApi$memberFilterToString),
			listMemberships: A4(_user$project$XisRestApi$listFilteredResources, auth, flags.membershipListUrl, _user$project$XisRestApi$decodeMembershipData, _user$project$XisRestApi$membershipFilterToString),
			listPlays: A4(_user$project$XisRestApi$listFilteredResources, auth, flags.playListUrl, _user$project$XisRestApi$decodePlayData, _user$project$XisRestApi$playFilterToString),
			listShows: A3(_user$project$XisRestApi$listResources, auth, flags.showListUrl, _user$project$XisRestApi$decodeShowData),
			listTasks: A4(_user$project$XisRestApi$listFilteredResources, auth, flags.taskListUrl, _user$project$XisRestApi$decodeTaskData, _user$project$XisRestApi$taskFilterToString),
			listTimeBlocks: A3(_user$project$XisRestApi$listResources, auth, flags.timeBlockListUrl, _user$project$XisRestApi$decodeTimeBlockData),
			listTimeBlockTypes: A3(_user$project$XisRestApi$listResources, auth, flags.timeBlockTypeListUrl, _user$project$XisRestApi$decodeTimeBlockTypeData),
			listVisitEvents: A4(_user$project$XisRestApi$listFilteredResources, auth, flags.visitEventListUrl, _user$project$XisRestApi$decodeVisitEventDataIn, _user$project$XisRestApi$visitEventFilterToString),
			listWorks: A4(_user$project$XisRestApi$listFilteredResources, auth, flags.workListUrl, _user$project$XisRestApi$decodeWorkData, _user$project$XisRestApi$workFilterToString),
			...
			replaceEpisodeTrack: A2(_user$project$XisRestApi$replaceEpisodeTrack, flags, auth),
			replaceWork: A2(_user$project$XisRestApi$replaceWork, flags, auth),
			replacePlay: A2(_user$project$XisRestApi$replacePlay, flags, auth),
			replaceEpisode: A2(_user$project$XisRestApi$replaceEpisode, flags, auth),
				...
				_0: A2(
					_elm_lang$html$Html$span,
					{
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								ctor: '::',
								_0: A2(_user$project$DjOps_ops['=>'], 'margin-top', '4px'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
