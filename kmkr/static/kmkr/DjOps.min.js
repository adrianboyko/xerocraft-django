...
var _user$project$DjOps$showSelectStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$DjOps$showOptions = function (model) {
	return A2(
		_elm_lang$core$List$map,
		function (show) {
			return A2(
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$DjOps$showSelectStyle,
							_1: {ctor: '[]'}
						},
						_user$project$DjOps$showOptions(model)),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$input,
							{
								ctor: '::',
								_0: _user$project$DjOps$userIdPwInputStyle,
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'placeholder', 'userid'),
									_1: {
										ctor: '::',
										_0: A2(_elm_lang$html$Html_Attributes$attribute, 'type', 'userid'),
										_1: {ctor: '[]'}
									}
								}
							},
...
var _user$project$DjOps$Model = F4(
	function (a, b, c, d) {
		return {mdl: a, xis: b, time: c, shows: d};
	});
...
var _user$project$DjOps$init = function (flags) {
	var auth = function () {
		var _p0 = flags.csrfToken;
		if (_p0.ctor === 'Just') {
			return _user$project$DjangoRestFramework$LoggedIn(_p0._0);
		} else {
	...
	var command = model.xis.listShows(_user$project$DjOps$ShowList_Result);
...
var _user$project$DjOps$update = F2(
	function (action, model) {
		...
		switch (_p1.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p1._0, model);
			case 'Tick':
				var _p2 = _p1._0;
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{time: _p2});
				var seconds = (_elm_lang$core$Basics$round(_p2) / 1000) | 0;
