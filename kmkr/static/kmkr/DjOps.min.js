...
var _user$project$XisRestApi$decodeTrackData = A7(
	...
	A2(_elm_lang$core$Json_Decode$field, 'duration_seconds', _elm_lang$core$Json_Decode$int),
...
var _user$project$DjOps$layout_header_center = function (model) {
	...
	if (_p1.ctor === 'Just') {
		var _p2 = {ctor: '_Tuple2', _0: _p1._0.show, _1: _p1._0.track};
		if (((_p2.ctor === '_Tuple2') && (_p2._0.ctor === 'Nothing')) && (_p2._1.ctor === 'Just')) {
			var _p3 = _p2._1._0;
			return {
				ctor: '::',
				_0: _elm_lang$html$Html$text('Now Playing: \''),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text(_p3.artist),
							_1: {ctor: '[]'}
						}
					}
				}
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_elm_lang$html$Html$td,
									{ctor: '[]'},
									_user$project$DjOps$layout_header_left(model)),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$td,
										{ctor: '[]'},
										_user$project$DjOps$layout_header_center(model)),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$td,
											{ctor: '[]'},
											_user$project$DjOps$layout_header_right(model)),
										_1: {ctor: '[]'}
									}
								}
							}),
...
var _user$project$DjOps$tick = F2(
	function (time, model) {
		var _p4 = model.state;
		if (_p4.ctor === 'CheckingAnRfid') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						state: _user$project$DjOps$CheckingAnRfid(_p4._0 + 1)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
		...
		switch (_p11.ctor) {
			...
			case 'Tick':
				...
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{currTime: _p12});
				var seconds = (_elm_lang$core$Basics$round(_p12) / 1000) | 0;
			...
			case 'SetDatePicker':
				var _p13 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p11._0, model.datePicker);
				var newDatePicker = _p13._0;
				var datePickerCmd = _p13._1;
				var dateEvent = _p13._2;
				var date = function () {
					var _p14 = dateEvent;
					if (_p14.ctor === 'NoChange') {
			...
			case 'KeyDownAuthenticate':
				...
				if (((_p15.ctor === '_Tuple2') && (_p15._0.ctor === 'Just')) && (_p15._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _elm_lang$core$Native_Utils.eq(_p11._0, 13) ? A3(model.xis.authenticate, _p15._0._0, _p15._1._0, _user$project$DjOps$Authenticate_Result) : _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
				...
				if (_p11._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								nowPlaying: _elm_lang$core$Maybe$Just(_p11._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
