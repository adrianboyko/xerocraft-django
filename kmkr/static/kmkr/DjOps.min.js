															...
															return function (p) {
																return function (q) {
																	return function (r) {
																		return function (s) {
																			return function (t) {
																				return {errMsgs: a, keyboardIdleTime: b, mdl: c, xis: d, currTime: e, selectedTab: f, shows: g, selectedShow: h, selectedShowDate: i, showInstance: j, datePicker: k, member: l, nowPlaying: m, tracksTabEntries: n, state: o, typed: p, rfidsToCheck: q, loggedAsPresent: r, userid: s, password: t};
																			};
																		};
																	};
																};
...
var _user$project$DjOps$saveTracksTab = function (model) {
	var reducer = F2(
		function (_p27, _p26) {
			var _p28 = _p27;
			var _p33 = _p28._1;
	...
	return (_elm_lang$core$Native_Utils.cmp(model.keyboardIdleTime, 5) > 0) ? A3(
		_elm_lang$core$List$foldl,
		reducer,
		{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none},
	...
	function (action, model) {
		...
		switch (_p36.ctor) {
			...
			case 'Tick_SaveTracksTab':
				return _user$project$DjOps$saveTracksTab(model);
			...
			case 'Authenticate_Result':
				if (_p36._0.ctor === 'Ok') {
					var errMsgs = _p36._0._0.isAuthentic ? {ctor: '[]'} : {
						ctor: '::',
					...
					return A3(
						...
						_user$project$DjOps$FetchTracksTabData,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{member: _p36._0._0.authenticatedMember, errMsgs: errMsgs}),
							_1: _elm_lang$core$Platform_Cmd$none
						});
				} else {
					return {
