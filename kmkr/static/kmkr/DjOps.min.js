...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var _p14 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
				start: {line: 1211, column: 25},
				end: {line: 1211, column: 36}
																																																					...
																																																					return function (_28) {
																																																						return function (_29) {
																																																							return function (_30) {
																																																								return function (_31) {
																																																									return function (_32) {
																																																										return {getMembershipById: a, getPlayByUrl: b, getTaskById: c, getTaskFromUrl: d, getWorkFromUrl: e, createClaim: f, createManualPlayListEntry: g, createPlay: h, createVendLog: i, createVisitEvent: j, createWork: k, createWorkNote: l, deletePlayById: m, deletePlayByUrl: n, deleteWorkById: o, deleteWorkByUrl: p, listClaims: q, listDiscoveryMethods: r, listMembers: s, listMemberships: t, listPlays: u, listShows: v, listShowInstances: w, listTasks: x, listTimeBlocks: y, listTimeBlockTypes: z, listVisitEvents: _1, listWorks: _2, moreVisitEvents: _3, replaceClaim: _4, replaceManualPlayListEntry: _5, replaceWork: _6, replacePlay: _7, claimUrl: _8, memberUrl: _9, productUrl: _10, showUrl: _11, showInstanceUrl: _12, taskUrl: _13, vendLogUrl: _14, visitEventUrl: _15, workUrl: _16, workNoteUrl: _17, authenticate: _18, blockHasType: _19, coverTime: _20, defaultBlockType: _21, emailMembershipInfo: _22, logMessage: _23, getBlocksTypes: _24, memberCanClaimTask: _25, memberHasStatusOnTask: _26, membersClaimOnTask: _27, membersStatusOnTask: _28, membersWithStatusOnTask: _29, mostRecentMembership: _30, nowPlaying: _31, pitInBlock: _32};
																																																									};
																																																								};
																																																							};
																																																						};
...
var _user$project$DjOps$durationColId = 2;
var _user$project$DjOps$titleColId = 1;
var _user$project$DjOps$artistColId = 0;
...
var _user$project$DjOps$TracksTabEntry = F6(
	function (a, b, c, d, e, f) {
		return {lastChanged: a, playListEntryId: b, artist: c, title: d, duration: e, saving: f};
	});
var _user$project$DjOps$newTracksTabEntry = F5(
	function (id, artist, title, duration, saving) {
		return A6(_user$project$DjOps$TracksTabEntry, _elm_lang$core$Maybe$Nothing, id, artist, title, duration, saving);
	});
var _user$project$DjOps$blankTracksTabEntry = A5(_user$project$DjOps$newTracksTabEntry, _elm_lang$core$Maybe$Nothing, '', '', '', false);
var _user$project$DjOps$populateTracksTabData_Helper = F2(
	function (model, plesRemaining) {
		populateTracksTabData_Helper:
		while (true) {
			var _p10 = plesRemaining;
			if (_p10.ctor === '[]') {
				return model;
			} else {
				var _p11 = _p10._0;
				var tte = A5(
					...
					_elm_lang$core$Maybe$Just(_p11.id),
					_p11.data.artist,
					_p11.data.title,
					_p11.data.duration,
					false);
				var seq = _p11.data.sequence;
														...
														return function (o) {
															return function (p) {
																return function (q) {
																	return function (r) {
																		return function (s) {
																			return {errMsgs: a, mdl: b, xis: c, currTime: d, selectedTab: e, shows: f, selectedShow: g, selectedShowDate: h, showInstance: i, datePicker: j, member: k, nowPlaying: l, tracksTabEntries: m, state: n, typed: o, rfidsToCheck: p, loggedAsPresent: q, userid: r, password: s};
																		};
																	};
																};
															};
					...
					return A2(
						_elm_lang$html$Html$option,
						{
							...
							_1: {
								...
								_0: _user$project$DjOps$tagattr(
									function () {
										var _p12 = model.selectedShow;
										if (_p12.ctor === 'Just') {
											return _elm_lang$core$Native_Utils.eq(show.id, _p12._0.id) ? 'selected' : 'dummy';
										} else {
											return 'dummy';
										}
									}()),
...
var _user$project$DjOps$fetchTracksTabData = function (model) {
	var _p13 = {ctor: '_Tuple3', _0: model.member, _1: model.selectedShow, _2: model.selectedShowDate};
	if ((((_p13.ctor === '_Tuple3') && (_p13._0.ctor === 'Just')) && (_p13._1.ctor === 'Just')) && (_p13._2.ctor === 'Just')) {
		var dateFilter = _user$project$XisRestApi$SI_DateEquals(
			_user$project$CalendarDate$fromDate(_p13._2._0));
		var showFilter = _user$project$XisRestApi$SI_ShowEquals(_p13._1._0.id);
		var fetchCmd = A2(
...
var _user$project$DjOps$SaveTracksTabEntry = function (a) {
	return {ctor: 'SaveTracksTabEntry', _0: a};
};
var _user$project$DjOps$RfidTick = {ctor: 'RfidTick'};
var _user$project$DjOps$PasswordInput = function (a) {
	return {ctor: 'PasswordInput', _0: a};
};
var _user$project$DjOps$NowPlaying_Tick = {ctor: 'NowPlaying_Tick'};
...
var _user$project$DjOps$checkAnRfid = function (model) {
	...
	switch (_p14.ctor) {
		...
		case 'FoundRfidToBe':
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		default:
			var _p15 = model.rfidsToCheck;
			if (_p15.ctor === '::') {
				var memberFilters = {
					ctor: '::',
					_0: _user$project$XisRestApi$RfidNumberEquals(_p15._0),
					_1: {ctor: '[]'}
				};
...
var _user$project$DjOps$init = function (flags) {
	var _p16 = _elm_community$elm_datepicker$DatePicker$init;
	var datePicker = _p16._0;
	var datePickerCmd = _p16._1;
	var auth = function () {
		var _p17 = flags.csrfToken;
		if (_p17.ctor === 'Just') {
			return _user$project$DjangoRestFramework$LoggedIn(_p17._0);
		} else {
...
var _user$project$DjOps$tracks_tableRow = F2(
	function (model, r) {
								...
								opts,
								{
									...
									_1: {
										...
										_0: _debois$elm_mdl$Material_Textfield$value(
											_elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$artistColId) ? tte.artist : (_elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$titleColId) ? tte.title : (_elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$durationColId) ? tte.duration : 'ERR1'))),
										_1: {
											ctor: '::',
		...
		var _p18 = A2(_elm_lang$core$Array$get, r, model.tracksTabEntries);
		if (_p18.ctor === 'Just') {
			var _p19 = _p18._0;
			return A2(
				_debois$elm_mdl$Material_Table$tr,
				{
					...
					_0: A2(
						_debois$elm_mdl$Material_Options$css,
						'color',
						_elm_community$maybe_extra$Maybe_Extra$isNothing(_p19.lastChanged) ? 'black' : 'red'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					...
					_1: {
						...
						_0: A4(
							...
							'Artist',
							_p19,
							_user$project$DjOps$artistColId,
							{ctor: '[]'}),
						_1: {
							ctor: '::',
							_0: A4(
								...
								'Title',
								_p19,
								_user$project$DjOps$titleColId,
								{ctor: '[]'}),
							_1: {
								ctor: '::',
								_0: A4(
									...
									'MM:SS',
									_p19,
									_user$project$DjOps$durationColId,
									{
										ctor: '::',
...
var _user$project$DjOps$upsertManualPlayListEntry = F3(
	function (model, row, tte) {
		var _p20 = model.showInstance;
		if (_p20.ctor === 'Just') {
			var mpleData = A5(
				_user$project$XisRestApi$ManualPlayListEntryData,
				model.xis.showInstanceUrl(_p20._0.id),
				row,
				tte.artist,
				tte.title,
				tte.duration);
			...
			if (_p21.ctor === 'Just') {
				return A2(
					...
					A2(_user$project$DjangoRestFramework$Resource, _p21._0, mpleData),
																						...
																						_1: {
																							...
																							_0: function () {
																								if (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.selectedShow) || (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.member) || _elm_community$maybe_extra$Maybe_Extra$isNothing(model.selectedShowDate))) {
																									...
																									var _p22 = model.selectedShowDate;
																									if (_p22.ctor === 'Just') {
																										return (!_elm_lang$core$Native_Utils.eq(
																											_user$project$CalendarDate$fromDate(_p22._0),
...
var _user$project$DjOps$KeyDownRfid = function (a) {
	return {ctor: 'KeyDownRfid', _0: a};
};
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$downs(_user$project$DjOps$KeyDownRfid),
				_1: {
					ctor: '::',
		...
		switch (_p24.ctor) {
			...
			case 'KeyDownRfid':
						...
						default:
							return A2(
								...
								_elm_lang$core$String$fromChar(
									_elm_lang$core$Char$fromCode(_p25)));
					}
				}();
				...
				if (_elm_lang$core$List$isEmpty(finds)) {
					...
					var hexToInt = function (_p26) {
						return _rtfeldman$hex$Hex$fromString(
							_elm_lang$core$String$toLower(_p26));
					};
			...
			case 'Login_Clicked':
				var _p27 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p27.ctor === '_Tuple2') && (_p27._0.ctor === 'Just')) && (_p27._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A3(model.xis.authenticate, _p27._0._0, _p27._1._0, _user$project$DjOps$Authenticate_Result)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p24._0, model);
			case 'NowPlaying_Tick':
				var _p34 = model.nowPlaying;
				if (_p34.ctor === 'Just') {
					var _p37 = _p34._0;
					var _p35 = _p37.track;
					if (_p35.ctor === 'Just') {
						...
						var updatedTrack = _elm_lang$core$Native_Utils.update(
							_p36,
							{remainingSeconds: _p36.remainingSeconds - 1});
			...
			case 'PasswordInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							password: _elm_lang$core$Maybe$Just(_p24._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RfidTick':
				var _p38 = model.state;
				if (_p38.ctor === 'CheckingAnRfid') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$DjOps$CheckingAnRfid(_p38._0 + 1)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'SaveTracksTabEntry':
				var _p42 = _p24._0;
				var _p39 = A2(_elm_lang$core$Array$get, _p42, model.tracksTabEntries);
				if (_p39.ctor === 'Just') {
					var _p41 = _p39._0;
					var _p40 = _p41.lastChanged;
					if (_p40.ctor === 'Just') {
						if ((_elm_lang$core$Native_Utils.cmp(model.currTime - _p40._0, 3 * _elm_lang$core$Time$second) > 0) && (!_p41.saving)) {
							var newTte = _elm_lang$core$Native_Utils.update(
								_p41,
								{saving: true});
							var newTtes = A3(_elm_lang$core$Array$set, _p42, newTte, model.tracksTabEntries);
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{tracksTabEntries: newTtes}),
								_1: A3(_user$project$DjOps$upsertManualPlayListEntry, model, _p42, _p41)
							};
						} else {
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						}
			...
			case 'SetDatePicker':
				var _p43 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p24._0, model.datePicker);
				var newDatePicker = _p43._0;
				var datePickerCmd = _p43._1;
				var dateEvent = _p43._2;
				var _p44 = dateEvent;
				if (_p44.ctor === 'NoChange') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return A3(
						...
						_user$project$DjOps$FetchTracksTabData,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{selectedShowDate: _p44._0, datePicker: newDatePicker}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$DjOps$SetDatePicker, datePickerCmd)
						});
				}
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p24._0._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'ShowWasChosen':
				var _p47 = _p24._0;
				var _p46 = _elm_lang$core$Result$toMaybe(
					_elm_lang$core$String$toInt(_p47));
				if (_p46.ctor === 'Just') {
					var show = A2(
						_elm_community$list_extra$List_Extra$find,
						function (s) {
							return _elm_lang$core$Native_Utils.eq(s.id, _p46._0);
						},
						model.shows);
					return A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
					...
					var dummy = A2(_elm_lang$core$Debug$log, 'Bad Show ID', _p47);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Tick':
				var newModel = _elm_lang$core$Native_Utils.update(
				...
				return A3(
					_ccapndave$elm_update_extra$Update_Extra$andThen,
					_user$project$DjOps$update,
					_user$project$DjOps$NowPlaying_Tick,
					A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
						_user$project$DjOps$update,
						_user$project$DjOps$RfidTick,
			...
			case 'TrackFieldUpdate':
				...
				var tte1 = A2(
					...
					A2(_elm_lang$core$Array$get, _p49, model.tracksTabEntries));
				var tte2 = _elm_lang$core$Native_Utils.update(
					tte1,
					{
						lastChanged: _elm_lang$core$Maybe$Just(model.currTime),
						saving: false
					});
				var tte3 = _elm_lang$core$Native_Utils.eq(_p48, _user$project$DjOps$artistColId) ? _elm_lang$core$Native_Utils.update(
					tte2,
					{artist: _p50}) : (_elm_lang$core$Native_Utils.eq(_p48, _user$project$DjOps$titleColId) ? _elm_lang$core$Native_Utils.update(
					tte2,
					{title: _p50}) : (_elm_lang$core$Native_Utils.eq(_p48, _user$project$DjOps$durationColId) ? _elm_lang$core$Native_Utils.update(
					tte2,
					{duration: _p50}) : tte2));
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						tracksTabEntries: A3(_elm_lang$core$Array$set, _p49, tte3, model.tracksTabEntries)
					});
				return {
					ctor: '_Tuple2',
					_0: newModel,
					_1: A2(
						_user$project$DjOps$delay,
						5 * _elm_lang$core$Time$second,
						_user$project$DjOps$SaveTracksTabEntry(_p49))
				};
			case 'UseridInput':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							userid: _elm_lang$core$Maybe$Just(_p24._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Authenticate_Result':
				if (_p24._0.ctor === 'Ok') {
					var errMsgs = _p24._0._0.isAuthentic ? {ctor: '[]'} : {
						ctor: '::',
					...
					return A3(
						...
						_user$project$DjOps$FetchTracksTabData,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{member: _p24._0._0.authenticatedMember, errMsgs: errMsgs}),
							_1: _elm_lang$core$Platform_Cmd$none
						});
				} else {
					return {
			...
			case 'ManualPlayListEntryUpsert_Result':
				if (_p24._0.ctor === 'Ok') {
					var _p29 = _p24._0._0;
					var _p28 = A2(_elm_lang$core$Array$get, _p29.data.sequence, model.tracksTabEntries);
					if (_p28.ctor === 'Just') {
						var newTte = _elm_lang$core$Native_Utils.update(
							_p28._0,
							{
								lastChanged: _elm_lang$core$Maybe$Nothing,
								saving: false,
								playListEntryId: _elm_lang$core$Maybe$Just(_p29.id)
							});
						var newTtes = A3(_elm_lang$core$Array$set, _p29.data.sequence, newTte, model.tracksTabEntries);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
				...
				if (_p24._0.ctor === 'Ok') {
						...
						if (_p30._1.ctor === '[]') {
							...
							var newModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									...
									rfidsToCheck: {ctor: '[]'},
									typed: '',
									loggedAsPresent: A2(_elm_lang$core$Set$insert, _p31.id, model.loggedAsPresent)
								});
							var cmd2 = A2(_elm_lang$core$Set$member, _p31.id, model.loggedAsPresent) ? _elm_lang$core$Platform_Cmd$none : A2(
								model.xis.createVisitEvent,
								{
									who: model.xis.memberUrl(_p31.id),
									when: model.currTime,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$DjOps$HitAnHttpErr(_p24._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			case 'NowPlaying_Result':
				if (_p24._0.ctor === 'Ok') {
					...
					var delaySeconds = function () {
						var _p32 = _p33.track;
						if (_p32.ctor === 'Just') {
							var rs = _p32._0.remainingSeconds;
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								nowPlaying: _elm_lang$core$Maybe$Just(_p33)
							}),
			...
			default:
				if (_p24._0.ctor === 'Ok') {
					var showInstance = _elm_lang$core$List$head(_p24._0._0.results);
					var tracksForTab = A2(
						_elm_lang$core$Maybe$withDefault,
						{ctor: '[]'},
						A2(
