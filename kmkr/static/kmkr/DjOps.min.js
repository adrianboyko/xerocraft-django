			...
			_1: {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'type',
						_1: _elm_lang$core$Json_Encode$string(bc.theType)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$XisRestApi$encodeBroadcastData = function (_p4) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$broadcastDataNVPs(_p4));
};
var _user$project$XisRestApi$replaceAll = F2(
	function (_p5, whole) {
		...
		return A4(
			_elm_lang$core$Regex$replace,
			_elm_lang$core$Regex$All,
			_elm_lang$core$Regex$regex(_p6.oldSub),
			function (_p7) {
				return _p6.newSub;
			},
			whole);
	...
	switch (_p11.ctor) {
		case 'VEF_WhenGreaterOrEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'when__gte=',
				_user$project$PointInTime$isoString(_p11._0));
		case 'VEF_EventTypeEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'event_type=',
				_user$project$XisRestApi$eventTypeString(_p11._0));
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'method=',
				_user$project$XisRestApi$eventMethodString(_p11._0));
	}
};
...
var _user$project$XisRestApi$encodeVisitEventDataOut = function (_p12) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$visitEventDataNVPs(_p12));
};
...
var _user$project$XisRestApi$encodeVendLogData = function (_p13) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$vendLogDataNVPs(_p13));
};
...
var _user$project$XisRestApi$coverTime = F2(
	function (memberships, now) {
		var _p14 = _user$project$XisRestApi$mostRecentMembership(memberships);
		if (_p14.ctor === 'Nothing') {
			return false;
		} else {
			var _p15 = _p14._0;
			var membershipRange = A2(_user$project$RangeOfTime$fromCalendarDates, _p15.data.startDate, _p15.data.endDate);
...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var bd = block.data;
		var _p17 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
...
var _user$project$XisRestApi$memberFilterToString = function (filter) {
	...
	switch (_p20.ctor) {
		...
		case 'EmailEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__email__iexact=', _p20._0);
		case 'UsernameEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__iexact=', _p20._0);
		case 'UsernameContains':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__icontains=', _p20._0);
		case 'UsernameStartsWith':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__istartswith=', _p20._0);
		case 'LastNameStartsWith':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__last_name__istartswith=', _p20._0);
		case 'LastNameEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__last_name__iexact=', _p20._0);
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
...
var _user$project$XisRestApi$encodePlayData = function (_p21) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$playDataNVPs(_p21));
};
	...
	switch (_p22.ctor) {
		...
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'play_date=',
				_user$project$CalendarDate$toString(_p22._0));
	}
};
...
var _user$project$XisRestApi$encodeWorkNoteData = function (_p23) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$workNoteDataNVPs(_p23));
};
...
var _user$project$XisRestApi$encodeWorkData = function (_p24) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$workDataNVPs(_p24));
};
var _user$project$XisRestApi$workFilterToString = function (filter) {
	var _p25 = filter;
	if (_p25.ctor === 'WorkedClaimEquals') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'claim=',
...
var _user$project$XisRestApi$encodeClaimData = function (_p27) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$claimDataNVPs(_p27));
};
	...
	switch (_p29.ctor) {
		case 'ClaimStatusEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'status=',
				_user$project$XisRestApi$claimStatusValue(_p29._0));
...
var _user$project$XisRestApi$memberHasStatusOnTask = F4(
	function (flags, memberNum, questionedStatus, task) {
		...
		var _p32 = actualStatus;
		if (_p32.ctor === 'Nothing') {
			return false;
		} else {
			return _elm_lang$core$Native_Utils.eq(_p32._0, questionedStatus);
		}
	});
var _user$project$XisRestApi$taskFilterToString = function (filter) {
	...
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'scheduled_date=',
		_user$project$CalendarDate$toString(_p33._0));
};
																																																											...
																																																											return function (_34) {
																																																												return function (_35) {
																																																													return function (_36) {
																																																														return function (_37) {
																																																															return function (_38) {
																																																																return {getMembershipById: a, getPlayByUrl: b, getTaskById: c, getTaskFromUrl: d, getWorkFromUrl: e, createBroadcast: f, createClaim: g, createEpisodeTrack: h, createPlay: i, createEpisode: j, createVendLog: k, createVisitEvent: l, createWork: m, createWorkNote: n, deleteEpisodeTrackById: o, deleteEpisodeTrackByUrl: p, deletePlayById: q, deletePlayByUrl: r, deleteWorkById: s, deleteWorkByUrl: t, listClaims: u, listDiscoveryMethods: v, listEpisodes: w, listMembers: x, listMemberships: y, listPlays: z, listShows: _1, listTasks: _2, listTimeBlocks: _3, listTimeBlockTypes: _4, listVisitEvents: _5, listWorks: _6, moreVisitEvents: _7, replaceClaim: _8, replaceEpisodeTrack: _9, replaceWork: _10, replacePlay: _11, replaceEpisode: _12, broadcastUrl: _13, claimUrl: _14, memberUrl: _15, productUrl: _16, showUrl: _17, episodeUrl: _18, taskUrl: _19, vendLogUrl: _20, visitEventUrl: _21, workUrl: _22, workNoteUrl: _23, authenticate: _24, blockHasType: _25, coverTime: _26, defaultBlockType: _27, emailMembershipInfo: _28, logMessage: _29, getBlocksTypes: _30, memberCanClaimTask: _31, memberHasStatusOnTask: _32, membersClaimOnTask: _33, membersStatusOnTask: _34, membersWithStatusOnTask: _35, mostRecentMembership: _36, nowPlaying: _37, pitInBlock: _38};
																																																															};
																																																														};
																																																													};
																																																												};
...
var _user$project$XisRestApi$decodeWorkNoteData = A3(
	...
	A2(
		...
		function (_p34) {
			return _elm_community$json_extra$Json_Decode_Extra$fromResult(
				_user$project$PointInTime$fromString(_p34));
		},
		_elm_lang$core$Json_Decode$string),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
...
var _user$project$XisRestApi$taskPriorityDecoder = A2(
	...
	function (str) {
		...
		switch (_p35) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown priority: ', _p35));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$staffingStatusDecoder = A2(
	...
	function (str) {
		...
		switch (_p36) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown staffing status: ', _p36));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeClaimStatus = A2(
	...
	function (str) {
		...
		switch (_p37) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown claim status: ', _p37));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeVisitEventMethod = A2(
	...
	function (str) {
		...
		switch (_p38) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown visit event type: ', _p38));
		}
	},
	_elm_lang$core$Json_Decode$string);
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(_user$project$DjOps_ops['=>'], 'overflow-x', 'hidden'),
									_1: {ctor: '[]'}
								}
							}
						}
		...
		while (true) {
			...
			if (_p11.ctor === '[]') {
				...
				var tte = A7(
					...
					_elm_lang$core$Maybe$Just(_p12.id),
					_p12.data.artist,
					_p12.data.title,
					_p12.data.duration,
					_p12.data.artist,
												...
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return {errMsgs: a, keyboardIdleTime: b, mdl: c, xisFlags: d, xis: e, currTime: f, selectedTab: g, shows: h, selectedShow: i, selectedShowDate: j, episode: k, datePicker: l, member: m, nowPlaying: n, tracksTabEntries: o, userid: p, password: q};
																};
															};
														};
													};
...
var _user$project$DjOps$Tick_SaveTracksTab = {ctor: 'Tick_SaveTracksTab'};
var _user$project$DjOps$Tick_NowPlaying = {ctor: 'Tick_NowPlaying'};
var _user$project$DjOps$Tick_Idle = {ctor: 'Tick_Idle'};
					...
					return A2(
						_elm_lang$html$Html$option,
						{
							...
							_1: {
								...
								_0: _user$project$DjOps$tagattr(
									function () {
										var _p13 = model.selectedShow;
										if (_p13.ctor === 'Just') {
											return _elm_lang$core$Native_Utils.eq(show.id, _p13._0.id) ? 'selected' : 'dummy';
										} else {
											return 'dummy';
										}
									}()),
...
var _user$project$DjOps$init = function (flags) {
	var _p14 = _elm_community$elm_datepicker$DatePicker$init;
	var datePicker = _p14._0;
	var datePickerCmd = _p14._1;
	var model = {
		errMsgs: {ctor: '[]'},
		keyboardIdleTime: 0,
...
var _user$project$DjOps$tracks_tableRow = F2(
	function (model, r) {
												...
												_1: {
													...
													_0: A2(
														...
														_elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$DurationColumn) && ((_elm_lang$core$Native_Utils.cmp(
															...
															0) > 0) && function (_p16) {
															return !A2(_elm_lang$core$Regex$contains, mmss, _p16);
														}(tte.duration)),
		...
		var _p17 = A2(_elm_lang$core$Array$get, r, model.tracksTabEntries);
		if (_p17.ctor === 'Just') {
			var _p18 = _p17._0;
			return A2(
				_debois$elm_mdl$Material_Table$tr,
				{
					...
					_0: A2(
						_debois$elm_mdl$Material_Options$css,
						'color',
						_user$project$DjOps$tracksTabEntryIsDirty(_p18) ? 'red' : 'black'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _user$project$DjOps$KeyDown_Idle = function (a) {
	return {ctor: 'KeyDown_Idle', _0: a};
};
...
var _user$project$DjOps$FetchTracksTabData = {ctor: 'FetchTracksTabData'};
...
var _user$project$DjOps$upsertEpisodeTrack = F3(
	function (model, row, tte) {
		var _p19 = model.episode;
		if (_p19.ctor === 'Just') {
			var etData = A5(
				_user$project$XisRestApi$EpisodeTrackData,
				model.xis.episodeUrl(_p19._0.id),
				row,
				tte.artist,
				tte.title,
				tte.duration);
			var _p20 = tte.playListEntryId;
			if (_p20.ctor === 'Just') {
				return A2(
					model.xis.replaceEpisodeTrack,
					A2(_user$project$DjangoRestFramework$Resource, _p20._0, etData),
	...
	function (model, minIdle) {
		var reducer = F2(
			function (_p23, _p22) {
				...
				var _p27 = _p25._0;
				var _p26 = _p25._1;
				if (_user$project$DjOps$tracksTabEntryIsDirty(_p29)) {
					var extraCmd = A2(
						...
						}) ? A3(_user$project$DjOps$deleteEpisodeTrack, _p27, _p28, _p29) : A3(_user$project$DjOps$upsertEpisodeTrack, _p27, _p28, _p29);
					return A2(
		...
		return (_elm_lang$core$Native_Utils.cmp(model.keyboardIdleTime, minIdle) > -1) ? A3(
			_elm_lang$core$List$foldl,
			reducer,
			{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none},
			_elm_lang$core$Array$toIndexedList(model.tracksTabEntries)) : {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$DjOps$EpisodeList_Result = F3(
	function (a, b, c) {
		return {ctor: 'EpisodeList_Result', _0: a, _1: b, _2: c};
	});
var _user$project$DjOps$fetchTracksTabData = function (model) {
	var _p30 = {ctor: '_Tuple2', _0: model.selectedShow, _1: model.selectedShowDate};
	if (((_p30.ctor === '_Tuple2') && (_p30._0.ctor === 'Just')) && (_p30._1.ctor === 'Just')) {
		var _p32 = _p30._1._0;
		var _p31 = _p30._0._0;
		var tagger = A2(_user$project$DjOps$EpisodeList_Result, _p31, _p32);
		var dateFilter = _user$project$XisRestApi$EpisodeDateEquals(
			_user$project$CalendarDate$fromDate(_p32));
		var showFilter = _user$project$XisRestApi$EpisodeShowEquals(_p31.id);
		var fetchCmd = A2(
			model.xis.listEpisodes,
			{
				ctor: '::',
				_0: showFilter,
				_1: {
			...
			tagger);
		return {ctor: '_Tuple2', _0: model, _1: fetchCmd};
	} else {
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	}
};
													...
													_0: A2(
														_elm_lang$html$Html$span,
														{
															...
															_0: _elm_lang$html$Html_Attributes$style(
																{
																	ctor: '::',
																	_0: A2(_user$project$DjOps_ops['=>'], 'color', 'green'),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														},
																						...
																						_1: {
																							...
																							_0: function () {
																								if (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.episode) || _elm_community$maybe_extra$Maybe_Extra$isNothing(model.member)) {
																									...
																									var _p33 = model.selectedShowDate;
																									if (_p33.ctor === 'Just') {
																										return (!_elm_lang$core$Native_Utils.eq(
																											_user$project$CalendarDate$fromDate(_p33._0),
	...
	function (action, model) {
		...
		switch (_p35.ctor) {
			...
			case 'BeginBroadcast_Clicked':
				var _p36 = model.episode;
				if (_p36.ctor === 'Just') {
					var bcData = {
						episode: model.xis.episodeUrl(_p36._0.id),
			...
			case 'FetchTracksTabData':
				return _user$project$DjOps$fetchTracksTabData(model);
			case 'KeyDown':
				return A3(
					_ccapndave$elm_update_extra$Update_Extra$andThen,
					_user$project$DjOps$update,
					_user$project$DjOps$KeyDown_Idle(_p35._0),
					{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
			case 'KeyDown_Idle':
				return {
					ctor: '_Tuple2',
			...
			case 'Login_Clicked':
				var _p37 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p37.ctor === '_Tuple2') && (_p37._0.ctor === 'Just')) && (_p37._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A3(model.xis.authenticate, _p37._0._0, _p37._1._0, _user$project$DjOps$Authenticate_Result)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p35._0, model);
			case 'PasswordInput':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							password: _elm_lang$core$Maybe$Just(_p35._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SelectTab':
				return A2(
					...
					0);
			case 'SetDatePicker':
				var _p42 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p35._0, model.datePicker);
				var newDatePicker = _p42._0;
				var datePickerCmd = _p42._1;
				var dateEvent = _p42._2;
				var _p43 = dateEvent;
				if (_p43.ctor === 'NoChange') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
						_user$project$DjOps$update,
						_user$project$DjOps$FetchTracksTabData,
						{
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{selectedShowDate: _p43._0, datePicker: newDatePicker}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$DjOps$SetDatePicker, datePickerCmd)
						});
				}
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p35._0._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'ShowWasChosen':
				var _p51 = _p35._0;
				var _p50 = _elm_lang$core$Result$toMaybe(
					_elm_lang$core$String$toInt(_p51));
				if (_p50.ctor === 'Just') {
					var show = A2(
						_elm_community$list_extra$List_Extra$find,
						function (s) {
							return _elm_lang$core$Native_Utils.eq(s.id, _p50._0);
						},
						model.shows);
					return A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
					...
					var dummy = A2(_elm_lang$core$Debug$log, 'Couldn\'t convert to Int', _p51);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Tick':
				return A3(
					_ccapndave$elm_update_extra$Update_Extra$andThen,
					_user$project$DjOps$update,
					_user$project$DjOps$Tick_SaveTracksTab,
					A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
						_user$project$DjOps$update,
			...
			case 'Tick_Idle':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{keyboardIdleTime: model.keyboardIdleTime + 1}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Tick_NowPlaying':
				var _p52 = model.nowPlaying;
				if (_p52.ctor === 'Just') {
					var _p55 = _p52._0;
					var _p53 = _p55.track;
					if (_p53.ctor === 'Just') {
						...
						var updatedTrack = _elm_lang$core$Native_Utils.update(
							_p54,
							{remainingSeconds: _p54.remainingSeconds - 1});
			...
			case 'Tick_SaveTracksTab':
				return A2(_user$project$DjOps$saveTracksTab, model, 5);
			case 'TrackFieldUpdate':
				...
				var tte1 = A2(
					...
					A2(_elm_lang$core$Array$get, _p57, model.tracksTabEntries));
				var tte2 = function () {
					var _p56 = _p35._1;
					switch (_p56.ctor) {
						case 'ArtistColumn':
						...
						default:
							return _elm_lang$core$Native_Utils.update(
								tte1,
								{
									duration: _user$project$DjOps$mmss_mask(_p58)
								});
					}
				}();
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						tracksTabEntries: A3(_elm_lang$core$Array$set, _p57, tte2, model.tracksTabEntries)
					});
			...
			case 'UseridInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							userid: _elm_lang$core$Maybe$Just(_p35._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Authenticate_Result':
				if (_p35._0.ctor === 'Ok') {
					if (_p35._0._0.isAuthentic) {
						...
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								member: _p35._0._0.authenticatedMember,
								xis: A2(
			...
			case 'EpisodeTrackDelete_Result':
				if (_p35._1.ctor === 'Ok') {
					var newTtes = A3(_elm_lang$core$Array$set, _p35._0, _user$project$DjOps$blankTracksTabEntry, model.tracksTabEntries);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p35._1._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'EpisodeTrackUpsert_Result':
				if (_p35._0.ctor === 'Ok') {
					var _p39 = _p35._0._0;
					var _p38 = A2(_elm_lang$core$Array$get, _p39.data.sequence, model.tracksTabEntries);
					if (_p38.ctor === 'Just') {
						var newTte = _elm_lang$core$Native_Utils.update(
							_p38._0,
							{
								playListEntryId: _elm_lang$core$Maybe$Just(_p39.id),
								savedArtist: _p39.data.artist,
								savedTitle: _p39.data.title,
								savedDuration: _p39.data.duration
							});
						var newTtes = A3(_elm_lang$core$Array$set, _p39.data.sequence, newTte, model.tracksTabEntries);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
						...
						var dummy = A2(_elm_lang$core$Debug$log, 'Couldn\'t find row for', _p39);
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				} else {
					return {
			...
			case 'NowPlaying_Result':
				if (_p35._0.ctor === 'Ok') {
					...
					var delaySeconds = function () {
						var _p40 = _p41.track;
						if (_p40.ctor === 'Just') {
							var rs = _p40._0.remainingSeconds;
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								nowPlaying: _elm_lang$core$Maybe$Just(_p41)
							}),
					...
					var dummy = A2(
						_elm_lang$core$Debug$log,
						'NowPlaying_Result',
						_elm_lang$core$Basics$toString(_p35._0._0));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
			...
			case 'EpisodeCreate_Result':
				if (_p35._2.ctor === 'Ok') {
					...
					var msg = A3(
						...
						_p35._1,
						_elm_lang$core$Result$Ok(
							_user$project$DjangoRestFramework$singletonPageOf(_p44)));
					return A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
						_user$project$DjOps$update,
						msg,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									episode: _elm_lang$core$Maybe$Just(_p44)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						});
				} else {
					var dummy = A2(
						...
						_elm_lang$core$Basics$toString(_p35._2._0));
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			default:
				if (_p35._2.ctor === 'Ok') {
					var _p49 = _p35._1;
					var _p48 = _p35._0;
					var _p47 = _p35._2._0.results;
					var _p46 = _p35._2._0.count;
					if (_elm_lang$core$Native_Utils.eq(_p46, 1)) {
						var episode = _elm_lang$core$List$head(_p47);
						var tracksForTab = A2(
							_elm_lang$core$Maybe$withDefault,
							{ctor: '[]'},
							A2(
						...
						if (_elm_lang$core$Native_Utils.eq(_p46, 0)) {
							var tagger = A2(_user$project$DjOps$EpisodeCreate_Result, _p48, _p49);
							var selShowUrl = model.xis.showUrl(_p48.id);
							var epData = A4(
								_user$project$XisRestApi$EpisodeData,
								selShowUrl,
								_user$project$CalendarDate$fromDate(_p49),
								'',
								{ctor: '[]'});
							var createCmd = A2(model.xis.createEpisode, epData, tagger);
							return {ctor: '_Tuple2', _0: model, _1: createCmd};
						} else {
							var dummy = A2(_elm_lang$core$Debug$log, '>1 Episode', _p47);
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						}
					}
				} else {
