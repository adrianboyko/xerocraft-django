																																																			...
																																																			return function (_26) {
																																																				return function (_27) {
																																																					return function (_28) {
																																																						return function (_29) {
																																																							return function (_30) {
																																																								return {getMembershipById: a, getPlayByUrl: b, getTaskById: c, getTaskFromUrl: d, getWorkFromUrl: e, createClaim: f, createManualPlayListEntry: g, createPlay: h, createVendLog: i, createVisitEvent: j, createWork: k, createWorkNote: l, deletePlayById: m, deletePlayByUrl: n, deleteWorkById: o, deleteWorkByUrl: p, listClaims: q, listDiscoveryMethods: r, listMembers: s, listMemberships: t, listPlays: u, listShows: v, listShowInstances: w, listTasks: x, listTimeBlocks: y, listTimeBlockTypes: z, listVisitEvents: _1, listWorks: _2, moreVisitEvents: _3, replaceClaim: _4, replaceWork: _5, replacePlay: _6, claimUrl: _7, memberUrl: _8, productUrl: _9, showUrl: _10, taskUrl: _11, vendLogUrl: _12, visitEventUrl: _13, workUrl: _14, workNoteUrl: _15, authenticate: _16, blockHasType: _17, coverTime: _18, defaultBlockType: _19, emailMembershipInfo: _20, logMessage: _21, getBlocksTypes: _22, memberCanClaimTask: _23, memberHasStatusOnTask: _24, membersClaimOnTask: _25, membersStatusOnTask: _26, membersWithStatusOnTask: _27, mostRecentMembership: _28, nowPlaying: _29, pitInBlock: _30};
																																																							};
																																																						};
																																																					};
																																																				};
...
var _user$project$DjOps$TracksTabEntry = F5(
	function (a, b, c, d, e) {
		return {lastChanged: a, playListEntryId: b, artist: c, title: d, duration: e};
	});
var _user$project$DjOps$newTracksTabEntry = F4(
	function (id, artist, title, duration) {
		return A5(_user$project$DjOps$TracksTabEntry, _elm_lang$core$Maybe$Nothing, id, artist, title, duration);
	});
var _user$project$DjOps$blankTracksTabEntry = A4(_user$project$DjOps$newTracksTabEntry, _elm_lang$core$Maybe$Nothing, '', '', '');
									...
									_1: {
										...
										_0: _debois$elm_mdl$Material_Textfield$value(
											function () {
												...
												if (_p18.ctor === 'Just') {
													var _p19 = _p18._0;
													return _elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$artistColId) ? _p19.artist : (_elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$titleColId) ? _p19.title : (_elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$durationColId) ? _p19.duration : 'ERR1'));
												} else {
													return 'ERR2';
												}
											}()),
																						...
																						_1: {
																							...
																							_0: function () {
																								if (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.selectedShow) || (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.member) || _elm_community$maybe_extra$Maybe_Extra$isNothing(model.selectedShowDate))) {
																									...
																									var _p20 = model.selectedShowDate;
																									if (_p20.ctor === 'Just') {
																										return (!_elm_lang$core$Native_Utils.eq(
																											_user$project$CalendarDate$fromDate(_p20._0),
		...
		switch (_p22.ctor) {
			...
			case 'KeyDownRfid':
						...
						default:
							return A2(
								...
								_elm_lang$core$String$fromChar(
									_elm_lang$core$Char$fromCode(_p23)));
					}
				}();
				...
				if (_elm_lang$core$List$isEmpty(finds)) {
					...
					var hexToInt = function (_p24) {
						return _rtfeldman$hex$Hex$fromString(
							_elm_lang$core$String$toLower(_p24));
					};
			...
			case 'Login_Clicked':
				var _p25 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p25.ctor === '_Tuple2') && (_p25._0.ctor === 'Just')) && (_p25._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A3(model.xis.authenticate, _p25._0._0, _p25._1._0, _user$project$DjOps$Authenticate_Result)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p22._0, model);
			case 'NowPlaying_Tick':
				var _p30 = model.nowPlaying;
				if (_p30.ctor === 'Just') {
					var _p33 = _p30._0;
					var _p31 = _p33.track;
					if (_p31.ctor === 'Just') {
						...
						var updatedTrack = _elm_lang$core$Native_Utils.update(
							_p32,
							{remainingSeconds: _p32.remainingSeconds - 1});
			...
			case 'PasswordInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							password: _elm_lang$core$Maybe$Just(_p22._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RfidTick':
				var _p34 = model.state;
				if (_p34.ctor === 'CheckingAnRfid') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$DjOps$CheckingAnRfid(_p34._0 + 1)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'SetDatePicker':
				var _p35 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p22._0, model.datePicker);
				var newDatePicker = _p35._0;
				var datePickerCmd = _p35._1;
				var dateEvent = _p35._2;
				var _p36 = dateEvent;
				if (_p36.ctor === 'NoChange') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return A3(
						...
						_user$project$DjOps$FetchTracksTabData,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{selectedShowDate: _p36._0, datePicker: newDatePicker}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$DjOps$SetDatePicker, datePickerCmd)
						});
				}
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p22._0._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'ShowWasChosen':
				var _p39 = _p22._0;
				var _p38 = _elm_lang$core$Result$toMaybe(
					_elm_lang$core$String$toInt(_p39));
				if (_p38.ctor === 'Just') {
					var show = A2(
						_elm_community$list_extra$List_Extra$find,
						function (s) {
							return _elm_lang$core$Native_Utils.eq(s.id, _p38._0);
						},
						model.shows);
					return A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
					...
					var dummy = A2(_elm_lang$core$Debug$log, 'Bad Show ID', _p39);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Tick':
				var newModel = _elm_lang$core$Native_Utils.update(
			...
			case 'TrackFieldUpdate':
				...
				var tte = A2(
					...
					A2(_elm_lang$core$Array$get, _p41, model.tracksTabEntries));
				var tteUpdated = _elm_lang$core$Native_Utils.eq(_p40, _user$project$DjOps$artistColId) ? _elm_lang$core$Native_Utils.update(
					tte,
					{artist: _p42}) : (_elm_lang$core$Native_Utils.eq(_p40, _user$project$DjOps$titleColId) ? _elm_lang$core$Native_Utils.update(
					tte,
					{title: _p42}) : (_elm_lang$core$Native_Utils.eq(_p40, _user$project$DjOps$durationColId) ? _elm_lang$core$Native_Utils.update(
					tte,
					{duration: _p42}) : tte));
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						tracksTabEntries: A3(_elm_lang$core$Array$set, _p41, tteUpdated, model.tracksTabEntries)
					});
			...
			case 'UseridInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							userid: _elm_lang$core$Maybe$Just(_p22._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Authenticate_Result':
				if (_p22._0.ctor === 'Ok') {
					var errMsgs = _p22._0._0.isAuthentic ? {ctor: '[]'} : {
						ctor: '::',
					...
					return A3(
						...
						_user$project$DjOps$FetchTracksTabData,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{member: _p22._0._0.authenticatedMember, errMsgs: errMsgs}),
							_1: _elm_lang$core$Platform_Cmd$none
						});
				} else {
					return {
				...
				if (_p22._0.ctor === 'Ok') {
						...
						if (_p26._1.ctor === '[]') {
							...
							var newModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									...
									rfidsToCheck: {ctor: '[]'},
									typed: '',
									loggedAsPresent: A2(_elm_lang$core$Set$insert, _p27.id, model.loggedAsPresent)
								});
							var cmd2 = A2(_elm_lang$core$Set$member, _p27.id, model.loggedAsPresent) ? _elm_lang$core$Platform_Cmd$none : A2(
								model.xis.createVisitEvent,
								{
									who: model.xis.memberUrl(_p27.id),
									when: model.currTime,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$DjOps$HitAnHttpErr(_p22._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			case 'NowPlaying_Result':
				if (_p22._0.ctor === 'Ok') {
					...
					var delaySeconds = function () {
						var _p28 = _p29.track;
						if (_p28.ctor === 'Just') {
							var rs = _p28._0.remainingSeconds;
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								nowPlaying: _elm_lang$core$Maybe$Just(_p29)
							}),
			...
			default:
				if (_p22._0.ctor === 'Ok') {
					var showInstance = _elm_lang$core$List$head(_p22._0._0.results);
					var tracksForTab = A2(
						_elm_lang$core$Maybe$withDefault,
						{ctor: '[]'},
						A2(
