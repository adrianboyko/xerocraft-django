...
var _user$project$DjOps$BatchEntry_Process = {ctor: 'BatchEntry_Process'};
			...
			_0: A5(
				...
				model.mdl,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _debois$elm_mdl$Material_Options$onClick(_user$project$DjOps$BatchEntry_Process),
							_1: {ctor: '[]'}
						}
					}
				},
...
var _user$project$DjOps$track_entry_textarea = function (model) {
	return A2(
		_elm_lang$html$Html$textarea,
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'placeholder', 'Artist Name\nTrack Title\nMM:SS\n\nArtist Name\nTrack Title\nMM:SS\n\n'),
				_1: {
					ctor: '::',
		...
		A2(
			...
			A2(
				_elm_lang$core$List$filter,
				function (_p63) {
					return !_user$project$DjOps$tracksTabEntryIsEmpty(_p63);
				},
...
var _user$project$DjOps$tracks_info = function (model) {
	...
	return A2(
		...
		function () {
			var _p64 = {ctor: '_Tuple2', _0: model.selectedShow, _1: model.selectedShowDate};
			if (((_p64.ctor === '_Tuple2') && (_p64._0.ctor === 'Just')) && (_p64._1.ctor === 'Just')) {
				return {
					ctor: '::',
					_0: para(
						{
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(_p64._0._0.data.title),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											...
											_1: {
												...
												_0: _elm_lang$html$Html$text(
													A2(
														...
														'%a %b %ddd',
														_user$project$CalendarDate$fromDate(_p64._1._0))),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html$text('.'),
													_1: {ctor: '[]'}
				...
				return {
					...
					_0: para(
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('You must first specify an episode on the START tab.'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				};
		...
		switch (_p67.ctor) {
			...
			case 'BatchEntry_Closed':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{showBatchEntryDialog: false, batchEntryText: _elm_lang$core$Maybe$Nothing}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'BatchEntry_Input':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							batchEntryText: _elm_lang$core$Maybe$Just(_p67._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'BatchEntry_Process':
			...
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p67._0, model);
			case 'PasswordInput':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							password: _elm_lang$core$Maybe$Just(_p67._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'PlayTrack_Clicked':
				...
				if (_p85.ctor === 'Just') {
					var callback = A2(_user$project$DjOps$TrackBroadastCreate_Result, _p67._0, _p86);
			...
			case 'SetDatePicker':
				var _p87 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p67._0, model.datePicker);
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p67._0._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'UseridInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							userid: _elm_lang$core$Maybe$Just(_p67._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Authenticate_Result':
				if (_p67._0.ctor === 'Ok') {
					if (_p67._0._0.isAuthentic) {
						...
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								member: _p67._0._0.authenticatedMember,
								xis: A2(
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p67._1._0),
									_1: {ctor: '[]'}
								},
								tracksTabEntriesChanging: A2(_elm_lang$core$Set$remove, _p67._0, model.tracksTabEntriesChanging)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'EpisodeTrackUpsert_Result':
				if (_p67._1.ctor === 'Ok') {
					...
					if (_p79.ctor === 'Just') {
						var newTtesChanging = A2(_elm_lang$core$Set$remove, _p67._0, model.tracksTabEntriesChanging);
			...
			case 'NowPlaying_Result':
				if (_p67._0.ctor === 'Ok') {
					...
					var dummy = A2(
						_elm_lang$core$Debug$log,
						'NowPlaying_Result',
						_elm_lang$core$Basics$toString(_p67._0._0));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
				...
				if (_p67._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								broadcast: _elm_lang$core$Maybe$Just(_p67._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'EpisodeCreate_Result':
				if (_p67._2.ctor === 'Ok') {
					...
					var dummy = A2(
						...
						_elm_lang$core$Basics$toString(_p67._2._0));
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'EpisodeList_Result':
				if (_p67._2.ctor === 'Ok') {
					var _p77 = _p67._1;
					var _p76 = _p67._0;
					var _p75 = _p67._2._0.results;
					var _p74 = _p67._2._0.count;
			...
			default:
				if (_p67._2.ctor === 'Ok') {
					var trackBroadcastUrl = model.xis.trackBroadcastUrl(_p67._2._0.id);
					var newTte = _elm_lang$core$Native_Utils.update(
						_p67._1,
						{
							trackBroadcast: _elm_lang$core$Maybe$Just(trackBroadcastUrl)
						});
					var newTtes = A3(_elm_lang$core$Array$set, _p67._0, newTte, model.tracksTabEntries);
					return A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
						_user$project$DjOps$update,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p67._2._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
