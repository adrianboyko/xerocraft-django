...
var _user$project$DjOps$layout_header_right = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'width', '30%'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Show Starts in 00:33:34'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$DjOps$layout_header_center = function (model) {
	var children = F2(
	...
	return A2(
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					...
					_1: {
						ctor: '::',
						_0: A2(_user$project$DjOps_ops['=>'], 'font-size', 'smaller'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
		...
		function () {
			...
			if (_p2.ctor === 'Just') {
				var _p3 = {ctor: '_Tuple2', _0: _p2._0.show, _1: _p2._0.track};
				if ((_p3._0.ctor === 'Nothing') && (_p3._1.ctor === 'Just')) {
					var _p4 = _p3._1._0;
					return A2(children, _p4.title, _p4.artist);
				} else {
					return {
						ctor: '::',
...
var _user$project$DjOps$layout_header_left = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_user$project$DjOps_ops['=>'], 'width', '10%'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		...
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$DjOps$layout_header_left(model),
						_1: {
							ctor: '::',
							_0: _debois$elm_mdl$Material_Layout$spacer,
							_1: {
								ctor: '::',
								_0: _user$project$DjOps$layout_header_center(model),
								_1: {
									ctor: '::',
									_0: _debois$elm_mdl$Material_Layout$spacer,
									_1: {
										ctor: '::',
										_0: _user$project$DjOps$layout_header_right(model),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$DjOps$tick = F2(
	function (time, model) {
		var _p5 = model.state;
		if (_p5.ctor === 'CheckingAnRfid') {
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						state: _user$project$DjOps$CheckingAnRfid(_p5._0 + 1)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
					...
					return A2(
						_elm_lang$html$Html$option,
						{
							...
							_1: {
								...
								_0: _user$project$DjOps$tagattr(
									function () {
										var _p6 = model.chosenShowsId;
										if (_p6.ctor === 'Just') {
											return _elm_lang$core$Native_Utils.eq(show.id, _p6._0) ? 'selected' : 'dummy';
										} else {
											return 'dummy';
										}
									}()),
...
var _user$project$DjOps$checkAnRfid = function (model) {
	...
	switch (_p7.ctor) {
		...
		case 'FoundRfidToBe':
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		default:
			var _p8 = model.rfidsToCheck;
			if (_p8.ctor === '::') {
				var memberFilters = {
					ctor: '::',
					_0: _user$project$XisRestApi$RfidNumberEquals(_p8._0),
					_1: {ctor: '[]'}
				};
...
var _user$project$DjOps$init = function (flags) {
	...
	var datePickerCmd = _p9._1;
	var auth = function () {
		var _p10 = flags.csrfToken;
		if (_p10.ctor === 'Just') {
			return _user$project$DjangoRestFramework$LoggedIn(_p10._0);
		} else {
...
var _user$project$DjOps$update = F2(
	function (action, model) {
		...
		switch (_p12.ctor) {
			...
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p12._0, model);
			case 'SelectTab':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'Tick':
				...
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{currTime: _p13});
				var seconds = (_elm_lang$core$Basics$round(_p13) / 1000) | 0;
			...
			case 'UseridInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							userid: _elm_lang$core$Maybe$Just(_p12._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'PasswordInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							password: _elm_lang$core$Maybe$Just(_p12._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p12._0._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'SetDatePicker':
				var _p14 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p12._0, model.datePicker);
				var newDatePicker = _p14._0;
				var datePickerCmd = _p14._1;
				var dateEvent = _p14._2;
				var date = function () {
					var _p15 = dateEvent;
					if (_p15.ctor === 'NoChange') {
			...
			case 'KeyDownAuthenticate':
				var _p16 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p16.ctor === '_Tuple2') && (_p16._0.ctor === 'Just')) && (_p16._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _elm_lang$core$Native_Utils.eq(_p12._0, 13) ? A3(model.xis.authenticate, _p16._0._0, _p16._1._0, _user$project$DjOps$Authenticate_Result) : _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Authenticate_Result':
				if (_p12._0.ctor === 'Ok') {
					var errMsgs = _p12._0._0.isAuthentic ? {ctor: '[]'} : {
						ctor: '::',
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{member: _p12._0._0.authenticatedMember, errMsgs: errMsgs}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
				...
				if (_p12._0.ctor === 'Ok') {
						...
						if (_p19._1.ctor === '[]') {
							...
							var newModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									...
									rfidsToCheck: {ctor: '[]'},
									typed: '',
									loggedAsPresent: A2(_elm_lang$core$Set$insert, _p20.id, model.loggedAsPresent)
								});
							var cmd2 = A2(_elm_lang$core$Set$member, _p20.id, model.loggedAsPresent) ? _elm_lang$core$Platform_Cmd$none : A2(
								model.xis.createVisitEvent,
								{
									who: model.xis.memberUrl(_p20.id),
									when: model.currTime,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$DjOps$HitAnHttpErr(_p12._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			default:
				if (_p12._0.ctor === 'Ok') {
					...
					var delaySeconds = function () {
						var _p21 = _p22.track;
						if (_p21.ctor === 'Just') {
							var rs = _p21._0.remainingSeconds;
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								nowPlaying: _elm_lang$core$Maybe$Just(_p22)
							}),
