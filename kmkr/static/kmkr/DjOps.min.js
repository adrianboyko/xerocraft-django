...
var _user$project$DjOps$tracksTabEntryColumnIsDirty = F2(
	function (tte, col) {
		...
		switch (_p18.ctor) {
			case 'ArtistColumn':
				return !_elm_lang$core$Native_Utils.eq(tte.artist, tte.savedArtist);
			case 'TitleColumn':
				return !_elm_lang$core$Native_Utils.eq(tte.title, tte.savedTitle);
			default:
				return !_elm_lang$core$Native_Utils.eq(tte.duration, tte.savedDuration);
		}
	});
var _user$project$DjOps$tracksTabEntryIsDirty = function (tte) {
	var saved = {ctor: '_Tuple4', _0: tte.savedArtist, _1: tte.savedTitle, _2: tte.savedDuration, _3: tte.savedTrackBroadcast};
	var curr = {ctor: '_Tuple4', _0: tte.artist, _1: tte.title, _2: tte.duration, _3: tte.trackBroadcast};
															...
															return function (p) {
																return function (q) {
																	return function (r) {
																		return function (s) {
																			return function (t) {
																				return {errMsgs: a, keyboardIdleTime: b, mdl: c, xisFlags: d, xis: e, currTime: f, selectedTab: g, shows: h, selectedShow: i, selectedShowDate: j, episode: k, broadcast: l, datePicker: m, member: n, nowPlaying: o, showBatchEntryDialog: p, batchEntryText: q, tracksTabEntries: r, userid: s, password: t};
																			};
																		};
																	};
																};
...
var _user$project$DjOps$EpisodeTrackUpsert_Result = function (a) {
	return {ctor: 'EpisodeTrackUpsert_Result', _0: a};
};
		...
		if (_p31.ctor === 'Just') {
			...
			if (_p32.ctor === 'Just') {
				return A2(
					...
					_user$project$DjOps$EpisodeTrackUpsert_Result);
			} else {
				return A2(model.xis.createEpisodeTrack, etData, _user$project$DjOps$EpisodeTrackUpsert_Result);
			}
		} else {
			var dummy = A2(
	...
	function (minIdle, _p34) {
		...
		var reducer = F2(
			function (_p37, _p36) {
				...
				var _p41 = _p39._0;
				var _p40 = _p39._1;
				if (_user$project$DjOps$tracksTabEntryIsDirty(_p43)) {
					var extraCmd = A2(
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					...
					_1: {
						ctor: '::',
						_0: A2(_user$project$DjOps_ops['=>'], 'zoom', '1.3'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$DjOps$update = F2(
	function (action, model) {
		...
		switch (_p67.ctor) {
			...
			case 'Login_Clicked':
				var _p80 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p80.ctor === '_Tuple2') && (_p80._0.ctor === 'Just')) && (_p80._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A3(model.xis.authenticate, _p80._0._0, _p80._1._0, _user$project$DjOps$Authenticate_Result)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			...
			case 'PlayTrack_Clicked':
				var _p85 = _p67._1;
				var _p84 = _p85.episodeTrackId;
				if (_p84.ctor === 'Just') {
					var callback = A2(_user$project$DjOps$TrackBroadastCreate_Result, _p67._0, _p85);
					var trackBroadcastData = {
						...
						nonLibraryTrack: _elm_lang$core$Maybe$Just(
							model.xis.episodeTrackUrl(_p84._0)),
					...
					var dummy = A2(_elm_lang$core$Debug$log, 'EpisodeTrackId is Nothing: ', _p85);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'SelectTab':
				return A2(
			...
			case 'SetDatePicker':
				var _p86 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p67._0, model.datePicker);
				var newDatePicker = _p86._0;
				var datePickerCmd = _p86._1;
				var dateEvent = _p86._2;
				var _p87 = dateEvent;
				if (_p87.ctor === 'NoChange') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return _user$project$DjOps$fetchTracksTabData(
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{selectedShowDate: _p87._0, datePicker: newDatePicker}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$DjOps$SetDatePicker, datePickerCmd)
						});
				}
			...
			case 'ShowWasChosen':
				var _p89 = _p67._0;
				var _p88 = _elm_lang$core$Result$toMaybe(
					_elm_lang$core$String$toInt(_p89));
				if (_p88.ctor === 'Just') {
					var show = A2(
						_elm_community$list_extra$List_Extra$find,
						function (s) {
							return _elm_lang$core$Native_Utils.eq(s.id, _p88._0);
						},
						model.shows);
					return _user$project$DjOps$fetchTracksTabData(
						{
					...
					var dummy = A2(_elm_lang$core$Debug$log, 'Couldn\'t convert to Int', _p89);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Tick':
			...
			case 'TrackFieldUpdate':
				...
				var tte1 = A2(
					...
					A2(_elm_lang$core$Array$get, _p91, model.tracksTabEntries));
				var tte2 = function () {
					var _p90 = _p67._1;
					switch (_p90.ctor) {
						case 'ArtistColumn':
						...
						default:
							return _elm_lang$core$Native_Utils.update(
								tte1,
								{
									duration: _user$project$DjOps$mmss_mask(_p92)
								});
					}
				}();
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						tracksTabEntries: A3(_elm_lang$core$Array$set, _p91, tte2, model.tracksTabEntries)
					});
			...
			case 'EpisodeTrackDelete_Result':
				if (_p67._1.ctor === 'Ok') {
					var newTtes = A3(_elm_lang$core$Array$set, _p67._0, _user$project$DjOps$blankTracksTabEntry, model.tracksTabEntries);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
			...
			case 'EpisodeTrackUpsert_Result':
				if (_p67._0.ctor === 'Ok') {
					var _p79 = _p67._0._0;
					var _p78 = A2(_elm_lang$core$Array$get, _p79.data.sequence, model.tracksTabEntries);
					if (_p78.ctor === 'Just') {
						var newTte = _elm_lang$core$Native_Utils.update(
							_p78._0,
							{
								episodeTrackId: _elm_lang$core$Maybe$Just(_p79.id),
								savedArtist: _p79.data.artist,
								savedTitle: _p79.data.title,
								savedDuration: _p79.data.duration,
								savedTrackBroadcast: _p79.data.trackBroadcast
							});
						var newTtes = A3(_elm_lang$core$Array$set, _p79.data.sequence, newTte, model.tracksTabEntries);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
						...
						var dummy = A2(_elm_lang$core$Debug$log, 'Couldn\'t find row for', _p79);
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				} else {
					return {
			...
			case 'NowPlaying_Result':
				if (_p67._0.ctor === 'Ok') {
					...
					if (_p81.ctor === 'Just') {
						...
						var modifiedNP = A2(
							_user$project$XisRestApi$NowPlaying,
							((!_elm_lang$core$Native_Utils.eq(mShow, show)) || (!_elm_lang$core$Native_Utils.eq(mHost, host))) ? _p83.show : _p82.show,
							((!_elm_lang$core$Native_Utils.eq(mTitle, title)) || (!_elm_lang$core$Native_Utils.eq(mArtist, artist))) ? _p83.track : _p82.track);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									nowPlaying: _elm_lang$core$Maybe$Just(_p83)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
