...
var _user$project$DjOps$layout_header_col_trackInfo = function (model) {
	...
	var blankInfo = {
		ctor: '::',
		_0: A2(_user$project$DjOps$timeRemaining, '--', '--'),
		_1: {
			ctor: '::',
			_0: A4(_user$project$DjOps$stackedPair, titleLabel, '...', artistLabel, '...'),
			_1: {ctor: '[]'}
		}
	};
	return A2(
...
var _user$project$DjOps$layout_header_col_showInfo = function (model) {
	...
	var blankInfo = {
		...
		_1: {
			ctor: '::',
			_0: A4(_user$project$DjOps$stackedPair, showLabel, '...', hostLabel, '...'),
			_1: {ctor: '[]'}
		}
	};
	return A2(
