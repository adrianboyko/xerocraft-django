...
var _user$project$XisRestApi$replaceAll = F2(
	function (_p3, whole) {
		...
		return A4(
			_elm_lang$core$Regex$replace,
			_elm_lang$core$Regex$All,
			_elm_lang$core$Regex$regex(_p4.oldSub),
			function (_p5) {
				return _p4.newSub;
			},
			whole);
	...
	switch (_p10.ctor) {
		case 'VEF_WhenGreaterOrEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'when__gte=',
				_user$project$PointInTime$isoString(_p10._0));
		case 'VEF_EventTypeEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'event_type=',
				_user$project$XisRestApi$eventTypeString(_p10._0));
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'method=',
				_user$project$XisRestApi$eventMethodString(_p10._0));
	}
};
...
var _user$project$XisRestApi$coverTime = F2(
	function (memberships, now) {
		var _p11 = _user$project$XisRestApi$mostRecentMembership(memberships);
		if (_p11.ctor === 'Nothing') {
			return false;
		} else {
			var _p12 = _p11._0;
			var membershipRange = A2(_user$project$RangeOfTime$fromCalendarDates, _p12.data.startDate, _p12.data.endDate);
...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var bd = block.data;
		var _p14 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
				start: {line: 1213, column: 25},
				end: {line: 1213, column: 36}
...
var _user$project$XisRestApi$memberFilterToString = function (filter) {
	...
	switch (_p17.ctor) {
		...
		case 'EmailEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__email__iexact=', _p17._0);
		case 'UsernameEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__iexact=', _p17._0);
		case 'UsernameContains':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__icontains=', _p17._0);
		case 'UsernameStartsWith':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__istartswith=', _p17._0);
		case 'LastNameStartsWith':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__last_name__istartswith=', _p17._0);
		case 'LastNameEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__last_name__iexact=', _p17._0);
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
...
var _user$project$XisRestApi$encodePlayData = function (_p18) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$playDataNVPs(_p18));
};
	...
	switch (_p19.ctor) {
		...
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'play_date=',
				_user$project$CalendarDate$toString(_p19._0));
	}
};
...
var _user$project$XisRestApi$encodeWorkData = function (_p20) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$workDataNVPs(_p20));
};
...
var _user$project$XisRestApi$workFilterToString = function (filter) {
	var _p21 = filter;
	if (_p21.ctor === 'WorkedClaimEquals') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'claim=',
...
var _user$project$XisRestApi$encodeClaimData = function (_p23) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$claimDataNVPs(_p23));
};
	...
	switch (_p25.ctor) {
		case 'ClaimStatusEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'status=',
				_user$project$XisRestApi$claimStatusValue(_p25._0));
...
var _user$project$XisRestApi$memberHasStatusOnTask = F4(
	function (flags, memberNum, questionedStatus, task) {
		...
		var _p28 = actualStatus;
		if (_p28.ctor === 'Nothing') {
			return false;
		} else {
			return _elm_lang$core$Native_Utils.eq(_p28._0, questionedStatus);
		}
	});
var _user$project$XisRestApi$taskFilterToString = function (filter) {
	...
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'scheduled_date=',
		_user$project$CalendarDate$toString(_p29._0));
};
																																																							...
																																																							return function (_30) {
																																																								return function (_31) {
																																																									return function (_32) {
																																																										return function (_33) {
																																																											return function (_34) {
																																																												return {getMembershipById: a, getPlayByUrl: b, getTaskById: c, getTaskFromUrl: d, getWorkFromUrl: e, createClaim: f, createManualPlayListEntry: g, createPlay: h, createVendLog: i, createVisitEvent: j, createWork: k, createWorkNote: l, deleteManualPlayListEntryById: m, deleteManualPlayListEntryByUrl: n, deletePlayById: o, deletePlayByUrl: p, deleteWorkById: q, deleteWorkByUrl: r, listClaims: s, listDiscoveryMethods: t, listMembers: u, listMemberships: v, listPlays: w, listShows: x, listShowInstances: y, listTasks: z, listTimeBlocks: _1, listTimeBlockTypes: _2, listVisitEvents: _3, listWorks: _4, moreVisitEvents: _5, replaceClaim: _6, replaceManualPlayListEntry: _7, replaceWork: _8, replacePlay: _9, claimUrl: _10, memberUrl: _11, productUrl: _12, showUrl: _13, showInstanceUrl: _14, taskUrl: _15, vendLogUrl: _16, visitEventUrl: _17, workUrl: _18, workNoteUrl: _19, authenticate: _20, blockHasType: _21, coverTime: _22, defaultBlockType: _23, emailMembershipInfo: _24, logMessage: _25, getBlocksTypes: _26, memberCanClaimTask: _27, memberHasStatusOnTask: _28, membersClaimOnTask: _29, membersStatusOnTask: _30, membersWithStatusOnTask: _31, mostRecentMembership: _32, nowPlaying: _33, pitInBlock: _34};
																																																											};
																																																										};
																																																									};
																																																								};
...
var _user$project$XisRestApi$decodeWorkNoteData = A3(
	...
	A2(
		...
		function (_p30) {
			return _elm_community$json_extra$Json_Decode_Extra$fromResult(
				_user$project$PointInTime$fromString(_p30));
		},
		_elm_lang$core$Json_Decode$string),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
...
var _user$project$XisRestApi$taskPriorityDecoder = A2(
	...
	function (str) {
		...
		switch (_p31) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown priority: ', _p31));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$staffingStatusDecoder = A2(
	...
	function (str) {
		...
		switch (_p32) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown staffing status: ', _p32));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeClaimStatus = A2(
	...
	function (str) {
		...
		switch (_p33) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown claim status: ', _p33));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeVisitEventMethod = A2(
	...
	function (str) {
		...
		switch (_p34) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown visit event type: ', _p34));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$DjOps$rfid_dialog_body = function (model) {
	var _p0 = model.state;
	_v0_3:
	do {
		switch (_p0.ctor) {
				...
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(_elm_lang$core$String$repeat, _p0._0, '●')),
							_1: {ctor: '[]'}
						}
					});
			case 'FoundRfidToBe':
...
var _user$project$DjOps$rfidCharsOnly = _elm_lang$core$Regex$regex('^>[0-9A-F]*$');
var _user$project$DjOps$delimitedRfidNum = _elm_lang$core$Regex$regex('>[0-9A-F]{8}');
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				function () {
					var _p2 = {ctor: '_Tuple2', _0: model.selectedShow, _1: model.selectedShowDate};
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html$text(_p2._0._0.data.title),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$br,
												...
												_1: {
													...
													_0: _elm_lang$html$Html$text(
														A2(
															...
															'%a, %b %ddd',
															_user$project$CalendarDate$fromDate(_p2._1._0))),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$DjOps$layout_header_col_trackInfo = function (model) {
	...
	return A2(
		...
		function () {
			var _p3 = model.nowPlaying;
			if (_p3.ctor === 'Just') {
				var _p4 = _p3._0.track;
				if (_p4.ctor === 'Just') {
					var _p5 = _p4._0;
					return (_elm_lang$core$Native_Utils.cmp(_p5.remainingSeconds, 0) > 0) ? {
						ctor: '::',
						_0: A2(
							_user$project$DjOps$timeRemaining,
							_elm_lang$core$Basics$toString(
								_elm_lang$core$Basics$floor(_p5.remainingSeconds / 60)),
							_elm_lang$core$Basics$toString(
								A2(
									_elm_lang$core$Basics$rem,
									_elm_lang$core$Basics$floor(_p5.remainingSeconds),
									60))),
						_1: {
							ctor: '::',
							_0: A4(_user$project$DjOps$stackedPair, titleLabel, _p5.title, artistLabel, _p5.artist),
							_1: {ctor: '[]'}
						}
					} : blankInfo;
				} else {
...
var _user$project$DjOps$layout_header_col_showInfo = function (model) {
	...
	return A2(
		...
		function () {
			var _p6 = model.nowPlaying;
			if (_p6.ctor === 'Just') {
				var _p7 = _p6._0.show;
				if (_p7.ctor === 'Just') {
					var _p8 = _p7._0;
					return (_elm_lang$core$Native_Utils.cmp(_p8.remainingSeconds, 0) > 0) ? {
						ctor: '::',
						_0: A2(
							_user$project$DjOps$timeRemaining,
							_elm_lang$core$Basics$toString(
								_elm_lang$core$Basics$floor(_p8.remainingSeconds / 60)),
							_elm_lang$core$Basics$toString(
								A2(
									_elm_lang$core$Basics$rem,
									_elm_lang$core$Basics$floor(_p8.remainingSeconds),
									60))),
						_1: {
							ctor: '::',
							_0: A4(
								...
								_p8.title,
								hostLabel,
								A2(_elm_lang$core$String$join, ' & ', _p8.hosts)),
							_1: {ctor: '[]'}
						}
					} : blankInfo;
				} else {
																...
																return function (q) {
																	return function (r) {
																		return function (s) {
																			return function (t) {
																				return function (u) {
																					return {errMsgs: a, keyboardIdleTime: b, mdl: c, xisFlags: d, xis: e, currTime: f, selectedTab: g, shows: h, selectedShow: i, selectedShowDate: j, showInstance: k, datePicker: l, member: m, nowPlaying: n, tracksTabEntries: o, state: p, typed: q, rfidsToCheck: r, loggedAsPresent: s, userid: t, password: u};
																				};
																			};
																		};
																	};
...
var _user$project$DjOps$FoundRfidToBe = function (a) {
	return {ctor: 'FoundRfidToBe', _0: a};
};
var _user$project$DjOps$HitAnHttpErr = function (a) {
	return {ctor: 'HitAnHttpErr', _0: a};
};
var _user$project$DjOps$CheckingAnRfid = function (a) {
	return {ctor: 'CheckingAnRfid', _0: a};
};
var _user$project$DjOps$Nominal = {ctor: 'Nominal'};
...
var _user$project$DjOps$Tick_RFID = {ctor: 'Tick_RFID'};
					...
					return A2(
						_elm_lang$html$Html$option,
						{
							...
							_1: {
								...
								_0: _user$project$DjOps$tagattr(
									function () {
										var _p14 = model.selectedShow;
										if (_p14.ctor === 'Just') {
											return _elm_lang$core$Native_Utils.eq(show.id, _p14._0.id) ? 'selected' : 'dummy';
										} else {
											return 'dummy';
										}
									}()),
...
var _user$project$DjOps$ShowInstanceList_Result = function (a) {
	return {ctor: 'ShowInstanceList_Result', _0: a};
};
var _user$project$DjOps$fetchTracksTabData = function (model) {
	var _p15 = {ctor: '_Tuple3', _0: model.member, _1: model.selectedShow, _2: model.selectedShowDate};
	if ((((_p15.ctor === '_Tuple3') && (_p15._0.ctor === 'Just')) && (_p15._1.ctor === 'Just')) && (_p15._2.ctor === 'Just')) {
		var dateFilter = _user$project$XisRestApi$SI_DateEquals(
			_user$project$CalendarDate$fromDate(_p15._2._0));
		var showFilter = _user$project$XisRestApi$SI_ShowEquals(_p15._1._0.id);
		var fetchCmd = A2(
...
var _user$project$DjOps$MemberPresentResult = function (a) {
	return {ctor: 'MemberPresentResult', _0: a};
};
var _user$project$DjOps$MemberListResult = function (a) {
	return {ctor: 'MemberListResult', _0: a};
};
var _user$project$DjOps$checkAnRfid = function (model) {
	...
	switch (_p16.ctor) {
		...
		case 'FoundRfidToBe':
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		default:
			var _p17 = model.rfidsToCheck;
			if (_p17.ctor === '::') {
				var memberFilters = {
					ctor: '::',
					_0: _user$project$XisRestApi$RfidNumberEquals(_p17._0),
					_1: {ctor: '[]'}
				};
				var listCmd = A2(model.xis.listMembers, memberFilters, _user$project$DjOps$MemberListResult);
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						rfidsToCheck: _p17._1,
						state: _user$project$DjOps$CheckingAnRfid(0)
					});
				return {ctor: '_Tuple2', _0: newModel, _1: listCmd};
			} else {
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							state: _user$project$DjOps$FoundRfidToBe(false)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			}
...
var _user$project$DjOps$init = function (flags) {
	var _p18 = _elm_community$elm_datepicker$DatePicker$init;
	var datePicker = _p18._0;
	var datePickerCmd = _p18._1;
	var auth = function () {
		var _p19 = flags.csrfToken;
		if (_p19.ctor === 'Just') {
			return _user$project$DjangoRestFramework$LoggedIn(_p19._0);
		} else {
			return _user$project$DjangoRestFramework$NoAuthorization;
		}
	}();
	var model = {
		errMsgs: {ctor: '[]'},
		...
		xis: A2(_user$project$XisRestApi$createSession, flags.xisRestFlags, auth),
		currTime: 0,
		selectedTab: 0,
		shows: {ctor: '[]'},
		...
		tracksTabEntries: A2(_elm_lang$core$Array$repeat, _user$project$DjOps$numTrackRows, _user$project$DjOps$blankTracksTabEntry),
		state: _user$project$DjOps$Nominal,
		typed: '',
		rfidsToCheck: {ctor: '[]'},
...
var _user$project$DjOps$tracks_tableRow = F2(
	function (model, r) {
		...
		var _p21 = A2(_elm_lang$core$Array$get, r, model.tracksTabEntries);
		if (_p21.ctor === 'Just') {
			var _p22 = _p21._0;
			return A2(
				_debois$elm_mdl$Material_Table$tr,
				{
					...
					_0: A2(
						_debois$elm_mdl$Material_Options$css,
						'color',
						_user$project$DjOps$tracksTabEntryIsDirty(_p22) ? 'red' : 'black'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _user$project$DjOps$upsertManualPlayListEntry = F3(
	function (model, row, tte) {
		var _p23 = model.showInstance;
		if (_p23.ctor === 'Just') {
			var mpleData = A5(
				_user$project$XisRestApi$ManualPlayListEntryData,
				model.xis.showInstanceUrl(_p23._0.id),
				row,
				tte.artist,
				tte.title,
				tte.duration);
			var _p24 = tte.playListEntryId;
			if (_p24.ctor === 'Just') {
				return A2(
					model.xis.replaceManualPlayListEntry,
					A2(_user$project$DjangoRestFramework$Resource, _p24._0, mpleData),
	...
	function (model, minIdle) {
		var reducer = F2(
			function (_p27, _p26) {
				...
				var _p31 = _p29._0;
				var _p30 = _p29._1;
				if (_user$project$DjOps$tracksTabEntryIsDirty(_p33)) {
					var extraCmd = A2(
						...
						}) ? A3(_user$project$DjOps$deleteManualPlayListEntry, _p31, _p32, _p33) : A3(_user$project$DjOps$upsertManualPlayListEntry, _p31, _p32, _p33);
					return A2(
																				...
																				_1: {
																					...
																					_1: {
																						...
																						_1: {
																							ctor: '::',
																							_0: function () {
																								if (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.selectedShow) || (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.member) || _elm_community$maybe_extra$Maybe_Extra$isNothing(model.selectedShowDate))) {
																									return _debois$elm_mdl$Material_Button$disabled;
																								} else {
																									var _p34 = model.selectedShowDate;
																									if (_p34.ctor === 'Just') {
																										return (!_elm_lang$core$Native_Utils.eq(
																											_user$project$CalendarDate$fromDate(_p34._0),
...
var _user$project$DjOps$KeyDown_RFID = function (a) {
	return {ctor: 'KeyDown_RFID', _0: a};
};
		...
		switch (_p36.ctor) {
			...
			case 'KeyDown':
				...
				return A3(
					...
					_user$project$DjOps$KeyDown_Idle(_p37),
					A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
						_user$project$DjOps$update,
						_user$project$DjOps$KeyDown_RFID(_p37),
						{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none}));
			case 'KeyDown_Idle':
				return {
					ctor: '_Tuple2',
			...
			case 'KeyDown_RFID':
						...
						default:
							return A2(
								...
								_elm_lang$core$String$fromChar(
									_elm_lang$core$Char$fromCode(_p38)));
					}
				}();
				var finds = A3(_elm_lang$core$Regex$find, _elm_lang$core$Regex$All, _user$project$DjOps$delimitedRfidNum, typed);
				if (_elm_lang$core$List$isEmpty(finds)) {
					...
					return _user$project$DjOps$checkAnRfid(
						_elm_lang$core$Native_Utils.update(
							model,
							{typed: typed, rfidsToCheck: newRfidsToCheck}));
				}
			case 'Login_Clicked':
				var _p40 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p40.ctor === '_Tuple2') && (_p40._0.ctor === 'Just')) && (_p40._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A3(model.xis.authenticate, _p40._0._0, _p40._1._0, _user$project$DjOps$Authenticate_Result)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p36._0, model);
			case 'PasswordInput':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							password: _elm_lang$core$Maybe$Just(_p36._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SelectTab':
				return A2(
					...
					0);
			case 'SetDatePicker':
				var _p47 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p36._0, model.datePicker);
				var newDatePicker = _p47._0;
				var datePickerCmd = _p47._1;
				var dateEvent = _p47._2;
				var _p48 = dateEvent;
				if (_p48.ctor === 'NoChange') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return A3(
						...
						_user$project$DjOps$FetchTracksTabData,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{selectedShowDate: _p48._0, datePicker: newDatePicker}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$DjOps$SetDatePicker, datePickerCmd)
						});
				}
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p36._0._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'ShowWasChosen':
				...
				if (_p50.ctor === 'Just') {
					...
					var dummy = A2(_elm_lang$core$Debug$log, 'Bad Show ID', _p51);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Tick':
				return A3(
			...
			case 'Tick_RFID':
				...
				if (_p56.ctor === 'CheckingAnRfid') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$DjOps$CheckingAnRfid(_p56._0 + 1)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'TrackFieldUpdate':
				...
				var tte1 = A2(
					...
					A2(_elm_lang$core$Array$get, _p58, model.tracksTabEntries));
				var tte2 = function () {
					var _p57 = _p36._1;
					switch (_p57.ctor) {
						case 'ArtistColumn':
				...
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						tracksTabEntries: A3(_elm_lang$core$Array$set, _p58, tte2, model.tracksTabEntries)
					});
			...
			case 'UseridInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							userid: _elm_lang$core$Maybe$Just(_p36._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Authenticate_Result':
				if (_p36._0.ctor === 'Ok') {
					if (_p36._0._0.isAuthentic) {
						...
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								member: _p36._0._0.authenticatedMember,
								xis: A2(
			...
			case 'ManualPlayListEntryDelete_Result':
				if (_p36._1.ctor === 'Ok') {
					var newTtes = A3(_elm_lang$core$Array$set, _p36._0, _user$project$DjOps$blankTracksTabEntry, model.tracksTabEntries);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p36._1._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'ManualPlayListEntryUpsert_Result':
				if (_p36._0.ctor === 'Ok') {
					var _p42 = _p36._0._0;
					var _p41 = A2(_elm_lang$core$Array$get, _p42.data.sequence, model.tracksTabEntries);
					if (_p41.ctor === 'Just') {
						var newTte = _elm_lang$core$Native_Utils.update(
							_p41._0,
							{
								playListEntryId: _elm_lang$core$Maybe$Just(_p42.id),
								savedArtist: _p42.data.artist,
								savedTitle: _p42.data.title,
								savedDuration: _p42.data.duration
							});
						var newTtes = A3(_elm_lang$core$Array$set, _p42.data.sequence, newTte, model.tracksTabEntries);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
			...
			case 'MemberListResult':
				if (_p36._0.ctor === 'Ok') {
					var _p43 = _p36._0._0.results;
					if (_p43.ctor === '[]') {
						return _user$project$DjOps$checkAnRfid(
							_elm_lang$core$Native_Utils.update(
								model,
						...
						if (_p43._1.ctor === '[]') {
							...
							var newModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									...
									rfidsToCheck: {ctor: '[]'},
									typed: '',
									loggedAsPresent: A2(_elm_lang$core$Set$insert, _p44.id, model.loggedAsPresent)
								});
							var cmd2 = A2(_elm_lang$core$Set$member, _p44.id, model.loggedAsPresent) ? _elm_lang$core$Platform_Cmd$none : A2(
								model.xis.createVisitEvent,
								{
									who: model.xis.memberUrl(_p44.id),
									when: model.currTime,
								...
								_user$project$DjOps$MemberPresentResult);
							return {ctor: '_Tuple2', _0: newModel, _1: cmd2};
						} else {
							return _user$project$DjOps$checkAnRfid(
								_elm_lang$core$Native_Utils.update(
									model,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$DjOps$HitAnHttpErr(_p36._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'MemberPresentResult':
				if (_p36._0.ctor === 'Ok') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					return {
			...
			case 'NowPlaying_Result':
				if (_p36._0.ctor === 'Ok') {
					...
					var delaySeconds = function () {
						var _p45 = _p46.track;
						if (_p45.ctor === 'Just') {
							var rs = _p45._0.remainingSeconds;
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								nowPlaying: _elm_lang$core$Maybe$Just(_p46)
							}),
					...
					var dummy = A2(
						...
						'NowPlaying_Result',
						_elm_lang$core$Basics$toString(_p36._0._0));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
			...
			default:
				if (_p36._0.ctor === 'Ok') {
					var showInstance = _elm_lang$core$List$head(_p36._0._0.results);
					var tracksForTab = A2(
						_elm_lang$core$Maybe$withDefault,
						{ctor: '[]'},
						A2(
						...
						function (_p60) {
							return A2(
								...
								_elm_lang$core$List$singleton(
									_elm_lang$html$Html$text(_p60)));
						},
						model.errMsgs))),
			footer: _elm_lang$core$Maybe$Nothing
		}) : _elm_lang$core$Maybe$Nothing;
};
var _user$project$DjOps$rfid_dialog_config = function (model) {
	...
	return _elm_lang$core$Maybe$Just(
		{
			...
			containerId: _elm_lang$core$Maybe$Nothing,
			header: _elm_lang$core$Maybe$Just(
				_elm_lang$html$Html$text('🎶 RFID Check-In')),
			body: _elm_lang$core$Maybe$Just(
				_user$project$DjOps$rfid_dialog_body(model)),
			footer: _elm_lang$core$Maybe$Nothing
		});
};
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: _jackwillis$elm_dialog$Dialog$view(
					_user$project$DjOps$rfid_dialog_config(model)),
				_1: {
					ctor: '::',
					_0: _jackwillis$elm_dialog$Dialog$view(
