...
var _user$project$XisRestApi$showInstanceFilterToString = function (filter) {
	var _p1 = filter;
	if (_p1.ctor === 'SI_DateEquals') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'date=',
			_user$project$CalendarDate$toString(_p1._0));
	} else {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'show=',
...
var _user$project$XisRestApi$replaceAll = F2(
	function (_p2, whole) {
		...
		return A4(
			_elm_lang$core$Regex$replace,
			_elm_lang$core$Regex$All,
			_elm_lang$core$Regex$regex(_p3.oldSub),
			function (_p4) {
				return _p3.newSub;
			},
			whole);
	...
	switch (_p9.ctor) {
		case 'VEF_WhenGreaterOrEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'when__gte=',
				_user$project$PointInTime$isoString(_p9._0));
		case 'VEF_EventTypeEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'event_type=',
				_user$project$XisRestApi$eventTypeString(_p9._0));
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'method=',
				_user$project$XisRestApi$eventMethodString(_p9._0));
	}
};
...
var _user$project$XisRestApi$coverTime = F2(
	function (memberships, now) {
		var _p10 = _user$project$XisRestApi$mostRecentMembership(memberships);
		if (_p10.ctor === 'Nothing') {
			return false;
		} else {
			var _p11 = _p10._0;
			var membershipRange = A2(_user$project$RangeOfTime$fromCalendarDates, _p11.data.startDate, _p11.data.endDate);
...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var bd = block.data;
		var _p13 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
				start: {line: 1202, column: 25},
				end: {line: 1202, column: 36}
...
var _user$project$XisRestApi$memberFilterToString = function (filter) {
	...
	switch (_p16.ctor) {
		...
		case 'EmailEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__email__iexact=', _p16._0);
		case 'UsernameEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__iexact=', _p16._0);
		case 'UsernameContains':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__icontains=', _p16._0);
		case 'UsernameStartsWith':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__username__istartswith=', _p16._0);
		case 'LastNameStartsWith':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__last_name__istartswith=', _p16._0);
		case 'LastNameEquals':
			return A2(_elm_lang$core$Basics_ops['++'], 'auth_user__last_name__iexact=', _p16._0);
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
...
var _user$project$XisRestApi$encodePlayData = function (_p17) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$playDataNVPs(_p17));
};
	...
	switch (_p18.ctor) {
		...
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'play_date=',
				_user$project$CalendarDate$toString(_p18._0));
	}
};
...
var _user$project$XisRestApi$encodeWorkData = function (_p19) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$workDataNVPs(_p19));
};
...
var _user$project$XisRestApi$workFilterToString = function (filter) {
	var _p20 = filter;
	if (_p20.ctor === 'WorkedClaimEquals') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'claim=',
...
var _user$project$XisRestApi$encodeClaimData = function (_p22) {
	return _elm_lang$core$Json_Encode$object(
		_user$project$XisRestApi$claimDataNVPs(_p22));
};
	...
	switch (_p24.ctor) {
		case 'ClaimStatusEquals':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'status=',
				_user$project$XisRestApi$claimStatusValue(_p24._0));
...
var _user$project$XisRestApi$memberHasStatusOnTask = F4(
	function (flags, memberNum, questionedStatus, task) {
		...
		var _p27 = actualStatus;
		if (_p27.ctor === 'Nothing') {
			return false;
		} else {
			return _elm_lang$core$Native_Utils.eq(_p27._0, questionedStatus);
		}
	});
var _user$project$XisRestApi$taskFilterToString = function (filter) {
	...
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'scheduled_date=',
		_user$project$CalendarDate$toString(_p28._0));
};
															...
															return function (p) {
																return function (q) {
																	return function (r) {
																		return function (s) {
																			return function (t) {
																				return {authenticateUrl: a, claimListUrl: b, discoveryMethodListUrl: c, emailMembershipInfoUrl: d, logMessageUrl: e, memberListUrl: f, membershipListUrl: g, nowPlayingUrl: h, playListUrl: i, productListUrl: j, showListUrl: k, showInstanceListUrl: l, taskListUrl: m, timeBlocksUrl: n, timeBlockTypesUrl: o, trackListUrl: p, vendLogListUrl: q, visitEventListUrl: r, workListUrl: s, workNoteListUrl: t};
																			};
																		};
																	};
																};
																																																		...
																																																		return function (_25) {
																																																			return function (_26) {
																																																				return function (_27) {
																																																					return function (_28) {
																																																						return function (_29) {
																																																							return {getMembershipById: a, getPlayByUrl: b, getTaskById: c, getTaskFromUrl: d, getWorkFromUrl: e, createClaim: f, createPlay: g, createVendLog: h, createVisitEvent: i, createWork: j, createWorkNote: k, deletePlayById: l, deletePlayByUrl: m, deleteWorkById: n, deleteWorkByUrl: o, listClaims: p, listDiscoveryMethods: q, listMembers: r, listMemberships: s, listPlays: t, listShows: u, listShowInstances: v, listTasks: w, listTimeBlocks: x, listTimeBlockTypes: y, listVisitEvents: z, listWorks: _1, moreVisitEvents: _2, replaceClaim: _3, replaceWork: _4, replacePlay: _5, claimUrl: _6, memberUrl: _7, productUrl: _8, showUrl: _9, taskUrl: _10, vendLogUrl: _11, visitEventUrl: _12, workUrl: _13, workNoteUrl: _14, authenticate: _15, blockHasType: _16, coverTime: _17, defaultBlockType: _18, emailMembershipInfo: _19, logMessage: _20, getBlocksTypes: _21, memberCanClaimTask: _22, memberHasStatusOnTask: _23, membersClaimOnTask: _24, membersStatusOnTask: _25, membersWithStatusOnTask: _26, mostRecentMembership: _27, nowPlaying: _28, pitInBlock: _29};
																																																						};
																																																					};
																																																				};
																																																			};
...
var _user$project$XisRestApi$decodeWorkNoteData = A3(
	...
	A2(
		...
		function (_p29) {
			return _elm_community$json_extra$Json_Decode_Extra$fromResult(
				_user$project$PointInTime$fromString(_p29));
		},
		_elm_lang$core$Json_Decode$string),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
...
var _user$project$XisRestApi$ManualPlayListEntryData = F4(
	function (a, b, c, d) {
		return {sequence: a, artist: b, title: c, duration: d};
	});
var _user$project$XisRestApi$decodeManualPlayListEntryData = A5(
	_elm_lang$core$Json_Decode$map4,
...
var _user$project$XisRestApi$taskPriorityDecoder = A2(
	...
	function (str) {
		...
		switch (_p30) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown priority: ', _p30));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$staffingStatusDecoder = A2(
	...
	function (str) {
		...
		switch (_p31) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown staffing status: ', _p31));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeClaimStatus = A2(
	...
	function (str) {
		...
		switch (_p32) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown claim status: ', _p32));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _user$project$XisRestApi$decodeVisitEventMethod = A2(
	...
	function (str) {
		...
		switch (_p33) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown visit event type: ', _p33));
		}
	},
	_elm_lang$core$Json_Decode$string);
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				function () {
					var _p2 = {ctor: '_Tuple2', _0: model.chosenShow, _1: model.showDate};
													...
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return function (r) {
																		return {errMsgs: a, mdl: b, xis: c, currTime: d, selectedTab: e, shows: f, chosenShow: g, showDate: h, datePicker: i, member: j, nowPlaying: k, tracksTabEntries: l, state: m, typed: n, rfidsToCheck: o, loggedAsPresent: p, userid: q, password: r};
																	};
																};
															};
														};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				A3(_elm_community$elm_datepicker$DatePicker$view, model.showDate, _elm_community$elm_datepicker$DatePicker$defaultSettings, model.datePicker)),
			_1: {ctor: '[]'}
		});
};
				...
				_elm_lang$html$Html$option,
				{
					...
					_1: {
						...
						_0: _user$project$DjOps$tagattr(
							_elm_community$maybe_extra$Maybe_Extra$isNothing(model.chosenShow) ? 'selected' : 'dummy'),
						_1: {
							ctor: '::',
...
var _user$project$DjOps$fetchTracksTabData = function (model) {
	var _p13 = {ctor: '_Tuple3', _0: model.member, _1: model.chosenShow, _2: model.showDate};
...
var _user$project$DjOps$init = function (flags) {
	...
	var model = {
		...
		selectedTab: 0,
		shows: {ctor: '[]'},
		chosenShow: _elm_lang$core$Maybe$Nothing,
		showDate: _elm_lang$core$Maybe$Nothing,
							...
							_0: row(
								{
									...
									_0: A2(
										numTd,
										_elm_community$maybe_extra$Maybe_Extra$isJust(model.chosenShow),
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('❷ '),
											_1: {ctor: '[]'}
								...
								_0: row(
									{
										...
										_0: A2(
											numTd,
											_elm_community$maybe_extra$Maybe_Extra$isJust(model.showDate),
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('❸ '),
												_1: {ctor: '[]'}
																				...
																				_1: {
																					...
																					_1: {
																						...
																						_1: {
																							ctor: '::',
																							_0: function () {
																								if (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.chosenShow) || (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.member) || _elm_community$maybe_extra$Maybe_Extra$isNothing(model.showDate))) {
																									return _debois$elm_mdl$Material_Button$disabled;
																								} else {
																									var _p18 = model.showDate;
																									if (_p18.ctor === 'Just') {
																										return (!_elm_lang$core$Native_Utils.eq(
																											_user$project$CalendarDate$fromDate(_p18._0),
									...
									_1: {
										...
										_0: _debois$elm_mdl$Material_Textfield$value(
											function () {
												...
												if (_p19.ctor === 'Just') {
													var _p20 = _p19._0;
													return _elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$artistColId) ? _p20.artist : (_elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$titleColId) ? _p20.title : (_elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$durationColId) ? _p20.duration : 'ERR1'));
												} else {
													return 'ERR2';
												}
											}()),
...
var _user$project$DjOps$KeyDownAuthenticate = function (a) {
	return {ctor: 'KeyDownAuthenticate', _0: a};
};
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$keyboard$Keyboard$downs(_user$project$DjOps$KeyDownAuthenticate),
					_1: {
						ctor: '::',
...
var _user$project$DjOps$update = F2(
	function (action, model) {
		...
		switch (_p22.ctor) {
			...
			case 'KeyDownAuthenticate':
				var _p23 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p23.ctor === '_Tuple2') && (_p23._0.ctor === 'Just')) && (_p23._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _elm_lang$core$Native_Utils.eq(_p22._0, 13) ? A3(model.xis.authenticate, _p23._0._0, _p23._1._0, _user$project$DjOps$Authenticate_Result) : _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'KeyDownRfid':
						...
						default:
							return A2(
								...
								_elm_lang$core$String$fromChar(
									_elm_lang$core$Char$fromCode(_p24)));
					}
				}();
				...
				if (_elm_lang$core$List$isEmpty(finds)) {
					...
					var hexToInt = function (_p25) {
						return _rtfeldman$hex$Hex$fromString(
							_elm_lang$core$String$toLower(_p25));
					};
				...
				if (_p36.ctor === 'NoChange') {
					...
					return A3(
						...
						_user$project$DjOps$FetchTracksTabData,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{showDate: _p36._0, datePicker: newDatePicker}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$DjOps$SetDatePicker, datePickerCmd)
						});
				}
				...
				if (_p22._0.ctor === 'Ok') {
					var tracksForTab = A2(
						...
						A2(
							...
							_elm_lang$core$List$head(_p22._0._0.results)));
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$DjOps$populateTracksTabData, model, tracksForTab),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var dummy = A2(
																																										...
																																										function (workListUrl) {
																																											return A2(
																																												...
																																												function (workNoteListUrl) {
																																													return _elm_lang$core$Json_Decode$succeed(
																																														{authenticateUrl: authenticateUrl, claimListUrl: claimListUrl, discoveryMethodListUrl: discoveryMethodListUrl, emailMembershipInfoUrl: emailMembershipInfoUrl, logMessageUrl: logMessageUrl, memberListUrl: memberListUrl, membershipListUrl: membershipListUrl, nowPlayingUrl: nowPlayingUrl, playListUrl: playListUrl, productListUrl: productListUrl, showInstanceListUrl: showInstanceListUrl, showListUrl: showListUrl, taskListUrl: taskListUrl, timeBlockTypesUrl: timeBlockTypesUrl, timeBlocksUrl: timeBlocksUrl, trackListUrl: trackListUrl, vendLogListUrl: vendLogListUrl, visitEventListUrl: visitEventListUrl, workListUrl: workListUrl, workNoteListUrl: workNoteListUrl});
																																												},
