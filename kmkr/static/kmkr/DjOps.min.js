...
var _user$project$DjOps$tracksTabTitle = function (model) {
	var trackCount = _elm_lang$core$List$length(
		A2(
			_elm_lang$core$List$filter,
			function (_p9) {
				return !_elm_lang$core$String$isEmpty(_p9);
			},
			_elm_lang$core$Array$toList(model.titles)));
		...
		while (true) {
			...
			if (_p10.ctor === '[]') {
				...
				var pyDurStr = A2(
					_elm_lang$core$Maybe$withDefault,
					'',
					A2(_elm_lang$core$Maybe$map, _user$project$DjangoRestFramework$durationToPythonRepr, _p11.data.duration));
				var duration = A2(_elm_lang$core$String$dropLeft, 5, pyDurStr);
				var artist = A2(_elm_lang$core$Maybe$withDefault, '', _p11.data.artist);
				var title = A2(_elm_lang$core$Maybe$withDefault, '', _p11.data.title);
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						titles: A3(_elm_lang$core$Array$set, seq, title, model.titles),
						artists: A3(_elm_lang$core$Array$set, seq, artist, model.artists),
						durations: A3(_elm_lang$core$Array$set, seq, duration, model.durations)
					});
				var _v7 = newModel,
					_v8 = _p10._1;
				model = _v7;
...
var _user$project$DjOps$populateTracksTabData = F2(
	function (model, ples) {
		var newModel = _elm_lang$core$Native_Utils.update(
			model,
			{
				artists: A2(_elm_lang$core$Array$repeat, _user$project$DjOps$numTrackRows, ''),
				titles: A2(_elm_lang$core$Array$repeat, _user$project$DjOps$numTrackRows, ''),
				durations: A2(_elm_lang$core$Array$repeat, _user$project$DjOps$numTrackRows, '')
			});
															...
															return function (p) {
																return function (q) {
																	return function (r) {
																		return function (s) {
																			return function (t) {
																				return {errMsgs: a, mdl: b, xis: c, currTime: d, selectedTab: e, shows: f, chosenShow: g, showDate: h, datePicker: i, member: j, nowPlaying: k, artists: l, titles: m, durations: n, state: o, typed: p, rfidsToCheck: q, loggedAsPresent: r, userid: s, password: t};
																			};
																		};
																	};
																};
																			...
																			model.mdl,
																			{
																				...
																				_1: {
																					...
																					_1: {
																						...
																						_1: {
																							ctor: '::',
																							_0: (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.chosenShow) || (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.member) || _elm_community$maybe_extra$Maybe_Extra$isNothing(model.showDate))) ? _debois$elm_mdl$Material_Button$disabled : _debois$elm_mdl$Material_Options$nop,
																							_1: {ctor: '[]'}
																						}
																					}
																				}
								...
								opts,
								{
									...
									_1: {
										...
										_0: _debois$elm_mdl$Material_Textfield$value(
											_elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$artistColId) ? A2(
												_elm_lang$core$Maybe$withDefault,
												'',
												A2(_elm_lang$core$Array$get, r, model.artists)) : (_elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$titleColId) ? A2(
												_elm_lang$core$Maybe$withDefault,
												'',
												A2(_elm_lang$core$Array$get, r, model.titles)) : (_elm_lang$core$Native_Utils.eq(c, _user$project$DjOps$durationColId) ? A2(
												_elm_lang$core$Maybe$withDefault,
												'',
												A2(_elm_lang$core$Array$get, r, model.durations)) : ''))),
										_1: {
											ctor: '::',
	...
	function (action, model) {
		...
		switch (_p19.ctor) {
			...
			case 'KeyDownAuthenticate':
				var _p20 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p20.ctor === '_Tuple2') && (_p20._0.ctor === 'Just')) && (_p20._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _elm_lang$core$Native_Utils.eq(_p19._0, 13) ? A3(model.xis.authenticate, _p20._0._0, _p20._1._0, _user$project$DjOps$Authenticate_Result) : _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
						...
						default:
							return A2(
								...
								_elm_lang$core$String$fromChar(
									_elm_lang$core$Char$fromCode(_p21)));
					}
				}();
			...
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p19._0, model);
			case 'NowPlaying_Tick':
				var _p27 = model.nowPlaying;
				if (_p27.ctor === 'Just') {
					var _p30 = _p27._0;
					var _p28 = _p30.track;
					if (_p28.ctor === 'Just') {
						...
						var updatedTrack = _elm_lang$core$Native_Utils.update(
							_p29,
							{remainingSeconds: _p29.remainingSeconds - 1});
			...
			case 'PasswordInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							password: _elm_lang$core$Maybe$Just(_p19._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RfidTick':
				var _p31 = model.state;
				if (_p31.ctor === 'CheckingAnRfid') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$DjOps$CheckingAnRfid(_p31._0 + 1)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'SetDatePicker':
				var _p32 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p19._0, model.datePicker);
				var newDatePicker = _p32._0;
				var datePickerCmd = _p32._1;
				var dateEvent = _p32._2;
				var _p33 = dateEvent;
				if (_p33.ctor === 'NoChange') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return A3(
						...
						_user$project$DjOps$FetchTracksTabData,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{showDate: _p33._0, datePicker: newDatePicker}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$DjOps$SetDatePicker, datePickerCmd)
						});
				}
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p19._0._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'ShowWasChosen':
				var _p36 = _p19._0;
				var _p35 = _elm_lang$core$Result$toMaybe(
					_elm_lang$core$String$toInt(_p36));
				if (_p35.ctor === 'Just') {
					var show = A2(
						_elm_community$list_extra$List_Extra$find,
						function (s) {
							return _elm_lang$core$Native_Utils.eq(s.id, _p35._0);
						},
						model.shows);
					return A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
					...
					var dummy = A2(_elm_lang$core$Debug$log, 'Bad Show ID', _p36);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Tick':
				var newModel = _elm_lang$core$Native_Utils.update(
			...
			case 'TrackFieldUpdate':
				...
				var _p38 = _p19._0;
				var _p37 = _p19._1;
				var newModel = _elm_lang$core$Native_Utils.eq(_p37, _user$project$DjOps$artistColId) ? _elm_lang$core$Native_Utils.update(
					model,
					{
						artists: A3(_elm_lang$core$Array$set, _p38, _p39, model.artists)
					}) : (_elm_lang$core$Native_Utils.eq(_p37, _user$project$DjOps$titleColId) ? _elm_lang$core$Native_Utils.update(
					model,
					{
						titles: A3(_elm_lang$core$Array$set, _p38, _p39, model.titles)
					}) : (_elm_lang$core$Native_Utils.eq(_p37, _user$project$DjOps$durationColId) ? _elm_lang$core$Native_Utils.update(
					model,
					{
						durations: A3(_elm_lang$core$Array$set, _p38, _p39, model.durations)
					}) : model));
			...
			case 'UseridInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							userid: _elm_lang$core$Maybe$Just(_p19._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Authenticate_Result':
				if (_p19._0.ctor === 'Ok') {
					var errMsgs = _p19._0._0.isAuthentic ? {ctor: '[]'} : {
						ctor: '::',
					...
					return A3(
						...
						_user$project$DjOps$FetchTracksTabData,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{member: _p19._0._0.authenticatedMember, errMsgs: errMsgs}),
							_1: _elm_lang$core$Platform_Cmd$none
						});
				} else {
					return {
				...
				if (_p19._0.ctor === 'Ok') {
						...
						if (_p23._1.ctor === '[]') {
							...
							var newModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									...
									rfidsToCheck: {ctor: '[]'},
									typed: '',
									loggedAsPresent: A2(_elm_lang$core$Set$insert, _p24.id, model.loggedAsPresent)
								});
							var cmd2 = A2(_elm_lang$core$Set$member, _p24.id, model.loggedAsPresent) ? _elm_lang$core$Platform_Cmd$none : A2(
								model.xis.createVisitEvent,
								{
									who: model.xis.memberUrl(_p24.id),
									when: model.currTime,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$DjOps$HitAnHttpErr(_p19._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			case 'NowPlaying_Result':
				if (_p19._0.ctor === 'Ok') {
					...
					var delaySeconds = function () {
						var _p25 = _p26.track;
						if (_p25.ctor === 'Just') {
							var rs = _p25._0.remainingSeconds;
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								nowPlaying: _elm_lang$core$Maybe$Just(_p26)
							}),
				...
				if (_p19._0.ctor === 'Ok') {
					var tracksForTab = A2(
						...
						A2(
							...
							_elm_lang$core$List$head(_p19._0._0.results)));
					return {
						ctor: '_Tuple2',
