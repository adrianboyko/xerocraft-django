...
var _user$project$DjOps$tracks_tableRow = F2(
	function (model, r) {
							...
							A2(
								...
								opts,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_community$maybe_extra$Maybe_Extra$isJust(model.member) ? _debois$elm_mdl$Material_Options$nop : _debois$elm_mdl$Material_Textfield$disabled,
											_1: {
												ctor: '::',
		...
		var _p16 = A2(_elm_lang$core$Array$get, r, model.tracksTabEntries);
		if (_p16.ctor === 'Just') {
			var _p17 = _p16._0;
			return A2(
				_debois$elm_mdl$Material_Table$tr,
				{
					...
					_0: A2(
						_debois$elm_mdl$Material_Options$css,
						'color',
						_user$project$DjOps$tracksTabEntryIsDirty(_p17) ? 'red' : 'black'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _user$project$DjOps$upsertEpisodeTrack = F3(
	function (model, row, tte) {
		var _p18 = model.episode;
		if (_p18.ctor === 'Just') {
			var etData = A5(
				_user$project$XisRestApi$EpisodeTrackData,
				model.xis.episodeUrl(_p18._0.id),
				row,
				tte.artist,
				tte.title,
				tte.duration);
			var _p19 = tte.playListEntryId;
			if (_p19.ctor === 'Just') {
				return A2(
					model.xis.replaceEpisodeTrack,
					A2(_user$project$DjangoRestFramework$Resource, _p19._0, etData),
	...
	function (model, minIdle) {
		var reducer = F2(
			function (_p22, _p21) {
				...
				var _p26 = _p24._0;
				var _p25 = _p24._1;
				if (_user$project$DjOps$tracksTabEntryIsDirty(_p28)) {
					var extraCmd = A2(
						...
						}) ? A3(_user$project$DjOps$deleteEpisodeTrack, _p26, _p27, _p28) : A3(_user$project$DjOps$upsertEpisodeTrack, _p26, _p27, _p28);
					return A2(
						_ccapndave$elm_update_extra$Update_Extra$addCmd,
						extraCmd,
						{ctor: '_Tuple2', _0: _p26, _1: _p25});
				} else {
					return {ctor: '_Tuple2', _0: _p26, _1: _p25};
				}
			});
...
var _user$project$DjOps$fetchTracksTabData = function (model) {
	var _p29 = {ctor: '_Tuple2', _0: model.selectedShow, _1: model.selectedShowDate};
	if (((_p29.ctor === '_Tuple2') && (_p29._0.ctor === 'Just')) && (_p29._1.ctor === 'Just')) {
		var _p31 = _p29._1._0;
		var _p30 = _p29._0._0;
		var tagger = A2(_user$project$DjOps$EpisodeList_Result, _p30, _p31);
		var dateFilter = _user$project$XisRestApi$EpisodeDateEquals(
			_user$project$CalendarDate$fromDate(_p31));
		var showFilter = _user$project$XisRestApi$EpisodeShowEquals(_p30.id);
		var fetchCmd = A2(
																						...
																						_1: {
																							...
																							_0: function () {
																								if (_elm_community$maybe_extra$Maybe_Extra$isNothing(model.episode) || _elm_community$maybe_extra$Maybe_Extra$isNothing(model.member)) {
																									...
																									var _p32 = model.selectedShowDate;
																									if (_p32.ctor === 'Just') {
																										return (!_elm_lang$core$Native_Utils.eq(
																											_user$project$CalendarDate$fromDate(_p32._0),
	...
	function (action, model) {
		...
		switch (_p34.ctor) {
			...
			case 'BeginBroadcast_Clicked':
				var _p35 = model.episode;
				if (_p35.ctor === 'Just') {
					var bcData = {
						episode: model.xis.episodeUrl(_p35._0.id),
			...
			case 'KeyDown':
				return A3(
					...
					_user$project$DjOps$KeyDown_Idle(_p34._0),
					{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
			case 'KeyDown_Idle':
				return {
					ctor: '_Tuple2',
			...
			case 'Login_Clicked':
				var _p36 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p36.ctor === '_Tuple2') && (_p36._0.ctor === 'Just')) && (_p36._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A3(model.xis.authenticate, _p36._0._0, _p36._1._0, _user$project$DjOps$Authenticate_Result)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p34._0, model);
			case 'PasswordInput':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							password: _elm_lang$core$Maybe$Just(_p34._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SelectTab':
				return A2(
					...
					0);
			case 'SetDatePicker':
				var _p41 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p34._0, model.datePicker);
				var newDatePicker = _p41._0;
				var datePickerCmd = _p41._1;
				var dateEvent = _p41._2;
				var _p42 = dateEvent;
				if (_p42.ctor === 'NoChange') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return A3(
						...
						_user$project$DjOps$FetchTracksTabData,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{selectedShowDate: _p42._0, datePicker: newDatePicker}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$DjOps$SetDatePicker, datePickerCmd)
						});
				}
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p34._0._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'ShowWasChosen':
				var _p50 = _p34._0;
				var _p49 = _elm_lang$core$Result$toMaybe(
					_elm_lang$core$String$toInt(_p50));
				if (_p49.ctor === 'Just') {
					var show = A2(
						_elm_community$list_extra$List_Extra$find,
						function (s) {
							return _elm_lang$core$Native_Utils.eq(s.id, _p49._0);
						},
						model.shows);
					return A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
					...
					var dummy = A2(_elm_lang$core$Debug$log, 'Couldn\'t convert to Int', _p50);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Tick':
				return A3(
				...
				if (_p51.ctor === 'Just') {
					...
					if (_p52.ctor === 'Just') {
						...
						var updatedTrack = _elm_lang$core$Native_Utils.update(
							_p53,
							{remainingSeconds: _p53.remainingSeconds - 1});
			...
			case 'TrackFieldUpdate':
				...
				var tte1 = A2(
					...
					A2(_elm_lang$core$Array$get, _p56, model.tracksTabEntries));
				var tte2 = function () {
					var _p55 = _p34._1;
					switch (_p55.ctor) {
						case 'ArtistColumn':
				...
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						tracksTabEntries: A3(_elm_lang$core$Array$set, _p56, tte2, model.tracksTabEntries)
					});
			...
			case 'UseridInput':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							userid: _elm_lang$core$Maybe$Just(_p34._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Authenticate_Result':
				if (_p34._0.ctor === 'Ok') {
					if (_p34._0._0.isAuthentic) {
						...
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								member: _p34._0._0.authenticatedMember,
								xis: A2(
			...
			case 'EpisodeTrackDelete_Result':
				if (_p34._1.ctor === 'Ok') {
					var newTtes = A3(_elm_lang$core$Array$set, _p34._0, _user$project$DjOps$blankTracksTabEntry, model.tracksTabEntries);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errMsgs: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p34._1._0),
									_1: {ctor: '[]'}
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'EpisodeTrackUpsert_Result':
				if (_p34._0.ctor === 'Ok') {
					var _p38 = _p34._0._0;
					var _p37 = A2(_elm_lang$core$Array$get, _p38.data.sequence, model.tracksTabEntries);
					if (_p37.ctor === 'Just') {
						var newTte = _elm_lang$core$Native_Utils.update(
							_p37._0,
							{
								playListEntryId: _elm_lang$core$Maybe$Just(_p38.id),
								savedArtist: _p38.data.artist,
								savedTitle: _p38.data.title,
								savedDuration: _p38.data.duration
							});
						var newTtes = A3(_elm_lang$core$Array$set, _p38.data.sequence, newTte, model.tracksTabEntries);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
						...
						var dummy = A2(_elm_lang$core$Debug$log, 'Couldn\'t find row for', _p38);
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				} else {
					return {
			...
			case 'NowPlaying_Result':
				if (_p34._0.ctor === 'Ok') {
					...
					var delaySeconds = function () {
						var _p39 = _p40.track;
						if (_p39.ctor === 'Just') {
							var rs = _p39._0.remainingSeconds;
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								nowPlaying: _elm_lang$core$Maybe$Just(_p40)
							}),
			...
			case 'EpisodeCreate_Result':
				if (_p34._2.ctor === 'Ok') {
					...
					var msg = A3(
						...
						_p34._1,
						_elm_lang$core$Result$Ok(
							_user$project$DjangoRestFramework$singletonPageOf(_p43)));
					return A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
						_user$project$DjOps$update,
						msg,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									episode: _elm_lang$core$Maybe$Just(_p43)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						});
				} else {
					var dummy = A2(
						...
						_elm_lang$core$Basics$toString(_p34._2._0));
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			default:
				if (_p34._2.ctor === 'Ok') {
					var _p48 = _p34._1;
					var _p47 = _p34._0;
					var _p46 = _p34._2._0.results;
					var _p45 = _p34._2._0.count;
					if (_elm_lang$core$Native_Utils.eq(_p45, 1)) {
						var episode = _elm_lang$core$List$head(_p46);
						var tracksForTab = A2(
							_elm_lang$core$Maybe$withDefault,
							{ctor: '[]'},
							A2(
						...
						if (_elm_lang$core$Native_Utils.eq(_p45, 0)) {
							var tagger = A2(_user$project$DjOps$EpisodeCreate_Result, _p47, _p48);
							var selShowUrl = model.xis.showUrl(_p47.id);
							var epData = A4(
								_user$project$XisRestApi$EpisodeData,
								selShowUrl,
							...
							var dummy = A2(_elm_lang$core$Debug$log, '>1 Episode', _p46);
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						}
					}
				} else {
