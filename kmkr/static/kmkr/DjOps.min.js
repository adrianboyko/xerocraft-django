...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var _p19 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
				start: {line: 922, column: 25},
				end: {line: 922, column: 36}
																																																												...
																																																												return function (_35) {
																																																													return function (_36) {
																																																														return function (_37) {
																																																															return function (_38) {
																																																																return function (_39) {
																																																																	return {getMembershipById: a, getPlayByUrl: b, getTaskById: c, getTaskFromUrl: d, getWorkFromUrl: e, createBroadcast: f, createClaim: g, createEpisodeTrack: h, createPlay: i, createEpisode: j, createVendLog: k, createVisitEvent: l, createWork: m, createWorkNote: n, deleteEpisodeTrackById: o, deleteEpisodeTrackByUrl: p, deletePlayById: q, deletePlayByUrl: r, deleteWorkById: s, deleteWorkByUrl: t, listBroadcasts: u, listClaims: v, listDiscoveryMethods: w, listEpisodes: x, listMembers: y, listMemberships: z, listPlays: _1, listShows: _2, listTasks: _3, listTimeBlocks: _4, listTimeBlockTypes: _5, listVisitEvents: _6, listWorks: _7, moreVisitEvents: _8, replaceClaim: _9, replaceEpisodeTrack: _10, replaceWork: _11, replacePlay: _12, replaceEpisode: _13, broadcastUrl: _14, claimUrl: _15, memberUrl: _16, productUrl: _17, showUrl: _18, episodeUrl: _19, taskUrl: _20, vendLogUrl: _21, visitEventUrl: _22, workUrl: _23, workNoteUrl: _24, authenticate: _25, blockHasType: _26, coverTime: _27, defaultBlockType: _28, emailMembershipInfo: _29, logMessage: _30, getBlocksTypes: _31, memberCanClaimTask: _32, memberHasStatusOnTask: _33, membersClaimOnTask: _34, membersStatusOnTask: _35, membersWithStatusOnTask: _36, mostRecentMembership: _37, nowPlaying: _38, pitInBlock: _39};
																																																																};
																																																															};
																																																														};
																																																													};
...
var _user$project$DjOps$TracksTabEntry = F7(
	function (a, b, c, d, e, f, g) {
		return {playListEntryId: a, artist: b, title: c, duration: d, savedArtist: e, savedTitle: f, savedDuration: g};
	});
var _user$project$DjOps$newTracksTabEntry = F7(
	function (id, artist, title, duration, sArtist, sTitle, sDuration) {
		return A7(_user$project$DjOps$TracksTabEntry, id, artist, title, duration, sArtist, sTitle, sDuration);
	});
									...
									_0: A2(
										...
										_user$project$DjOps$firstTdStyle,
										{
											...
											_0: A5(
												...
												{
													ctor: '::',
													_0: _debois$elm_mdl$Material_Icon$i('play_arrow'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
...
var _user$project$DjOps$update = F2(
	function (action, model) {
		...
		switch (_p59.ctor) {
			...
			case 'Login_Clicked':
				var _p63 = {ctor: '_Tuple2', _0: model.userid, _1: model.password};
				if (((_p63.ctor === '_Tuple2') && (_p63._0.ctor === 'Just')) && (_p63._1.ctor === 'Just')) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A3(model.xis.authenticate, _p63._0._0, _p63._1._0, _user$project$DjOps$Authenticate_Result)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			...
			case 'SetDatePicker':
				var _p74 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p59._0, model.datePicker);
				var newDatePicker = _p74._0;
				var datePickerCmd = _p74._1;
				var dateEvent = _p74._2;
				var _p75 = dateEvent;
				if (_p75.ctor === 'NoChange') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return _user$project$DjOps$fetchTracksTabData(
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{selectedShowDate: _p75._0, datePicker: newDatePicker}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$DjOps$SetDatePicker, datePickerCmd)
						});
				}
			...
			case 'ShowWasChosen':
				var _p77 = _p59._0;
				var _p76 = _elm_lang$core$Result$toMaybe(
					_elm_lang$core$String$toInt(_p77));
				if (_p76.ctor === 'Just') {
					var show = A2(
						_elm_community$list_extra$List_Extra$find,
						function (s) {
							return _elm_lang$core$Native_Utils.eq(s.id, _p76._0);
						},
						model.shows);
					return _user$project$DjOps$fetchTracksTabData(
						{
					...
					var dummy = A2(_elm_lang$core$Debug$log, 'Couldn\'t convert to Int', _p77);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Tick':
			...
			case 'TrackFieldUpdate':
				...
				var tte1 = A2(
					...
					A2(_elm_lang$core$Array$get, _p79, model.tracksTabEntries));
				var tte2 = function () {
					var _p78 = _p59._1;
					switch (_p78.ctor) {
						case 'ArtistColumn':
						...
						default:
							return _elm_lang$core$Native_Utils.update(
								tte1,
								{
									duration: _user$project$DjOps$mmss_mask(_p80)
								});
					}
				}();
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						tracksTabEntries: A3(_elm_lang$core$Array$set, _p79, tte2, model.tracksTabEntries)
					});
			...
			case 'EpisodeTrackUpsert_Result':
				if (_p59._0.ctor === 'Ok') {
					var _p71 = _p59._0._0;
					var _p70 = A2(_elm_lang$core$Array$get, _p71.data.sequence, model.tracksTabEntries);
					if (_p70.ctor === 'Just') {
						var newTte = _elm_lang$core$Native_Utils.update(
							_p70._0,
							{
								playListEntryId: _elm_lang$core$Maybe$Just(_p71.id),
								savedArtist: _p71.data.artist,
								savedTitle: _p71.data.title,
								savedDuration: _p71.data.duration
							});
						var newTtes = A3(_elm_lang$core$Array$set, _p71.data.sequence, newTte, model.tracksTabEntries);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
						...
						var dummy = A2(_elm_lang$core$Debug$log, 'Couldn\'t find row for', _p71);
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				} else {
					return {
			...
			case 'EpisodeCreate_Result':
				if (_p59._2.ctor === 'Ok') {
					...
					var msg = A3(
						...
						_p59._1,
						_elm_lang$core$Result$Ok(
							_user$project$DjangoRestFramework$singletonPageOf(_p64)));
					return A3(
						...
						msg,
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									episode: _elm_lang$core$Maybe$Just(_p64)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						});
				} else {
			...
			default:
				if (_p59._2.ctor === 'Ok') {
					var _p69 = _p59._1;
					var _p68 = _p59._0;
					var _p67 = _p59._2._0.results;
					var _p66 = _p59._2._0.count;
					if (_elm_lang$core$Native_Utils.eq(_p66, 1)) {
						var episode = _elm_lang$core$List$head(_p67);
						var tracksForTab = A2(
							_elm_lang$core$Maybe$withDefault,
							{ctor: '[]'},
							A2(
						...
						if (_elm_lang$core$Native_Utils.eq(_p66, 0)) {
							var tagger = A2(_user$project$DjOps$EpisodeCreate_Result, _p68, _p69);
							var selShowUrl = model.xis.showUrl(_p68.id);
							var epData = A4(
								_user$project$XisRestApi$EpisodeData,
								selShowUrl,
								_user$project$CalendarDate$fromDate(_p69),
								'',
								{ctor: '[]'});
							var createCmd = A2(model.xis.createEpisode, epData, tagger);
							return {ctor: '_Tuple2', _0: model, _1: createCmd};
						} else {
							var dummy = A2(_elm_lang$core$Debug$log, '>1 Episode', _p67);
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						}
					}
				} else {
																																														...
																																														function (workListUrl) {
																																															return A2(
																																																...
																																																function (workNoteListUrl) {
																																																	return _elm_lang$core$Json_Decode$succeed(
																																																		{authenticateUrl: authenticateUrl, broadcastListUrl: broadcastListUrl, claimListUrl: claimListUrl, discoveryMethodListUrl: discoveryMethodListUrl, emailMembershipInfoUrl: emailMembershipInfoUrl, episodeListUrl: episodeListUrl, episodeTrackListUrl: episodeTrackListUrl, logMessageUrl: logMessageUrl, memberListUrl: memberListUrl, membershipListUrl: membershipListUrl, nowPlayingUrl: nowPlayingUrl, playListUrl: playListUrl, productListUrl: productListUrl, showListUrl: showListUrl, taskListUrl: taskListUrl, timeBlockListUrl: timeBlockListUrl, timeBlockTypeListUrl: timeBlockTypeListUrl, trackListUrl: trackListUrl, vendLogListUrl: vendLogListUrl, visitEventListUrl: visitEventListUrl, workListUrl: workListUrl, workNoteListUrl: workNoteListUrl});
																																																},
