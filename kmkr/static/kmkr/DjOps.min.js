...
var _user$project$XisRestApi$replaceResource = F6(
...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var _p18 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
				start: {line: 954, column: 25},
				end: {line: 954, column: 36}
...
var _user$project$XisRestApi$createSession = F2(
	function (flags, auth) {
		return {
			...
			replaceClaim: A4(_user$project$XisRestApi$replaceResource, auth, flags.claimListUrl, _user$project$XisRestApi$encodeClaimData, _user$project$XisRestApi$decodeClaimData),
			replaceEpisodeTrack: A4(_user$project$XisRestApi$replaceResource, auth, flags.episodeTrackListUrl, _user$project$XisRestApi$encodeEpisodeTrackData, _user$project$XisRestApi$decodeEpisodeTrackData),
			replaceWork: A4(_user$project$XisRestApi$replaceResource, auth, flags.workListUrl, _user$project$XisRestApi$encodeWorkData, _user$project$XisRestApi$decodeWorkData),
			replacePlay: A4(_user$project$XisRestApi$replaceResource, auth, flags.playListUrl, _user$project$XisRestApi$encodePlayData, _user$project$XisRestApi$decodePlayData),
			replaceEpisode: A4(_user$project$XisRestApi$replaceResource, auth, flags.episodeListUrl, _user$project$XisRestApi$encodeEpisodeData, _user$project$XisRestApi$decodeEpisodeData),
