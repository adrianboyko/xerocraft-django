...
var _user$project$DjOps$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {mdl: a, xis: b, time: c, selectedTab: d, shows: e, showDate: f, datePicker: g};
	});
...
var _user$project$DjOps$init = function (flags) {
	...
	var auth = function () {
		var _p2 = flags.csrfToken;
		if (_p2.ctor === 'Just') {
			return _user$project$DjangoRestFramework$LoggedIn(_p2._0);
		} else {
...
var _user$project$DjOps$update = F2(
	function (action, model) {
		...
		switch (_p3.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$DjOps$Mdl, _p3._0, model);
			case 'SelectTab':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'Tick':
				...
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{time: _p4});
				var seconds = (_elm_lang$core$Basics$round(_p4) / 1000) | 0;
			...
			default:
				var _p5 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_community$elm_datepicker$DatePicker$defaultSettings, _p3._0, model.datePicker);
				var newDatePicker = _p5._0;
				var datePickerCmd = _p5._1;
				var dateEvent = _p5._2;
				var date = function () {
					var _p6 = dateEvent;
					if (_p6.ctor === 'NoChange') {
