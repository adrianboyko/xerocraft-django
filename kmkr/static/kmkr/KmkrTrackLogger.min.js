...
var _user$project$XisRestApi$pitInBlock = F2(
	function (pit, block) {
		...
		var _p12 = bd.last ? _elm_lang$core$Native_Utils.crash(
			'XisRestApi',
			{
				start: {line: 1185, column: 25},
				end: {line: 1185, column: 36}
											...
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return {authenticateUrl: a, claimListUrl: b, discoveryMethodListUrl: c, emailMembershipInfoUrl: d, logMessageUrl: e, memberListUrl: f, membershipListUrl: g, playListUrl: h, productListUrl: i, taskListUrl: j, timeBlocksUrl: k, timeBlockTypesUrl: l, vendLogListUrl: m, visitEventListUrl: n, workListUrl: o, workNoteListUrl: p};
															};
														};
													};
												};
																																														...
																																														return function (_21) {
																																															return function (_22) {
																																																return function (_23) {
																																																	return function (_24) {
																																																		return function (_25) {
																																																			return {getMembershipById: a, getPlayByUrl: b, getTaskById: c, getTaskFromUrl: d, getWorkFromUrl: e, createClaim: f, createPlay: g, createVendLog: h, createVisitEvent: i, createWork: j, createWorkNote: k, deletePlayById: l, deletePlayByUrl: m, deleteWorkById: n, deleteWorkByUrl: o, listClaims: p, listDiscoveryMethods: q, listMembers: r, listMemberships: s, listPlays: t, listTasks: u, listTimeBlocks: v, listTimeBlockTypes: w, listVisitEvents: x, listWorks: y, moreVisitEvents: z, replaceClaim: _1, replaceWork: _2, replacePlay: _3, claimUrl: _4, memberUrl: _5, productUrl: _6, taskUrl: _7, vendLogUrl: _8, visitEventUrl: _9, workUrl: _10, workNoteUrl: _11, authenticate: _12, blockHasType: _13, coverTime: _14, defaultBlockType: _15, emailMembershipInfo: _16, logMessage: _17, getBlocksTypes: _18, memberCanClaimTask: _19, memberHasStatusOnTask: _20, membersClaimOnTask: _21, membersStatusOnTask: _22, membersWithStatusOnTask: _23, mostRecentMembership: _24, pitInBlock: _25};
																																																		};
																																																	};
																																																};
																																															};
...
var _user$project$KmkrTrackLogger$restTdStyle = {
	ctor: '::',
...
var _user$project$KmkrTrackLogger$firstTdStyle = {
	ctor: '::',
	_0: A2(_debois$elm_mdl$Material_Options$css, 'border-style', 'none'),
	_1: {
		ctor: '::',
...
var _user$project$KmkrTrackLogger_ops = _user$project$KmkrTrackLogger_ops || {};
_user$project$KmkrTrackLogger_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _user$project$KmkrTrackLogger$unselectable = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: A2(_user$project$KmkrTrackLogger_ops['=>'], '-moz-user-select', '-moz-none'),
		_1: {
			ctor: '::',
			_0: A2(_user$project$KmkrTrackLogger_ops['=>'], '-khtml-user-select', 'none'),
			_1: {
				ctor: '::',
				_0: A2(_user$project$KmkrTrackLogger_ops['=>'], '-webkit-user-select', 'none'),
				_1: {
					ctor: '::',
					_0: A2(_user$project$KmkrTrackLogger_ops['=>'], '-ms-user-select', 'none'),
					_1: {
						ctor: '::',
						_0: A2(_user$project$KmkrTrackLogger_ops['=>'], 'user-select', 'none'),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$KmkrTrackLogger$layout_header = function (model) {
	return {
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('DJ Data Entry / Tracks for Show'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	};
};
var _user$project$KmkrTrackLogger$init = function (flags) {
	var auth = function () {
...
var _user$project$KmkrTrackLogger$Flags = F2(
	function (a, b) {
		return {csrfToken: a, xisRestFlags: b};
	});
var _user$project$KmkrTrackLogger$Model = F3(
	function (a, b, c) {
		return {mdl: a, xis: b, time: c};
	});
var _user$project$KmkrTrackLogger$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$KmkrTrackLogger$update = F2(
	function (action, model) {
		var xis = model.xis;
		var _p1 = action;
		if (_p1.ctor === 'Mdl') {
			return A3(_debois$elm_mdl$Material$update, _user$project$KmkrTrackLogger$Mdl, _p1._0, model);
		} else {
			var _p2 = _p1._0;
...
var _user$project$KmkrTrackLogger$tableRow = F2(
	function (model, r) {
		var aTd = F4(
			function (s, r, c, opts) {
				return A2(
					_debois$elm_mdl$Material_Table$td,
					_user$project$KmkrTrackLogger$restTdStyle,
					{
						ctor: '::',
						_0: A5(
							_debois$elm_mdl$Material_Textfield$render,
							_user$project$KmkrTrackLogger$Mdl,
							{
								ctor: '::',
								_0: r,
								_1: {
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					_debois$elm_mdl$Material_Table$td,
					_user$project$KmkrTrackLogger$firstTdStyle,
					{
						ctor: '::',
...
var _user$project$KmkrTrackLogger$layout_main = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				A2(
					_elm_lang$core$List$map,
					_user$project$KmkrTrackLogger$tableRow(model),
					A2(_elm_lang$core$List$range, 1, 60))),
			_1: {ctor: '[]'}
		});
};
var _user$project$KmkrTrackLogger$view = function (model) {
	return A4(
		...
		{
			header: _user$project$KmkrTrackLogger$layout_header(model),
			drawer: {ctor: '[]'},
			tabs: {
				ctor: '_Tuple2',
				_0: {ctor: '[]'},
			...
			main: {
				ctor: '::',
				_0: _user$project$KmkrTrackLogger$layout_main(model),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$KmkrTrackLogger$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$KmkrTrackLogger$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$KmkrTrackLogger$Tick),
			_1: {ctor: '[]'}
		});
};
var _user$project$KmkrTrackLogger$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$KmkrTrackLogger$init, view: _user$project$KmkrTrackLogger$view, update: _user$project$KmkrTrackLogger$update, subscriptions: _user$project$KmkrTrackLogger$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (csrfToken) {
			return A2(
																																		...
																																		function (workListUrl) {
																																			return A2(
																																				...
																																				function (workNoteListUrl) {
																																					return _elm_lang$core$Json_Decode$succeed(
																																						{authenticateUrl: authenticateUrl, claimListUrl: claimListUrl, discoveryMethodListUrl: discoveryMethodListUrl, emailMembershipInfoUrl: emailMembershipInfoUrl, logMessageUrl: logMessageUrl, memberListUrl: memberListUrl, membershipListUrl: membershipListUrl, playListUrl: playListUrl, productListUrl: productListUrl, taskListUrl: taskListUrl, timeBlockTypesUrl: timeBlockTypesUrl, timeBlocksUrl: timeBlocksUrl, vendLogListUrl: vendLogListUrl, visitEventListUrl: visitEventListUrl, workListUrl: workListUrl, workNoteListUrl: workNoteListUrl});
																																				},
...
var Elm = {};
Elm['KmkrTrackLogger'] = Elm['KmkrTrackLogger'] || {};
if (typeof _user$project$KmkrTrackLogger$main !== 'undefined') {
    _user$project$KmkrTrackLogger$main(Elm['KmkrTrackLogger'], 'KmkrTrackLogger', undefined);
}
