	...
	return getTimeBlocksFn(
		function (_p0) {
			return _user$project$ReceptionKiosk_Types$MembersOnlyVector(
				_user$project$ReceptionKiosk_Types$UpdateTimeBlocks(_p0));
		});
};
	...
	return A6(
		...
		A2(
			...
			{ctor: '[]'},
			{
				ctor: '::',
				_0: function () {
					var _p1 = sceneModel.currTimeBlock;
					if (_p1.ctor === 'Nothing') {
						return _elm_lang$html$Html$text('not in block');
					} else {
						return _elm_lang$html$Html$text(_p1._0.startTime);
					}
				}(),
				_1: {ctor: '[]'}
			}),
...
var _user$project$ReceptionKiosk_MembersOnlyScene$MembersOnlyModel = F2(
	function (a, b) {
		return {currTimeBlock: a, badNews: b};
	});
