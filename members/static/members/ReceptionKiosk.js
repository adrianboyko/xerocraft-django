...
var _user$project$ReceptionKiosk$init = function (f) {
	...
	var _p10 = _user$project$ReceptionKiosk_HowDidYouHearScene$init(f);
	var howDidYouHearModel = _p10._0;
	var howDidYouHearCmd = _p10._1;
	var _p11 = _user$project$ReceptionKiosk_EmailInUseScene$init(f);
	var emailInUseModel = _p11._0;
	var emailInUseCmd = _p11._1;
	var _p12 = _user$project$ReceptionKiosk_CreatingAcctScene$init(f);
	var creatingAcctModel = _p12._0;
	var creatingAcctCmd = _p12._1;
	var _p13 = _user$project$ReceptionKiosk_CheckOutDoneScene$init(f);
	var checkOutDoneModel = _p13._0;
	var checkOutDoneCmd = _p13._1;
	var _p14 = _user$project$ReceptionKiosk_CheckOutScene$init(f);
	var checkOutModel = _p14._0;
	var checkOutCmd = _p14._1;
	var _p15 = _user$project$ReceptionKiosk_CheckInDoneScene$init(f);
	var checkInDoneModel = _p15._0;
	var checkInDoneCmd = _p15._1;
	var _p16 = _user$project$ReceptionKiosk_CheckInScene$init(f);
	var checkInModel = _p16._0;
	var checkInCmd = _p16._1;
	var model = {
		flags: f,
...
var _user$project$ReceptionKiosk$update = F2(
	function (msg, model) {
		...
		switch (_p17.ctor) {
				...
				switch (_p18.ctor) {
					case 'Push':
						...
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								sceneStack: A2(_mgold$elm_nonempty_list$List_Nonempty$cons, _p19, model.sceneStack)
							});
						return A2(
					...
					case 'RebaseTo':
						...
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								sceneStack: _mgold$elm_nonempty_list$List_Nonempty$fromElement(_p20)
							});
						return A2(
							_ccapndave$elm_update_extra$Update_Extra_Infix_ops[':>'],
							{ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none},
					...
					default:
						...
						switch (_p22.ctor) {
							case 'CreatingAcct':
								var _p23 = A2(_user$project$ReceptionKiosk_CreatingAcctScene$tick, _p25, model);
								var sm = _p23._0;
								var cmd = _p23._1;
								return {
									ctor: '_Tuple2',
							...
							case 'CheckInDone':
								var _p24 = A2(_user$project$ReceptionKiosk_CheckInDoneScene$tick, _p25, model);
								var sm = _p24._0;
								var cmd = _p24._1;
								return {
									ctor: '_Tuple2',
			...
			case 'CheckInVector':
				var _p26 = A2(_user$project$ReceptionKiosk_CheckInScene$update, _p17._0, model);
				var sm = _p26._0;
				var cmd = _p26._1;
				return {
					ctor: '_Tuple2',
			...
			case 'CheckOutVector':
				var _p27 = A2(_user$project$ReceptionKiosk_CheckOutScene$update, _p17._0, model);
				var sm = _p27._0;
				var cmd = _p27._1;
				return {
					ctor: '_Tuple2',
			...
			case 'CreatingAcctVector':
				var _p28 = A2(_user$project$ReceptionKiosk_CreatingAcctScene$update, _p17._0, model);
				var sm = _p28._0;
				var cmd = _p28._1;
				return {
					ctor: '_Tuple2',
			...
			case 'HowDidYouHearVector':
				var _p29 = A2(_user$project$ReceptionKiosk_HowDidYouHearScene$update, _p17._0, model);
				var sm = _p29._0;
				var cmd = _p29._1;
				return {
					ctor: '_Tuple2',
			...
			case 'NewMemberVector':
				var _p30 = A2(_user$project$ReceptionKiosk_NewMemberScene$update, _p17._0, model);
				var sm = _p30._0;
				var cmd = _p30._1;
				return {
					ctor: '_Tuple2',
			...
			case 'NewUserVector':
				var _p31 = A2(_user$project$ReceptionKiosk_NewUserScene$update, _p17._0, model);
				var sm = _p31._0;
				var cmd = _p31._1;
				return {
					ctor: '_Tuple2',
			...
			case 'ReasonForVisitVector':
				var _p32 = A2(_user$project$ReceptionKiosk_ReasonForVisitScene$update, _p17._0, model);
				var sm = _p32._0;
				var cmd = _p32._1;
				return {
					ctor: '_Tuple2',
			...
			case 'TaskListVector':
				var _p33 = A2(_user$project$ReceptionKiosk_TaskListScene$update, _p17._0, model);
				var sm = _p33._0;
				var cmd = _p33._1;
				return {
					ctor: '_Tuple2',
			...
			case 'WaiverVector':
				var _p34 = A2(_user$project$ReceptionKiosk_WaiverScene$update, _p17._0, model);
				var sm = _p34._0;
				var cmd = _p34._1;
				return {
					ctor: '_Tuple2',
			...
			case 'WelcomeVector':
				var _p35 = A2(_user$project$ReceptionKiosk_WelcomeScene$update, _p17._0, model);
				var sm = _p35._0;
				var cmd = _p35._1;
				return {
					ctor: '_Tuple2',
			...
			default:
				return A3(_debois$elm_mdl$Material$update, _user$project$ReceptionKiosk_Types$MdlVector, _p17._0, model);
		}
	});
