...
var _user$project$ReceptionKiosk$DiscoveryMethod = F3(
	function (a, b, c) {
		return {id: a, name: b, order: c};
	});
var _user$project$ReceptionKiosk$decodeDiscoveryMethod = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$ReceptionKiosk$DiscoveryMethod,
...
var _user$project$ReceptionKiosk$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			default:
				if (_p1._0.ctor === 'Ok') {
					var methods = A2(_elm_lang$core$Basics_ops['++'], model.discoveryMethods, _p1._0._0.results);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
									...
									return A2(
										...
										function (orgName) {
											return _elm_lang$core$Json_Decode$succeed(
												{bannerBottomUrl: bannerBottomUrl, bannerTopUrl: bannerTopUrl, csrfToken: csrfToken, discoveryMethodsUrl: discoveryMethodsUrl, orgName: orgName});
										},
