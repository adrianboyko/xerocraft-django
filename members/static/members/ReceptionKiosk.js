										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {addDiscoveryMethodUrl: a, bannerBottomUrl: b, bannerTopUrl: c, checkedInAcctsUrl: d, cloneAcctUrl: e, csrfToken: f, discoveryMethodsUrl: g, logVisitEventUrl: h, matchingAcctsUrl: i, orgName: j, scrapeLoginsUrl: k, setIsAdultUrl: l, xcOrgActionUrl: m, timeBlocksUrl: n, timeBlockTypesUrl: o};
														};
													};
												};
											};
							...
							switch (_p5._0.ctor) {
								...
								case 'MemberPrivileges':
									return {
										...
										_1: _user$project$Wizard_SceneUtils$send(
											_user$project$ReceptionKiosk_Types$WizardVector(
												_user$project$ReceptionKiosk_Types$Push(_user$project$ReceptionKiosk_Types$MembersOnly)))
									};
								default:
									break _v4_2;
							}
...
var _user$project$ReceptionKiosk_MembersOnlyScene$update = F2(
	function (msg, kioskModel) {
		...
		if (_p3.ctor === 'UpdateTimeBlocks') {
			if (_p3._0.ctor === 'Ok') {
				var followUpCmd = _user$project$ReceptionKiosk_MembersOnlyScene$getTimeBlockTypes(kioskModel);
...
var _user$project$ReceptionKiosk$update = F2(
	function (msg, model) {
		...
		switch (_p18.ctor) {
			case 'WizardVector':
				...
				switch (_p19.ctor) {
					...
					default:
						...
						switch (_p29.ctor) {
							case 'CreatingAcct':
								var _p30 = A2(_user$project$ReceptionKiosk_CreatingAcctScene$tick, _p32, model);
								var sm = _p30._0;
								var cmd = _p30._1;
								return {
									ctor: '_Tuple2',
							...
							case 'CheckInDone':
								var _p31 = A2(_user$project$ReceptionKiosk_CheckInDoneScene$tick, _p32, model);
								var sm = _p31._0;
								var cmd = _p31._1;
								return {
									ctor: '_Tuple2',
			...
			case 'CheckInVector':
				var _p33 = A2(_user$project$ReceptionKiosk_CheckInScene$update, _p18._0, model);
				var sm = _p33._0;
				var cmd = _p33._1;
				return {
					ctor: '_Tuple2',
			...
			case 'CheckOutVector':
				var _p34 = A2(_user$project$ReceptionKiosk_CheckOutScene$update, _p18._0, model);
				var sm = _p34._0;
				var cmd = _p34._1;
				return {
					ctor: '_Tuple2',
			...
			case 'CreatingAcctVector':
				var _p35 = A2(_user$project$ReceptionKiosk_CreatingAcctScene$update, _p18._0, model);
				var sm = _p35._0;
				var cmd = _p35._1;
				return {
					ctor: '_Tuple2',
			...
			case 'HowDidYouHearVector':
				var _p36 = A2(_user$project$ReceptionKiosk_HowDidYouHearScene$update, _p18._0, model);
				var sm = _p36._0;
				var cmd = _p36._1;
				return {
					ctor: '_Tuple2',
			...
			case 'MembersOnlyVector':
				var _p37 = A2(_user$project$ReceptionKiosk_MembersOnlyScene$update, _p18._0, model);
				var sm = _p37._0;
				var cmd = _p37._1;
				return {
					ctor: '_Tuple2',
			...
			case 'NewMemberVector':
				var _p38 = A2(_user$project$ReceptionKiosk_NewMemberScene$update, _p18._0, model);
				var sm = _p38._0;
				var cmd = _p38._1;
				return {
					ctor: '_Tuple2',
			...
			case 'NewUserVector':
				var _p39 = A2(_user$project$ReceptionKiosk_NewUserScene$update, _p18._0, model);
				var sm = _p39._0;
				var cmd = _p39._1;
				return {
					ctor: '_Tuple2',
			...
			case 'ReasonForVisitVector':
				var _p40 = A2(_user$project$ReceptionKiosk_ReasonForVisitScene$update, _p18._0, model);
				var sm = _p40._0;
				var cmd = _p40._1;
				return {
					ctor: '_Tuple2',
			...
			case 'TaskListVector':
				var _p41 = A2(_user$project$ReceptionKiosk_TaskListScene$update, _p18._0, model);
				var sm = _p41._0;
				var cmd = _p41._1;
				return {
					ctor: '_Tuple2',
			...
			case 'WaiverVector':
				var _p42 = A2(_user$project$ReceptionKiosk_WaiverScene$update, _p18._0, model);
				var sm = _p42._0;
				var cmd = _p42._1;
				return {
					ctor: '_Tuple2',
...
if (typeof _user$project$ReceptionKiosk$main !== 'undefined') {
    _user$project$ReceptionKiosk$main(Elm['ReceptionKiosk'], 'ReceptionKiosk', {"types":{"unions":{"ReceptionKiosk.Types.ReasonForVisitMsg":{"args":[],"tags":{"LogCheckInResult":["Result.Result Http.Error MembersApi.GenericResult"],"UpdateReasonForVisit":["MembersApi.ReasonForVisit"],"ValidateReason":[]}},"ReceptionKiosk.Types.NewUserMsg":{"args":[],"tags":{"UpdatePassword1":["String"],"UpdateUserName":["String"],"UpdatePassword2":["String"],"ValidateUserNameAndPw":[],"ValidateUserNameUnique":["Result.Result Http.Error MembersApi.MatchingAcctInfo"]}},"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"ReceptionKiosk.Types.CheckOutMsg":{"args":[],"tags":{"LogCheckOut":["Int"],"UpdateCheckedInAccts":["Result.Result Http.Error MembersApi.MatchingAcctInfo"]}},"Material.Component.Msg":{"args":["button","textfield","menu","layout","toggles","tooltip","tabs","dispatch"],"tags":{"TooltipMsg":["Material.Component.Index","tooltip"],"TogglesMsg":["Material.Component.Index","toggles"],"LayoutMsg":["layout"],"ButtonMsg":["Material.Component.Index","button"],"MenuMsg":["Material.Component.Index","menu"],"TabsMsg":["Material.Component.Index","tabs"],"Dispatch":["dispatch"],"TextfieldMsg":["Material.Component.Index","textfield"]}},"Material.Ripple.Msg":{"args":[],"tags":{"Down":["Material.Ripple.DOMState"],"Up":[],"Tick":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"ReceptionKiosk.Types.WizardMsg":{"args":[],"tags":{"SceneWillAppear":["ReceptionKiosk.Types.Scene"],"Pop":[],"Tick":["Time.Time"],"RebaseTo":["ReceptionKiosk.Types.Scene"],"Reset":[],"Push":["ReceptionKiosk.Types.Scene"]}},"ReceptionKiosk.Types.WaiverMsg":{"args":[],"tags":{"UpdateSignature":["String"],"ClearSignaturePad":["String"],"ShowSignaturePad":["String"],"GetSignature":[]}},"Material.Tooltip.Msg":{"args":[],"tags":{"Enter":["Material.Tooltip.DOMState"],"Leave":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Json.Decode.Decoder":{"args":["a"],"tags":{"Decoder":[]}},"ReceptionKiosk.Types.Msg":{"args":[],"tags":{"MdlVector":["Material.Msg ReceptionKiosk.Types.Msg"],"NewUserVector":["ReceptionKiosk.Types.NewUserMsg"],"ReasonForVisitVector":["ReceptionKiosk.Types.ReasonForVisitMsg"],"CreatingAcctVector":["ReceptionKiosk.Types.CreatingAcctMsg"],"MembersOnlyVector":["ReceptionKiosk.Types.MembersOnlyMsg"],"CheckOutVector":["ReceptionKiosk.Types.CheckOutMsg"],"WaiverVector":["ReceptionKiosk.Types.WaiverMsg"],"WizardVector":["ReceptionKiosk.Types.WizardMsg"],"NewMemberVector":["ReceptionKiosk.Types.NewMemberMsg"],"HowDidYouHearVector":["ReceptionKiosk.Types.HowDidYouHearMsg"],"CheckInVector":["ReceptionKiosk.Types.CheckInMsg"],"TaskListVector":["ReceptionKiosk.Types.TaskListMsg"]}},"ReceptionKiosk.Types.MembersOnlyMsg":{"args":[],"tags":{"UpdateTimeBlocks":["Result.Result Http.Error OpsApi.PageOfTimeBlocks"],"UpdateTimeBlockTypes":["Result.Result Http.Error OpsApi.PageOfTimeBlockTypes"]}},"Material.Textfield.Msg":{"args":[],"tags":{"Focus":[],"Input":["String"],"Blur":[]}},"ReceptionKiosk.Types.TaskListMsg":{"args":[],"tags":{"ValidateTaskChoice":[],"ToggleTask":["TaskApi.OpsTask"],"CalendarPageResult":["Result.Result Http.Error TaskApi.CalendarPage"]}},"ReceptionKiosk.Types.Scene":{"args":[],"tags":{"NewMember":[],"HowDidYouHear":[],"MembersOnly":[],"EmailInUse":[],"ReasonForVisit":[],"SignUpDone":[],"CheckInDone":[],"CheckIn":[],"CreatingAcct":[],"TaskList":[],"VolunteerInDone":[],"Welcome":[],"NewUser":[],"CheckOutDone":[],"CheckOut":[],"Waiver":[]}},"Material.Layout.Msg":{"args":[],"tags":{"Resize":["Int"],"ToggleDrawer":[],"TransitionEnd":[],"ScrollPane":["Bool","Float"],"Ripple":["Int","Material.Ripple.Msg"],"ScrollTab":["Material.Layout.TabScrollState"],"TransitionHeader":["{ toCompact : Bool, fixedHeader : Bool }"],"NOP":[]}},"MembersApi.ReasonForVisit":{"args":[],"tags":{"Other":[],"Volunteer":[],"MemberPrivileges":[],"Curiousity":[],"GuestOfMember":[],"ClassParticipant":[]}},"ReceptionKiosk.Types.CheckInMsg":{"args":[],"tags":{"UpdateMatchingAccts":["Result.Result Http.Error MembersApi.MatchingAcctInfo"],"UpdateMemberNum":["Int"],"UpdateFlexId":["String"]}},"Material.Toggles.Msg":{"args":[],"tags":{"Ripple":["Material.Ripple.Msg"],"SetFocus":["Bool"]}},"VirtualDom.Property":{"args":["msg"],"tags":{"Property":[]}},"ReceptionKiosk.Types.CreatingAcctMsg":{"args":[],"tags":{"XcAcctCreationAttempted":["Result.Result Http.Error String"],"CloneAttempted":["Result.Result Http.Error String"],"IsAdultWasSet":["Result.Result Http.Error String"],"DiscoveryMethodAdded":["Result.Result Http.Error String"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"ReceptionKiosk.Types.NewMemberMsg":{"args":[],"tags":{"UpdateEmail":["String"],"ToggleIsAdult":["Bool"],"ValidateEmailUnique":["Result.Result Http.Error MembersApi.MatchingAcctInfo"],"UpdateFirstName":["String"],"UpdateLastName":["String"],"Validate":[]}},"ReceptionKiosk.Types.HowDidYouHearMsg":{"args":[],"tags":{"AccDiscoveryMethods":["Result.Result Http.Error MembersApi.DiscoveryMethodInfo"],"ToggleDiscoveryMethod":["MembersApi.DiscoveryMethod"]}},"Material.Tabs.Msg":{"args":[],"tags":{"Ripple":["Int","Material.Ripple.Msg"]}},"Material.Menu.Msg":{"args":["m"],"tags":{"Tick":[],"Close":[],"Open":["Material.Menu.Geometry.Geometry"],"Key":["List (Material.Options.Internal.Summary (Material.Menu.ItemConfig m) m)","Int"],"Ripple":["Int","Material.Ripple.Msg"],"Select":["Int","Maybe.Maybe m"],"Click":["Mouse.Position"]}},"Material.Dispatch.Config":{"args":["msg"],"tags":{"Config":["{ decoders : List ( String , ( Json.Decode.Decoder msg, Maybe.Maybe Html.Events.Options ) ) , lift : Maybe.Maybe (Json.Decode.Decoder (List msg) -> Json.Decode.Decoder msg) }"]}}},"aliases":{"Material.Button.Msg":{"args":[],"type":"Material.Ripple.Msg"},"Material.Layout.TabScrollState":{"args":[],"type":"{ canScrollLeft : Bool , canScrollRight : Bool , width : Maybe.Maybe Int }"},"TaskApi.MonthOfTasks":{"args":[],"type":"List TaskApi.WeekOfTasks"},"Material.Tooltip.DOMState":{"args":[],"type":"{ rect : DOM.Rectangle, offsetWidth : Float, offsetHeight : Float }"},"Html.Attribute":{"args":["msg"],"type":"VirtualDom.Property msg"},"Material.Menu.ItemConfig":{"args":["m"],"type":"{ enabled : Bool, divider : Bool, onSelect : Maybe.Maybe m }"},"OpsApi.PageOfTimeBlocks":{"args":[],"type":"OpsApi.PageOf OpsApi.TimeBlock"},"TaskApi.CalendarPage":{"args":[],"type":"{ user : Maybe.Maybe TaskApi.User , tasks : TaskApi.MonthOfTasks , year : Int , month : Int }"},"Material.Component.Index":{"args":[],"type":"List Int"},"Html.Events.Options":{"args":[],"type":"{ stopPropagation : Bool, preventDefault : Bool }"},"MembersApi.GenericResult":{"args":[],"type":"{ result : String }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Material.Ripple.DOMState":{"args":[],"type":"{ rect : DOM.Rectangle , clientX : Maybe.Maybe Float , clientY : Maybe.Maybe Float , touchX : Maybe.Maybe Float , touchY : Maybe.Maybe Float , type_ : String }"},"OpsApi.PageOf":{"args":["a"],"type":"{ count : Int , next : Maybe.Maybe String , previous : Maybe.Maybe String , results : List a }"},"TaskApi.DayOfTasks":{"args":[],"type":"{ dayOfMonth : Int , isInTargetMonth : Bool , isToday : Bool , tasks : List TaskApi.OpsTask }"},"TaskApi.WeekOfTasks":{"args":[],"type":"List TaskApi.DayOfTasks"},"MembersApi.DiscoveryMethod":{"args":[],"type":"{ id : Int, name : String, order : Int, visible : Bool }"},"Mouse.Position":{"args":[],"type":"{ x : Int, y : Int }"},"OpsApi.TimeBlock":{"args":[],"type":"{ id : Int , isNow : Bool , startTime : String , duration : String , first : Bool , second : Bool , third : Bool , fourth : Bool , last : Bool , every : Bool , monday : Bool , tuesday : Bool , wednesday : Bool , thursday : Bool , friday : Bool , saturday : Bool , sunday : Bool , types : List String }"},"Material.Options.Internal.Summary":{"args":["c","m"],"type":"{ classes : List String , css : List ( String, String ) , attrs : List (Html.Attribute m) , internal : List (Html.Attribute m) , dispatch : Material.Dispatch.Config m , config : c }"},"Material.Msg":{"args":["m"],"type":"Material.Component.Msg Material.Button.Msg Material.Textfield.Msg (Material.Menu.Msg m) Material.Layout.Msg Material.Toggles.Msg Material.Tooltip.Msg Material.Tabs.Msg (List m)"},"OpsApi.PageOfTimeBlockTypes":{"args":[],"type":"OpsApi.PageOf OpsApi.TimeBlockType"},"TaskApi.OpsTask":{"args":[],"type":"{ taskId : Int , isoDate : String , shortDesc : String , timeWindow : Maybe.Maybe TaskApi.TimeWindow , instructions : String , staffingStatus : String , possibleActions : List String , staffedBy : List String , taskStatus : String , usersClaimId : Maybe.Maybe Int }"},"TaskApi.User":{"args":[],"type":"{ memberId : Int, name : String }"},"Material.Menu.Geometry.Element":{"args":[],"type":"{ offsetTop : Float , offsetLeft : Float , offsetHeight : Float , bounds : DOM.Rectangle }"},"TaskApi.TimeWindow":{"args":[],"type":"{ begin : TaskApi.ClockTime, duration : TaskApi.Duration }"},"TaskApi.Duration":{"args":[],"type":"Float"},"MembersApi.MatchingAcctInfo":{"args":[],"type":"{ target : String, matches : List MembersApi.MatchingAcct }"},"MembersApi.MatchingAcct":{"args":[],"type":"{ userName : String, memberNum : Int }"},"Material.Menu.Geometry.Geometry":{"args":[],"type":"{ button : Material.Menu.Geometry.Element , menu : Material.Menu.Geometry.Element , container : Material.Menu.Geometry.Element , offsetTops : List Float , offsetHeights : List Float }"},"TaskApi.ClockTime":{"args":[],"type":"{ hour : Int, minute : Int }"},"Time.Time":{"args":[],"type":"Float"},"MembersApi.DiscoveryMethodInfo":{"args":[],"type":"{ count : Int , next : Maybe.Maybe String , previous : Maybe.Maybe String , results : List MembersApi.DiscoveryMethod }"},"OpsApi.TimeBlockType":{"args":[],"type":"{ id : Int, name : String, description : String }"},"DOM.Rectangle":{"args":[],"type":"{ top : Float, left : Float, width : Float, height : Float }"}},"message":"ReceptionKiosk.Types.Msg"},"versions":{"elm":"0.18.0"}});
}
