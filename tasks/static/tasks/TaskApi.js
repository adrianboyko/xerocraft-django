...
var Elm = {};
Elm['TaskApi'] = Elm['TaskApi'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['TaskApi'], 'TaskApi', typeof _user$project$TaskApi$main === 'undefined' ? null : _user$project$TaskApi$main);
