...
urlpatterns = [
    ...
    url(r'^ops-calendar-spa/(?P<year>[0-9]{4})-(?P<month>[0-9][0-9]?)/$', views.ops_calendar_spa, name='ops-calendar-spa'),
    url(r'^ops-calendar-json/(?P<year>[0-9]{4})-(?P<month>[0-9][0-9]?)/$', views.ops_calendar_json, name='ops-calendar-json'),
